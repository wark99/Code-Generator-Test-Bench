...
|------------- | ------------- | -------------|
| [**call2profileSupportTicketsGet**](SupportApi.md#call2profileSupportTicketsGet) | **GET** /2/profile/support/tickets | List support tickets |



## call2profileSupportTicketsGet

> Model2ProfileSupportTicketsGet200Response call2profileSupportTicketsGet(_return, page, perPage, orderBy, order, orderFor)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            Model2ProfileSupportTicketsGet200Response result = apiInstance.call2profileSupportTicketsGet(_return, page, perPage, orderBy, order, orderFor);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SupportApi#call2profileSupportTicketsGet");
...
[**Model2ProfileSupportTicketsGet200Response**](Model2ProfileSupportTicketsGet200Response.md)

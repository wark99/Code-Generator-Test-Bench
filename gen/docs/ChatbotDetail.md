...
|**rcsReply** | [**RcsReplyEnum**](#RcsReplyEnum) | service가 &#39;chat&#39; 이거나 양방향 대화방으로 설정하고자 한다면 반드시 &#39;1&#39;로 설정해야 합니다.      + 0 : SMS MO 수신     + 1 : RCS Postback 수신   |  [optional] |
...
|**searchWeight** | **Object** | 검색 우선 순위로 사용자 단말에서 검색 시 검색 결과가 여러 개라면 이 값이 높은 순서로 보여집니다. 대행사나 기업에서 API를 통한 등록/수정은 제공하지 않습니다.  |  [optional] |
|**webhook** | **Object** | 양방향 대화방 서비스 중계사 webhook URL 정보이며 botAgencyId 지정 시 자동으로 등록됩니다. |  [optional] |
|**botTcPage** | **Object** | 이용약관페이지 URL 입니다.   대행사나 기업에서 API를 통해 등록/수정은 제공하지 않습니다.  |  [optional] |
|**persistentMenu** | **Object** |  |  [optional] |
|**groupId** | **Object** | 대화방이 대량등록된 경우 그룹ID 입니다.  |  [optional] |
|**chatbotId** | **Object** | 대화방(발신번호)ID, A2P의 경우 발신번호(mdn)과 동일합니다.  |  |
|**brandId** | **Object** | 브랜드ID |  |
|**subNum** | **Object** | 회신번호 A2P의 경우 발신번호, 즉 chatbotId와 동일합니다.  |  [optional] |
...
|**psMenuUse** | **Object** | 대화방메뉴 사용 여부입니다.      + true : 사용     + false : 미사용  |  [optional] |

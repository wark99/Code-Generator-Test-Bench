...
|------------ | ------------- | ------------- | -------------|
|**chatbotId** | **String** | 발신번호 또는 양방향ID로 등록된 대화방의 고유 식별값입니다.    |  |
|**brandId** | **String** | 대화방이 속한 브랜드ID 입니다.  |  |
|**subNum** | **String** | 양방향 대화방에 지정된 회신번호 입니다. A2P의 경우 chatbotId와 동일합니다.  |  |
...
|**psMenuUse** | **Boolean** | 대화방메뉴 사용 여부입니다.  |  [optional] |

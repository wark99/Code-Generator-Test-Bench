...
import org.openapitools.client.model.UploadFile200Response;
...
public class PetApi {
     ...
     * @param updatePetRequest Create a new pet in the store (required)
     * @return UpdatePetRequest
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public UpdatePetRequest addPet(UpdatePetRequest updatePetRequest) throws RestClientException {
        return addPetWithHttpInfo(updatePetRequest).getBody();
    }
     ...
     * <p><b>405</b> - Invalid input
     * @param updatePetRequest Create a new pet in the store (required)
     * @return ResponseEntity&lt;UpdatePetRequest&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<UpdatePetRequest> addPetWithHttpInfo(UpdatePetRequest updatePetRequest) throws RestClientException {
        Object localVarPostBody = updatePetRequest;
        
        // verify the required parameter 'updatePetRequest' is set
        if (updatePetRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'updatePetRequest' when calling addPet");
        }
        ...
        ParameterizedTypeReference<UpdatePetRequest> localReturnType = new ParameterizedTypeReference<UpdatePetRequest>() {};
     ...
     * @return List&lt;UpdatePetRequest&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<UpdatePetRequest> findPetsByStatus(String status) throws RestClientException {
     ...
     * <p><b>400</b> - Invalid status value
     * @param status Status values that need to be considered for filter (optional, default to available)
     * @return ResponseEntity&lt;List&lt;UpdatePetRequest&gt;&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<UpdatePetRequest>> findPetsByStatusWithHttpInfo(String status) throws RestClientException {
        Object localVarPostBody = null;
        ...
        ParameterizedTypeReference<List<UpdatePetRequest>> localReturnType = new ParameterizedTypeReference<List<UpdatePetRequest>>() {};
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<UpdatePetRequest> findPetsByTags(List<String> tags) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<UpdatePetRequest>> findPetsByTagsWithHttpInfo(List<String> tags) throws RestClientException {
        Object localVarPostBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public UpdatePetRequest getPetById(Long petId) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<UpdatePetRequest> getPetByIdWithHttpInfo(Long petId) throws RestClientException {
        Object localVarPostBody = null;
     ...
     * @param updatePetRequest Update an existent pet in the store (required)
     * @return UpdatePetRequest
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public UpdatePetRequest updatePet(UpdatePetRequest updatePetRequest) throws RestClientException {
        return updatePetWithHttpInfo(updatePetRequest).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<UpdatePetRequest> updatePetWithHttpInfo(UpdatePetRequest updatePetRequest) throws RestClientException {
        Object localVarPostBody = updatePetRequest;
        
        // verify the required parameter 'updatePetRequest' is set
        if (updatePetRequest == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'updatePetRequest' when calling updatePet");
        }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public UploadFile200Response uploadFile(Long petId, String additionalMetadata, File body) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<UploadFile200Response> uploadFileWithHttpInfo(Long petId, String additionalMetadata, File body) throws RestClientException {
        ...
        ParameterizedTypeReference<UploadFile200Response> localReturnType = new ParameterizedTypeReference<UploadFile200Response>() {};

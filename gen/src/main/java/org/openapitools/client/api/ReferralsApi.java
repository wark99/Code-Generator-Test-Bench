...
public class ReferralsApi {
     ...
     * <p><b>200</b> - Returns a list of referrals.
     * @return GetActivities200Response
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public GetActivities200Response getReferrals() throws RestClientException {
        return getReferralsWithHttpInfo().getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GetActivities200Response> getReferralsWithHttpInfo() throws RestClientException {
        ...
        return apiClient.invokeAPI("/referrals", HttpMethod.GET, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
}

...
public class UserApi {
     ...
     */
    public CreateUserRequest createUser(CreateUserRequest createUserRequest) throws RestClientException {
     ...
     * <p><b>0</b> - successful operation
     * @param createUserRequest Created user object (optional)
     * @return ResponseEntity&lt;CreateUserRequest&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<CreateUserRequest> createUserWithHttpInfo(CreateUserRequest createUserRequest) throws RestClientException {
        ...
        ParameterizedTypeReference<CreateUserRequest> localReturnType = new ParameterizedTypeReference<CreateUserRequest>() {};
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public CreateUserRequest createUsersWithListInput(List<CreateUserRequest> createUserRequest) throws RestClientException {
        return createUsersWithListInputWithHttpInfo(createUserRequest).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<CreateUserRequest> createUsersWithListInputWithHttpInfo(List<CreateUserRequest> createUserRequest) throws RestClientException {
        Object localVarPostBody = createUserRequest;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public CreateUserRequest getUserByName(String username) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<CreateUserRequest> getUserByNameWithHttpInfo(String username) throws RestClientException {
        Object localVarPostBody = null;
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public void updateUser(String username, CreateUserRequest createUserRequest) throws RestClientException {
        updateUserWithHttpInfo(username, createUserRequest);
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Void> updateUserWithHttpInfo(String username, CreateUserRequest createUserRequest) throws RestClientException {
        Object localVarPostBody = createUserRequest;

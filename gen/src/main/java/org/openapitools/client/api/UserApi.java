...
public class UserApi {
     ...
     */
    public GetUserProfile200Response getMe() throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<GetUserProfile200Response> getMeWithHttpInfo() throws RestClientException {

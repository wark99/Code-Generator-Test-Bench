...
import org.openapitools.client.model.DeviceActionDeviceAction;
 ...
 */
@JsonPropertyOrder({
  DeviceAction.JSON_PROPERTY_DEVICE_ACTION
})
@JsonTypeName("deviceAction")
...
public class DeviceAction {
  public static final String JSON_PROPERTY_DEVICE_ACTION = "deviceAction";
  private DeviceActionDeviceAction deviceAction;

  public DeviceAction() {
  }

  public DeviceAction deviceAction(DeviceActionDeviceAction deviceAction) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DEVICE_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public DeviceActionDeviceAction getDeviceAction() {
    return deviceAction;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DEVICE_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDeviceAction(DeviceActionDeviceAction deviceAction) {
    this.deviceAction = deviceAction;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeviceAction deviceAction = (DeviceAction) o;
    return Objects.equals(this.deviceAction, deviceAction.deviceAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deviceAction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DeviceAction {\n");
    sb.append("    deviceAction: ").append(toIndentedString(deviceAction)).append("\n");
    sb.append("}");
    return sb.toString();
  }

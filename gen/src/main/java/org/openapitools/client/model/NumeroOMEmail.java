...
import org.openapitools.client.model.NumeroOMEmailData;
 ...
 */
@JsonPropertyOrder({
  NumeroOMEmail.JSON_PROPERTY_TYPE,
  NumeroOMEmail.JSON_PROPERTY_DATA
})
...
public class NumeroOMEmail {
  ...
  private NumeroOMEmailData data;

  public NumeroOMEmail() {
  }

  public NumeroOMEmail type(EnumTypeNotification type) {
  ...
  **/
  ...
  public NumeroOMEmail data(NumeroOMEmailData data) {
  ...
  **/
  ...
  public NumeroOMEmailData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(NumeroOMEmailData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    NumeroOMEmail numeroOMEmail = (NumeroOMEmail) o;
    return Objects.equals(this.type, numeroOMEmail.type) &&
        Objects.equals(this.data, numeroOMEmail.data);
  }

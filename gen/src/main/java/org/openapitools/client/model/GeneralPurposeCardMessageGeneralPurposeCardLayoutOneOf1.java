 ...
 */
@JsonPropertyOrder({
  GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1.JSON_PROPERTY_CARD_ORIENTATION,
  GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1.JSON_PROPERTY_IMAGE_ALIGNMENT,
  GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1.JSON_PROPERTY_TITLE_FONT_STYLE,
  GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1.JSON_PROPERTY_DESCRIPTION_FONT_STYLE,
  GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1.JSON_PROPERTY_STYLE
})
@JsonTypeName("generalPurposeCardMessage_generalPurposeCard_layout_oneOf_1")
...
public class GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1 {
  /**
  ...
  public enum ImageAlignmentEnum {
    ...
    ImageAlignmentEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static ImageAlignmentEnum fromValue(String value) {
  ...
  /**
   * Gets or Sets titleFontStyle
   */
  public enum TitleFontStyleEnum {
    ITALICS("italics"),
    ...
    TitleFontStyleEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static TitleFontStyleEnum fromValue(String value) {
      for (TitleFontStyleEnum b : TitleFontStyleEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  private List<TitleFontStyleEnum> titleFontStyle;

  /**
   * Gets or Sets descriptionFontStyle
   */
  public enum DescriptionFontStyleEnum {
    ITALICS("italics"),
    ...
    DescriptionFontStyleEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static DescriptionFontStyleEnum fromValue(String value) {
      for (DescriptionFontStyleEnum b : DescriptionFontStyleEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  private List<DescriptionFontStyleEnum> descriptionFontStyle;

  public static final String JSON_PROPERTY_STYLE = "style";
  private URI style;

  public GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1() {
  }

  public GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1 cardOrientation(CardOrientationEnum cardOrientation) {
  ...
  **/
  ...
  public GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1 imageAlignment(ImageAlignmentEnum imageAlignment) {
  ...
  **/
  ...
  public GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1 titleFontStyle(List<TitleFontStyleEnum> titleFontStyle) {
    
    this.titleFontStyle = titleFontStyle;
    return this;
  }

  public GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1 addTitleFontStyleItem(TitleFontStyleEnum titleFontStyleItem) {
    if (this.titleFontStyle == null) {
      this.titleFontStyle = new ArrayList<>();
    }
    this.titleFontStyle.add(titleFontStyleItem);
    return this;
  }
  ...
  **/
  ...
  public List<TitleFontStyleEnum> getTitleFontStyle() {
    return titleFontStyle;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TITLE_FONT_STYLE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTitleFontStyle(List<TitleFontStyleEnum> titleFontStyle) {
    this.titleFontStyle = titleFontStyle;
  }


  public GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1 descriptionFontStyle(List<DescriptionFontStyleEnum> descriptionFontStyle) {
    
    this.descriptionFontStyle = descriptionFontStyle;
    return this;
  }

  public GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1 addDescriptionFontStyleItem(DescriptionFontStyleEnum descriptionFontStyleItem) {
    if (this.descriptionFontStyle == null) {
      this.descriptionFontStyle = new ArrayList<>();
    }
    this.descriptionFontStyle.add(descriptionFontStyleItem);
    return this;
  }
  ...
  **/
  ...
  public List<DescriptionFontStyleEnum> getDescriptionFontStyle() {
    return descriptionFontStyle;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DESCRIPTION_FONT_STYLE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDescriptionFontStyle(List<DescriptionFontStyleEnum> descriptionFontStyle) {
    this.descriptionFontStyle = descriptionFontStyle;
  }


  public GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1 style(URI style) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1 generalPurposeCardMessageGeneralPurposeCardLayoutOneOf1 = (GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1) o;
    return Objects.equals(this.cardOrientation, generalPurposeCardMessageGeneralPurposeCardLayoutOneOf1.cardOrientation) &&
        Objects.equals(this.imageAlignment, generalPurposeCardMessageGeneralPurposeCardLayoutOneOf1.imageAlignment) &&
        Objects.equals(this.titleFontStyle, generalPurposeCardMessageGeneralPurposeCardLayoutOneOf1.titleFontStyle) &&
        Objects.equals(this.descriptionFontStyle, generalPurposeCardMessageGeneralPurposeCardLayoutOneOf1.descriptionFontStyle) &&
        Objects.equals(this.style, generalPurposeCardMessageGeneralPurposeCardLayoutOneOf1.style);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cardOrientation, imageAlignment, titleFontStyle, descriptionFontStyle, style);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1 {\n");

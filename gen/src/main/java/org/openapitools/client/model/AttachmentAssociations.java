 ...
 */
@JsonPropertyOrder({
  AttachmentAssociations.JSON_PROPERTY_ID,
  AttachmentAssociations.JSON_PROPERTY_ATTACHMENT_ID,
  AttachmentAssociations.JSON_PROPERTY_CONTEXT_ID,
  AttachmentAssociations.JSON_PROPERTY_CONTEXT_TYPE
})
@JsonTypeName("attachment_associations")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-05-13T19:17:10.693828204Z[Etc/UTC]", comments = "Generator version: 7.4.0")
public class AttachmentAssociations {
  ...
  public AttachmentAssociations() {
  }

  public AttachmentAssociations id(Object id) {
   ...
   /**
   * The unique identifier of an attachment associations record.
   * @return id
  **/
  ...
  public AttachmentAssociations attachmentId(Object attachmentId) {
  ...
  **/
  ...
  public AttachmentAssociations contextId(Object contextId) {
   ...
   /**
   * The unique identifier of the context of this attachment association.
   * @return contextId
  **/
  @javax.annotation.Nullable
  @JsonIgnore
  ...
  public AttachmentAssociations contextType(ContextTypeEnum contextType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AttachmentAssociations attachmentAssociations = (AttachmentAssociations) o;
    return Objects.equals(this.id, attachmentAssociations.id) &&
        equalsNullable(this.attachmentId, attachmentAssociations.attachmentId) &&
        equalsNullable(this.contextId, attachmentAssociations.contextId) &&
        Objects.equals(this.contextType, attachmentAssociations.contextType);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, hashCodeNullable(attachmentId), hashCodeNullable(contextId), contextType);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttachmentAssociations {\n");

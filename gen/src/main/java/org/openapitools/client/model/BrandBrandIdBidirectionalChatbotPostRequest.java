...
import org.openapitools.client.model.RegBiChatbot;
 ...
 */
@JsonPropertyOrder({
  BrandBrandIdBidirectionalChatbotPostRequest.JSON_PROPERTY_CHATBOT
})
@JsonTypeName("_brand__brandId__bidirectional_chatbot_post_request")
...
public class BrandBrandIdBidirectionalChatbotPostRequest {
  public static final String JSON_PROPERTY_CHATBOT = "chatbot";
  private RegBiChatbot chatbot;

  public BrandBrandIdBidirectionalChatbotPostRequest() {
  }

  public BrandBrandIdBidirectionalChatbotPostRequest chatbot(RegBiChatbot chatbot) {
  ...
  **/
  ...
  public RegBiChatbot getChatbot() {
    return chatbot;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CHATBOT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChatbot(RegBiChatbot chatbot) {
    this.chatbot = chatbot;
  }
  ...
  public boolean equals(Object o) {
    ...
    BrandBrandIdBidirectionalChatbotPostRequest brandBrandIdBidirectionalChatbotPostRequest = (BrandBrandIdBidirectionalChatbotPostRequest) o;
    return Objects.equals(this.chatbot, brandBrandIdBidirectionalChatbotPostRequest.chatbot);
  }
  ...
  public String toString() {
    ...
    sb.append("class BrandBrandIdBidirectionalChatbotPostRequest {\n");

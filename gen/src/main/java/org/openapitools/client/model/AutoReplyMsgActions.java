...
import org.openapitools.client.model.CustomReply;
import org.openapitools.client.model.CustomReplyReply;
 ...
 */
@JsonPropertyOrder({
  AutoReplyMsgActions.JSON_PROPERTY_ACTION,
  AutoReplyMsgActions.JSON_PROPERTY_REPLY
})
...
public class AutoReplyMsgActions {
  public static final String JSON_PROPERTY_ACTION = "action";
  private ActionAction action;

  public static final String JSON_PROPERTY_REPLY = "reply";
  private CustomReplyReply reply;

  public AutoReplyMsgActions() {
  }

  public AutoReplyMsgActions action(ActionAction action) {
  ...
  **/
  ...
  public AutoReplyMsgActions reply(CustomReplyReply reply) {
  ...
  **/
  ...
  public CustomReplyReply getReply() {
    return reply;
  }
  ...
  @JsonProperty(JSON_PROPERTY_REPLY)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setReply(CustomReplyReply reply) {
    this.reply = reply;
  }
  ...
  public boolean equals(Object o) {
    ...
    AutoReplyMsgActions autoReplyMsgActions = (AutoReplyMsgActions) o;
    return Objects.equals(this.action, autoReplyMsgActions.action) &&
        Objects.equals(this.reply, autoReplyMsgActions.reply);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutoReplyMsgActions {\n");

...
import org.openapitools.client.model.DetailInfo;
 ...
 */
@JsonPropertyOrder({
  GuideInfo.JSON_PROPERTY_MAX_LINE_COUNT,
  GuideInfo.JSON_PROPERTY_MAX_DISPLAY_TEXT,
  GuideInfo.JSON_PROPERTY_MAX_DESCRIPTION_SIZE,
  GuideInfo.JSON_PROPERTY_IMAGE_WIDTH,
  GuideInfo.JSON_PROPERTY_IMAGE_HEIGHT,
  GuideInfo.JSON_PROPERTY_DETAIL_INFO
})
...
public class GuideInfo {
  public static final String JSON_PROPERTY_MAX_LINE_COUNT = "maxLineCount";
  private Integer maxLineCount;

  public static final String JSON_PROPERTY_MAX_DISPLAY_TEXT = "maxDisplayText";
  private Integer maxDisplayText;
  ...
  public static final String JSON_PROPERTY_DETAIL_INFO = "detailInfo";
  private DetailInfo detailInfo;

  public GuideInfo() {
  }

  public GuideInfo maxLineCount(Integer maxLineCount) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_MAX_LINE_COUNT)
  ...
  public GuideInfo maxDisplayText(Integer maxDisplayText) {
    
    this.maxDisplayText = maxDisplayText;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_MAX_DISPLAY_TEXT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getMaxDisplayText() {
    return maxDisplayText;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MAX_DISPLAY_TEXT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMaxDisplayText(Integer maxDisplayText) {
    this.maxDisplayText = maxDisplayText;
  }


  public GuideInfo maxDescriptionSize(Integer maxDescriptionSize) {
  ...
  **/
  ...
  public GuideInfo imageWidth(Integer imageWidth) {
  ...
  **/
  ...
  public GuideInfo imageHeight(Integer imageHeight) {
  ...
  **/
  ...
  public GuideInfo detailInfo(DetailInfo detailInfo) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_DETAIL_INFO)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.maxLineCount, guideInfo.maxLineCount) &&
        Objects.equals(this.maxDisplayText, guideInfo.maxDisplayText) &&
        Objects.equals(this.maxDescriptionSize, guideInfo.maxDescriptionSize) &&
        Objects.equals(this.imageWidth, guideInfo.imageWidth) &&
        Objects.equals(this.imageHeight, guideInfo.imageHeight) &&
        Objects.equals(this.detailInfo, guideInfo.detailInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(maxLineCount, maxDisplayText, maxDescriptionSize, imageWidth, imageHeight, detailInfo);
  }
  ...
  public String toString() {
    ...
    sb.append("    maxDisplayText: ").append(toIndentedString(maxDisplayText)).append("\n");

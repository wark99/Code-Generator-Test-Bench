 ...
 */
@JsonPropertyOrder({
  RegRCSMessageRCSMessage.JSON_PROPERTY_TRAFFIC_TYPE,
  RegRCSMessageRCSMessage.JSON_PROPERTY_OPENRICHCARD_MESSAGE
})
@JsonTypeName("RegRCSMessage_RCSMessage")
...
public class RegRCSMessageRCSMessage {
  /**
  ...
  public RegRCSMessageRCSMessage() {
  }

  public RegRCSMessageRCSMessage trafficType(TrafficTypeEnum trafficType) {
  ...
  **/
  ...
  public RegRCSMessageRCSMessage openrichcardMessage(OpenrichcardMessageOpenrichcardMessage openrichcardMessage) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RegRCSMessageRCSMessage regRCSMessageRCSMessage = (RegRCSMessageRCSMessage) o;
    return equalsNullable(this.trafficType, regRCSMessageRCSMessage.trafficType) &&
        Objects.equals(this.openrichcardMessage, regRCSMessageRCSMessage.openrichcardMessage);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(trafficType), openrichcardMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegRCSMessageRCSMessage {\n");

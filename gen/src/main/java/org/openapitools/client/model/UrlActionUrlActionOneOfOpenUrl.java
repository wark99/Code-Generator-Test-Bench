 ...
 */
@JsonPropertyOrder({
  UrlActionUrlActionOneOfOpenUrl.JSON_PROPERTY_URL
})
@JsonTypeName("urlAction_urlAction_oneOf_openUrl")
...
public class UrlActionUrlActionOneOfOpenUrl {
  public static final String JSON_PROPERTY_URL = "url";
  private URI url;

  public UrlActionUrlActionOneOfOpenUrl() {
  }

  public UrlActionUrlActionOneOfOpenUrl url(URI url) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UrlActionUrlActionOneOfOpenUrl urlActionUrlActionOneOfOpenUrl = (UrlActionUrlActionOneOfOpenUrl) o;
    return Objects.equals(this.url, urlActionUrlActionOneOfOpenUrl.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class UrlActionUrlActionOneOfOpenUrl {\n");

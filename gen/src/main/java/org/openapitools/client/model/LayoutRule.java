...
import org.openapitools.client.model.LayoutRuleComponentLimit;
 ...
 */
@JsonPropertyOrder({
  LayoutRule.JSON_PROPERTY_PRODUCT_CODE,
  LayoutRule.JSON_PROPERTY_COMPONENT_COUNT,
  LayoutRule.JSON_PROPERTY_COMPONENT_MIN_COUNT,
  LayoutRule.JSON_PROPERTY_BUTTON_COUNT,
  LayoutRule.JSON_PROPERTY_COMPONENT_LIMIT
})
...
public class LayoutRule {
  ...
  public static final String JSON_PROPERTY_COMPONENT_MIN_COUNT = "componentMinCount";
  private Integer componentMinCount;

  public static final String JSON_PROPERTY_BUTTON_COUNT = "buttonCount";
  private Integer buttonCount;

  public static final String JSON_PROPERTY_COMPONENT_LIMIT = "componentLimit";
  private LayoutRuleComponentLimit componentLimit;

  public LayoutRule() {
  }

  public LayoutRule productCode(ProductCodeEnum productCode) {
  ...
  **/
  ...
  public LayoutRule componentCount(Integer componentCount) {
  ...
  **/
  ...
  public LayoutRule componentMinCount(Integer componentMinCount) {
    
    this.componentMinCount = componentMinCount;
    return this;
  }

   /**
   * 레이아웃 정의 시 필요한 최소 컴포넌트 개수 입니다.
   * @return componentMinCount
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_COMPONENT_MIN_COUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getComponentMinCount() {
    return componentMinCount;
  }
  ...
  @JsonProperty(JSON_PROPERTY_COMPONENT_MIN_COUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setComponentMinCount(Integer componentMinCount) {
    this.componentMinCount = componentMinCount;
  }


  public LayoutRule buttonCount(Integer buttonCount) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_BUTTON_COUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public LayoutRule componentLimit(LayoutRuleComponentLimit componentLimit) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_COMPONENT_LIMIT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public LayoutRuleComponentLimit getComponentLimit() {
    return componentLimit;
  }
  ...
  @JsonProperty(JSON_PROPERTY_COMPONENT_LIMIT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setComponentLimit(LayoutRuleComponentLimit componentLimit) {
    this.componentLimit = componentLimit;
  }
  ...
  public boolean equals(Object o) {
    ...
    LayoutRule layoutRule = (LayoutRule) o;
    return Objects.equals(this.productCode, layoutRule.productCode) &&
        Objects.equals(this.componentCount, layoutRule.componentCount) &&
        Objects.equals(this.componentMinCount, layoutRule.componentMinCount) &&
        Objects.equals(this.buttonCount, layoutRule.buttonCount) &&
        Objects.equals(this.componentLimit, layoutRule.componentLimit);
  }

  @Override
  public int hashCode() {
    return Objects.hash(productCode, componentCount, componentMinCount, buttonCount, componentLimit);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LayoutRule {\n");
    sb.append("    productCode: ").append(toIndentedString(productCode)).append("\n");
    sb.append("    componentCount: ").append(toIndentedString(componentCount)).append("\n");
    sb.append("    componentMinCount: ").append(toIndentedString(componentMinCount)).append("\n");
    sb.append("    buttonCount: ").append(toIndentedString(buttonCount)).append("\n");
    sb.append("    componentLimit: ").append(toIndentedString(componentLimit)).append("\n");
    sb.append("}");
    return sb.toString();
  }

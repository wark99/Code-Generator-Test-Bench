 ...
 */
@JsonPropertyOrder({
  ComposeActionComposeActionOneOf.JSON_PROPERTY_COMPOSE_TEXT_MESSAGE
})
@JsonTypeName("composeAction_composeAction_oneOf")
...
public class ComposeActionComposeActionOneOf {
  ...
  public ComposeActionComposeActionOneOf() {
  }

  public ComposeActionComposeActionOneOf composeTextMessage(ComposeActionComposeActionOneOfComposeTextMessage composeTextMessage) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ComposeActionComposeActionOneOf composeActionComposeActionOneOf = (ComposeActionComposeActionOneOf) o;
    return Objects.equals(this.composeTextMessage, composeActionComposeActionOneOf.composeTextMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(composeTextMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ComposeActionComposeActionOneOf {\n");

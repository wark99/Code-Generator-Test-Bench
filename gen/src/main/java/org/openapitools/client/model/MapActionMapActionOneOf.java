 ...
 */
@JsonPropertyOrder({
  MapActionMapActionOneOf.JSON_PROPERTY_SHOW_LOCATION
})
@JsonTypeName("mapAction_mapAction_oneOf")
...
public class MapActionMapActionOneOf {
  ...
  public MapActionMapActionOneOf() {
  }

  public MapActionMapActionOneOf showLocation(MapActionMapActionOneOfShowLocation showLocation) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MapActionMapActionOneOf mapActionMapActionOneOf = (MapActionMapActionOneOf) o;
    return Objects.equals(this.showLocation, mapActionMapActionOneOf.showLocation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(showLocation);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MapActionMapActionOneOf {\n");

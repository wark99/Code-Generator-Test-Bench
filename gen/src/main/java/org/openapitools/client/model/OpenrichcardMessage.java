 ...
 */
@JsonPropertyOrder({
  OpenrichcardMessage.JSON_PROPERTY_OPENRICHCARD_MESSAGE
})
...
public class OpenrichcardMessage {
  ...
  public OpenrichcardMessage() {
  }

  public OpenrichcardMessage openrichcardMessage(OpenrichcardMessageOpenrichcardMessage openrichcardMessage) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OpenrichcardMessage openrichcardMessage = (OpenrichcardMessage) o;
    return Objects.equals(this.openrichcardMessage, openrichcardMessage.openrichcardMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(openrichcardMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OpenrichcardMessage {\n");

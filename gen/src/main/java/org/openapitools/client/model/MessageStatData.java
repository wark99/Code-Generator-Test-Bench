 ...
 */
@JsonPropertyOrder({
  MessageStatData.JSON_PROPERTY_STAT_DATE,
  MessageStatData.JSON_PROPERTY_CORP_ID,
  MessageStatData.JSON_PROPERTY_CORP_REG_NUM,
  MessageStatData.JSON_PROPERTY_BRAND_ID,
  MessageStatData.JSON_PROPERTY_CHATBOT_ID,
  MessageStatData.JSON_PROPERTY_GROUP_ID,
  MessageStatData.JSON_PROPERTY_MESSAGEBASE_ID,
  MessageStatData.JSON_PROPERTY_DELIVERED_COUNT,
  MessageStatData.JSON_PROPERTY_DISPLAYED_COUNT
})
...
public class MessageStatData {
  ...
  public static final String JSON_PROPERTY_DISPLAYED_COUNT = "displayedCount";
  private Integer displayedCount;

  public MessageStatData() {
  }

  public MessageStatData statDate(String statDate) {
  ...
  **/
  ...
  public MessageStatData corpId(String corpId) {
  ...
  **/
  ...
  public MessageStatData corpRegNum(String corpRegNum) {
  ...
  **/
  ...
  public MessageStatData brandId(String brandId) {
  ...
  **/
  ...
  public MessageStatData chatbotId(String chatbotId) {
  ...
  **/
  ...
  public MessageStatData groupId(String groupId) {
  ...
  **/
  ...
  public MessageStatData messagebaseId(String messagebaseId) {
  ...
  **/
  ...
  public MessageStatData deliveredCount(Integer deliveredCount) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_DELIVERED_COUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public MessageStatData displayedCount(Integer displayedCount) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_DISPLAYED_COUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_DISPLAYED_COUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDisplayedCount(Integer displayedCount) {
    this.displayedCount = displayedCount;
  }
  ...
  public boolean equals(Object o) {
    ...
    MessageStatData messageStatData = (MessageStatData) o;
    return Objects.equals(this.statDate, messageStatData.statDate) &&
        Objects.equals(this.corpId, messageStatData.corpId) &&
        Objects.equals(this.corpRegNum, messageStatData.corpRegNum) &&
        Objects.equals(this.brandId, messageStatData.brandId) &&
        Objects.equals(this.chatbotId, messageStatData.chatbotId) &&
        Objects.equals(this.groupId, messageStatData.groupId) &&
        Objects.equals(this.messagebaseId, messageStatData.messagebaseId) &&
        Objects.equals(this.deliveredCount, messageStatData.deliveredCount) &&
        Objects.equals(this.displayedCount, messageStatData.displayedCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(statDate, corpId, corpRegNum, brandId, chatbotId, groupId, messagebaseId, deliveredCount, displayedCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MessageStatData {\n");
    ...
    sb.append("    displayedCount: ").append(toIndentedString(displayedCount)).append("\n");
    sb.append("}");
    return sb.toString();
  }

...
import org.openapitools.client.model.RCSMessageRCSMessage;
 ...
 */
@JsonPropertyOrder({
  RCSMessage.JSON_PROPERTY_RC_S_MESSAGE
})
...
public class RCSMessage {
  ...
  private RCSMessageRCSMessage rcSMessage;

  public RCSMessage() {
  }

  public RCSMessage rcSMessage(RCSMessageRCSMessage rcSMessage) {
  ...
  **/
  ...
  public RCSMessageRCSMessage getRcSMessage() {
    return rcSMessage;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RC_S_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRcSMessage(RCSMessageRCSMessage rcSMessage) {
    this.rcSMessage = rcSMessage;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rcSMessage, rcSMessage.rcSMessage);
  }

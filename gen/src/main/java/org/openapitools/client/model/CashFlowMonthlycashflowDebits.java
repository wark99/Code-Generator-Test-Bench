 ...
 */
@JsonPropertyOrder({
  CashFlowMonthlycashflowDebits.JSON_PROPERTY_MONTH,
  CashFlowMonthlycashflowDebits.JSON_PROPERTY_NUMBER_OF_DEBITS,
  CashFlowMonthlycashflowDebits.JSON_PROPERTY_TOTAL_DEBITS_AMOUNT,
  CashFlowMonthlycashflowDebits.JSON_PROPERTY_LARGEST_DEBIT,
  CashFlowMonthlycashflowDebits.JSON_PROPERTY_NUMBER_OF_DEBITS_LESS_TRANSFERS,
  CashFlowMonthlycashflowDebits.JSON_PROPERTY_TOTAL_DEBITS_AMOUNT_LESS_TRANSFERS,
  CashFlowMonthlycashflowDebits.JSON_PROPERTY_AVERAGE_DEBIT_AMOUNT
})
...
public class CashFlowMonthlycashflowDebits {
  ...
  **/
  ...
  public CashFlowMonthlycashflowDebits totalDebitsAmount(BigDecimal totalDebitsAmount) {
  ...
  **/
  ...
  public CashFlowMonthlycashflowDebits largestDebit(BigDecimal largestDebit) {
  ...
  **/
  ...
  public CashFlowMonthlycashflowDebits totalDebitsAmountLessTransfers(BigDecimal totalDebitsAmountLessTransfers) {
  ...
  **/
  ...
  public CashFlowMonthlycashflowDebits averageDebitAmount(BigDecimal averageDebitAmount) {

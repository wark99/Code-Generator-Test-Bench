...
import org.openapitools.client.model.NumeroOMData;
 ...
 */
@JsonPropertyOrder({
  NumeroOM.JSON_PROPERTY_TYPE,
  NumeroOM.JSON_PROPERTY_DATA
})
...
public class NumeroOM {
  ...
  private NumeroOMData data;

  public NumeroOM() {
  }

  public NumeroOM type(EnumTypeNotification type) {
  ...
  **/
  ...
  public NumeroOM data(NumeroOMData data) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(NumeroOMData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    NumeroOM numeroOM = (NumeroOM) o;
    return Objects.equals(this.type, numeroOM.type) &&
        Objects.equals(this.data, numeroOM.data);
  }

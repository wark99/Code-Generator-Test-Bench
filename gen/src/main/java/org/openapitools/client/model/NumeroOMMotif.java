...
import org.openapitools.client.model.NumeroOMMotifData;
 ...
 */
@JsonPropertyOrder({
  NumeroOMMotif.JSON_PROPERTY_TYPE,
  NumeroOMMotif.JSON_PROPERTY_DATA
})
...
public class NumeroOMMotif {
  ...
  private NumeroOMMotifData data;

  public NumeroOMMotif() {
  }

  public NumeroOMMotif type(EnumTypeNotification type) {
  ...
  **/
  ...
  public NumeroOMMotif data(NumeroOMMotifData data) {
  ...
  **/
  ...
  public NumeroOMMotifData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(NumeroOMMotifData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    NumeroOMMotif numeroOMMotif = (NumeroOMMotif) o;
    return Objects.equals(this.type, numeroOMMotif.type) &&
        Objects.equals(this.data, numeroOMMotif.data);
  }

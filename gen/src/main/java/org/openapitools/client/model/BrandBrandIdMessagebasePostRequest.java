 ...
 */
@JsonPropertyOrder({
  BrandBrandIdMessagebasePostRequest.JSON_PROPERTY_REG_MESSAGEBASES
})
@JsonTypeName("_brand__brandId__messagebase_post_request")
...
public class BrandBrandIdMessagebasePostRequest {
  public static final String JSON_PROPERTY_REG_MESSAGEBASES = "regMessagebases";
  private List<RegMessagebaseInfo> regMessagebases;

  public BrandBrandIdMessagebasePostRequest() {
  }

  public BrandBrandIdMessagebasePostRequest regMessagebases(List<RegMessagebaseInfo> regMessagebases) {
    
    this.regMessagebases = regMessagebases;
    return this;
  }

  public BrandBrandIdMessagebasePostRequest addRegMessagebasesItem(RegMessagebaseInfo regMessagebasesItem) {
    if (this.regMessagebases == null) {
      this.regMessagebases = new ArrayList<>();
    }
    this.regMessagebases.add(regMessagebasesItem);
    return this;
  }

   /**
   * Get regMessagebases
   * @return regMessagebases
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_REG_MESSAGEBASES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<RegMessagebaseInfo> getRegMessagebases() {
    return regMessagebases;
  }
  ...
  @JsonProperty(JSON_PROPERTY_REG_MESSAGEBASES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRegMessagebases(List<RegMessagebaseInfo> regMessagebases) {
    this.regMessagebases = regMessagebases;
  }
  ...
  public boolean equals(Object o) {
    ...
    BrandBrandIdMessagebasePostRequest brandBrandIdMessagebasePostRequest = (BrandBrandIdMessagebasePostRequest) o;
    return Objects.equals(this.regMessagebases, brandBrandIdMessagebasePostRequest.regMessagebases);
  }

  @Override
  public int hashCode() {
    return Objects.hash(regMessagebases);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BrandBrandIdMessagebasePostRequest {\n");
    sb.append("    regMessagebases: ").append(toIndentedString(regMessagebases)).append("\n");
    sb.append("}");
    return sb.toString();
  }

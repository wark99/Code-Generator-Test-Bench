...
import org.openapitools.client.model.RegPersistentMenuL1Action;
 ...
 */
@JsonPropertyOrder({
  RegPersistentMenuL1.JSON_PROPERTY_TYPE,
  RegPersistentMenuL1.JSON_PROPERTY_TITLE,
  RegPersistentMenuL1.JSON_PROPERTY_ORD_NO,
  RegPersistentMenuL1.JSON_PROPERTY_AUTO_REPLY_MSG_ID,
  RegPersistentMenuL1.JSON_PROPERTY_FEED_ID,
  RegPersistentMenuL1.JSON_PROPERTY_ACTION_TYPE,
  RegPersistentMenuL1.JSON_PROPERTY_ACTION
})
@JsonTypeName("RegPersistentMenu_L1")
...
public class RegPersistentMenuL1 {
  /**
   * 대화방 메뉴를 구성하는 메뉴 버튼의 유형입니다.    - reply : 응답 메뉴 버튼(챗봇응답 or 자동메시지)   - feed : 브랜드 소식 연결 버튼   - action : RCS 액션 지정 버튼  
   */
  ...
  /**
   * type이 &#39;action&#39;인 경우, 사용할 RCS 액션 유형을 지정합니다.      - dialerAction : 전화연결     - urlAction : 웹사이트 연결 
   */
  ...
  private RegPersistentMenuL1Action action;

  public RegPersistentMenuL1() {
  }

  public RegPersistentMenuL1 type(TypeEnum type) {
  ...
  **/
  ...
  public RegPersistentMenuL1 title(String title) {
  ...
  **/
  ...
  public RegPersistentMenuL1 ordNo(BigDecimal ordNo) {
  ...
  **/
  ...
  public RegPersistentMenuL1 autoReplyMsgId(String autoReplyMsgId) {
  ...
  **/
  ...
  public RegPersistentMenuL1 feedId(String feedId) {
  ...
  **/
  ...
  public RegPersistentMenuL1 actionType(ActionTypeEnum actionType) {
  ...
  **/
  ...
  public RegPersistentMenuL1 action(RegPersistentMenuL1Action action) {
  ...
  **/
  ...
  public RegPersistentMenuL1Action getAction() {
    return action;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ACTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAction(RegPersistentMenuL1Action action) {
    this.action = action;
  }
  ...
  public boolean equals(Object o) {
    ...
    RegPersistentMenuL1 regPersistentMenuL1 = (RegPersistentMenuL1) o;
    return Objects.equals(this.type, regPersistentMenuL1.type) &&
        Objects.equals(this.title, regPersistentMenuL1.title) &&
        Objects.equals(this.ordNo, regPersistentMenuL1.ordNo) &&
        Objects.equals(this.autoReplyMsgId, regPersistentMenuL1.autoReplyMsgId) &&
        Objects.equals(this.feedId, regPersistentMenuL1.feedId) &&
        Objects.equals(this.actionType, regPersistentMenuL1.actionType) &&
        Objects.equals(this.action, regPersistentMenuL1.action);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, title, ordNo, autoReplyMsgId, feedId, actionType, action);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegPersistentMenuL1 {\n");

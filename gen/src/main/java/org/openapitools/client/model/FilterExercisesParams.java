 ...
 */
@JsonPropertyOrder({
  FilterExercisesParams.JSON_PROPERTY_LIMIT,
  FilterExercisesParams.JSON_PROPERTY_NEXT_TOKEN,
  FilterExercisesParams.JSON_PROPERTY_ID,
  FilterExercisesParams.JSON_PROPERTY_UNTRACKED,
  FilterExercisesParams.JSON_PROPERTY_INACTIVE
})
...
public class FilterExercisesParams {
  ...
  private InclusiveFilter inactive;

  public FilterExercisesParams() {
  }

  public FilterExercisesParams limit(Object limit) {
  ...
  **/
  ...
  public FilterExercisesParams nextToken(Object nextToken) {
  ...
  **/
  ...
  public FilterExercisesParams id(Integer id) {
   ...
   /**
   * Retrieve a single exercise with this ID (response data will be a single object not an array).
   * @return id
  **/
  @javax.annotation.Nullable
  ...
  public FilterExercisesParams untracked(InclusiveFilter untracked) {
   ...
   /**
   * Control whether exercises which are manually input are included
   * @return untracked
  **/
  @javax.annotation.Nullable
  ...
  public FilterExercisesParams inactive(InclusiveFilter inactive) {
   ...
   /**
   * Control whether exercises which have been archived are included
   * @return inactive
  **/
  @javax.annotation.Nullable
  ...
  public InclusiveFilter getInactive() {
    return inactive;
  }
  ...
  @JsonProperty(JSON_PROPERTY_INACTIVE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInactive(InclusiveFilter inactive) {
    this.inactive = inactive;
  }
  ...
  public boolean equals(Object o) {
    ...
    FilterExercisesParams filterExercisesParams = (FilterExercisesParams) o;
    return equalsNullable(this.limit, filterExercisesParams.limit) &&
        equalsNullable(this.nextToken, filterExercisesParams.nextToken) &&
        Objects.equals(this.id, filterExercisesParams.id) &&
        Objects.equals(this.untracked, filterExercisesParams.untracked) &&
        Objects.equals(this.inactive, filterExercisesParams.inactive);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(limit), hashCodeNullable(nextToken), id, untracked, inactive);
  }
  ...
  public String toString() {
    ...
    sb.append("class FilterExercisesParams {\n");

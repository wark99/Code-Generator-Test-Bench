...
import org.openapitools.client.model.PostIstatData;
 ...
 */
@JsonPropertyOrder({
  PostIstat.JSON_PROPERTY_DATA
})
@JsonTypeName("post_istat")
...
public class PostIstat {
  public static final String JSON_PROPERTY_DATA = "data";
  private PostIstatData data;

  public PostIstat() {
  }

  public PostIstat data(PostIstatData data) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(PostIstatData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    PostIstat postIstat = (PostIstat) o;
    return Objects.equals(this.data, postIstat.data);
  }

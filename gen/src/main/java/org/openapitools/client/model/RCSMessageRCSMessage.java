...
import org.openapitools.client.model.OpenrichcardMessageOpenrichcardMessage;
import org.openapitools.client.model.RichcardMessage;
import org.openapitools.client.model.RichcardMessageRichcardMessage;
 ...
 */
@JsonPropertyOrder({
  RCSMessageRCSMessage.JSON_PROPERTY_TRAFFIC_TYPE,
  RCSMessageRCSMessage.JSON_PROPERTY_RICHCARD_MESSAGE,
  RCSMessageRCSMessage.JSON_PROPERTY_OPENRICHCARD_MESSAGE
})
@JsonTypeName("RCSMessage_RCSMessage")
...
public class RCSMessageRCSMessage {
  /**
  ...
  public enum TrafficTypeEnum {
    ...
    @JsonCreator
    public static TrafficTypeEnum fromValue(Object value) {
  ...
  private JsonNullable<TrafficTypeEnum> trafficType = JsonNullable.<TrafficTypeEnum>of(null);

  public static final String JSON_PROPERTY_RICHCARD_MESSAGE = "richcardMessage";
  private RichcardMessageRichcardMessage richcardMessage;

  public static final String JSON_PROPERTY_OPENRICHCARD_MESSAGE = "openrichcardMessage";
  private OpenrichcardMessageOpenrichcardMessage openrichcardMessage;

  public RCSMessageRCSMessage() {
  }

  public RCSMessageRCSMessage trafficType(TrafficTypeEnum trafficType) {
    this.trafficType = JsonNullable.<TrafficTypeEnum>of(trafficType);
  ...
  **/
  ...
  public TrafficTypeEnum getTrafficType() {
        return trafficType.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_TRAFFIC_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<TrafficTypeEnum> getTrafficType_JsonNullable() {
    return trafficType;
  }
  
  @JsonProperty(JSON_PROPERTY_TRAFFIC_TYPE)
  public void setTrafficType_JsonNullable(JsonNullable<TrafficTypeEnum> trafficType) {
  ...
  public RCSMessageRCSMessage richcardMessage(RichcardMessageRichcardMessage richcardMessage) {
    
    this.richcardMessage = richcardMessage;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_RICHCARD_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public RichcardMessageRichcardMessage getRichcardMessage() {
    return richcardMessage;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RICHCARD_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRichcardMessage(RichcardMessageRichcardMessage richcardMessage) {
    this.richcardMessage = richcardMessage;
  }


  public RCSMessageRCSMessage openrichcardMessage(OpenrichcardMessageOpenrichcardMessage openrichcardMessage) {
    
    this.openrichcardMessage = openrichcardMessage;
    return this;
  }

   /**
   * Get openrichcardMessage
   * @return openrichcardMessage
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_OPENRICHCARD_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public OpenrichcardMessageOpenrichcardMessage getOpenrichcardMessage() {
    return openrichcardMessage;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OPENRICHCARD_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOpenrichcardMessage(OpenrichcardMessageOpenrichcardMessage openrichcardMessage) {
    this.openrichcardMessage = openrichcardMessage;
  }
  ...
  public boolean equals(Object o) {
    ...
    RCSMessageRCSMessage rcSMessageRCSMessage = (RCSMessageRCSMessage) o;
    return equalsNullable(this.trafficType, rcSMessageRCSMessage.trafficType) &&
        Objects.equals(this.richcardMessage, rcSMessageRCSMessage.richcardMessage) &&
        Objects.equals(this.openrichcardMessage, rcSMessageRCSMessage.openrichcardMessage);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(trafficType), richcardMessage, openrichcardMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class RCSMessageRCSMessage {\n");
    sb.append("    trafficType: ").append(toIndentedString(trafficType)).append("\n");
    sb.append("    richcardMessage: ").append(toIndentedString(richcardMessage)).append("\n");
    sb.append("    openrichcardMessage: ").append(toIndentedString(openrichcardMessage)).append("\n");
    sb.append("}");
    return sb.toString();
  }

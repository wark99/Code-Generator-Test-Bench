 ...
 */
@JsonPropertyOrder({
  RegChatbotInfo.JSON_PROPERTY_MDN,
  RegChatbotInfo.JSON_PROPERTY_SUB_NUM,
  RegChatbotInfo.JSON_PROPERTY_SUB_TITLE,
  RegChatbotInfo.JSON_PROPERTY_RCS_REPLY,
  RegChatbotInfo.JSON_PROPERTY_DISPLAY,
  RegChatbotInfo.JSON_PROPERTY_INPUT_FIELD,
  RegChatbotInfo.JSON_PROPERTY_SUB_DESCR,
  RegChatbotInfo.JSON_PROPERTY_SAFTY_STATUS_YN
})
...
public class RegChatbotInfo {
  public static final String JSON_PROPERTY_MDN = "mdn";
  private String mdn;
  ...
  /**
   * 대화방 전시 설정값 입니다. 설정하지 않을 경우 기본 &#39;01&#39;로 설정됩니다.      + &#39;11&#39; : 브랜드채널 노출,브랜드검색 허용,브랜드홈 전시     + &#39;10&#39; : 브랜드채널 노출,브랜드검색 허용,브랜드홈 비전시     + &#39;01&#39; : 브랜드채널 노출,브랜드검색 불허,브랜드홈 전시     + &#39;00&#39; : 브랜드채널 노출,브랜드검색 불허,브랜드홈 비전시   
   */
  ...
  private DisplayEnum display = DisplayEnum._01;
  ...
  public RegChatbotInfo() {
  }

  public RegChatbotInfo mdn(String mdn) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_MDN)
  ...
  public RegChatbotInfo subNum(String subNum) {
  ...
  **/
  ...
  public RegChatbotInfo subTitle(String subTitle) {
  ...
  **/
  ...
  public RegChatbotInfo rcsReply(RcsReplyEnum rcsReply) {
  ...
  **/
  ...
  public RegChatbotInfo display(DisplayEnum display) {
  ...
  **/
  ...
  public RegChatbotInfo inputField(InputFieldEnum inputField) {
  ...
  **/
  ...
  public RegChatbotInfo subDescr(String subDescr) {
  ...
  **/
  ...
  public RegChatbotInfo saftyStatusYn(SaftyStatusYnEnum saftyStatusYn) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RegChatbotInfo regChatbotInfo = (RegChatbotInfo) o;
    return Objects.equals(this.mdn, regChatbotInfo.mdn) &&
        Objects.equals(this.subNum, regChatbotInfo.subNum) &&
        Objects.equals(this.subTitle, regChatbotInfo.subTitle) &&
        Objects.equals(this.rcsReply, regChatbotInfo.rcsReply) &&
        Objects.equals(this.display, regChatbotInfo.display) &&
        Objects.equals(this.inputField, regChatbotInfo.inputField) &&
        Objects.equals(this.subDescr, regChatbotInfo.subDescr) &&
        Objects.equals(this.saftyStatusYn, regChatbotInfo.saftyStatusYn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mdn, subNum, subTitle, rcsReply, display, inputField, subDescr, saftyStatusYn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegChatbotInfo {\n");

 ...
 */
@JsonPropertyOrder({
  NotiAgencyKey.JSON_PROPERTY_NOTI_TYPE,
  NotiAgencyKey.JSON_PROPERTY_AGENCY_KEY,
  NotiAgencyKey.JSON_PROPERTY_METHOD,
  NotiAgencyKey.JSON_PROPERTY_DATE,
  NotiAgencyKey.JSON_PROPERTY_USER_NAME
})
...
public class NotiAgencyKey {
  public static final String JSON_PROPERTY_NOTI_TYPE = "notiType";
  private String notiType = "agencykey";
  ...
  public NotiAgencyKey() {
  }

  public NotiAgencyKey notiType(String notiType) {
  ...
  **/
  ...
  public NotiAgencyKey agencyKey(String agencyKey) {
  ...
  **/
  ...
  public NotiAgencyKey method(MethodEnum method) {
  ...
  **/
  ...
  public NotiAgencyKey date(String date) {
  ...
  **/
  ...
  public NotiAgencyKey userName(String userName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    NotiAgencyKey notiAgencyKey = (NotiAgencyKey) o;
    return Objects.equals(this.notiType, notiAgencyKey.notiType) &&
        Objects.equals(this.agencyKey, notiAgencyKey.agencyKey) &&
        Objects.equals(this.method, notiAgencyKey.method) &&
        Objects.equals(this.date, notiAgencyKey.date) &&
        Objects.equals(this.userName, notiAgencyKey.userName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(notiType, agencyKey, method, date, userName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NotiAgencyKey {\n");

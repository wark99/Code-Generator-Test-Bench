...
@JsonPropertyOrder({
  ...
  Category.JSON_PROPERTY_SUB_CATEGORIES,
  Category.JSON_PROPERTY_UPDATE_DATE
})
...
public class Category {
  ...
  public static final String JSON_PROPERTY_SUB_CATEGORIES = "subCategories";
  private List<CategorySubCategoriesInner> subCategories;
  ...
  **/
  ...
  public Category updateDate(OffsetDateTime updateDate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.categoryId, category.categoryId) &&
        ...
        Objects.equals(this.updateDate, category.updateDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(categoryId, categoryName, subCategories, updateDate);
  }

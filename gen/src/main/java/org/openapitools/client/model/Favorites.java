 ...
 */
@JsonPropertyOrder({
  Favorites.JSON_PROPERTY_ID,
  Favorites.JSON_PROPERTY_USER_ID,
  Favorites.JSON_PROPERTY_CREATED_AT,
  Favorites.JSON_PROPERTY_UPDATED_AT,
  Favorites.JSON_PROPERTY_CONTEXT_ID,
  Favorites.JSON_PROPERTY_CONTEXT_TYPE
})
@JsonTypeName("favorites")
...
public class Favorites {
  ...
  public Favorites id(Object id) {
   ...
   /**
   * The unique identifier for a favorite record.
   * @return id
  **/
  ...
  public Favorites userId(Object userId) {
  ...
  **/
  ...
  public Favorites createdAt(Object createdAt) {
   ...
   /**
   * Timestamp of when a favorites record was created.
   * @return createdAt
  **/
  @javax.annotation.Nullable
  ...
  public Favorites updatedAt(Object updatedAt) {
   ...
   /**
   * Timestamp of when a favorites record was updated.
   * @return updatedAt
  **/
  @javax.annotation.Nullable
  ...
  public Favorites contextId(Object contextId) {
   ...
   /**
   * The unique identifier for the favorites&#39;s context (account, course, user).
   * @return contextId
  **/
  @javax.annotation.Nullable
  @JsonIgnore
  ...
  public Favorites contextType(ContextTypeEnum contextType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, favorites.id) &&
        equalsNullable(this.userId, favorites.userId) &&
        Objects.equals(this.createdAt, favorites.createdAt) &&
        Objects.equals(this.updatedAt, favorites.updatedAt) &&
        equalsNullable(this.contextId, favorites.contextId) &&
        Objects.equals(this.contextType, favorites.contextType);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, hashCodeNullable(userId), createdAt, updatedAt, hashCodeNullable(contextId), contextType);
  }

 ...
 */
@JsonPropertyOrder({
  LayoutRuleComponentLimit.JSON_PROPERTY_IMAGE_GROUP,
  LayoutRuleComponentLimit.JSON_PROPERTY_TITLE_GROUP,
  LayoutRuleComponentLimit.JSON_PROPERTY_BANNER_GROUP,
  LayoutRuleComponentLimit.JSON_PROPERTY_DESCRIPTION_GROUP,
  LayoutRuleComponentLimit.JSON_PROPERTY_ITEM_GROUP,
  LayoutRuleComponentLimit.JSON_PROPERTY_THUMB_DESC_GROUP,
  LayoutRuleComponentLimit.JSON_PROPERTY_TABLE_GROUP,
  LayoutRuleComponentLimit.JSON_PROPERTY_THUMBNAIL_GROUP,
  LayoutRuleComponentLimit.JSON_PROPERTY_NOTICE_GROUP,
  LayoutRuleComponentLimit.JSON_PROPERTY_BUTTON_GROUP
})
@JsonTypeName("LayoutRule_componentLimit")
...
public class LayoutRuleComponentLimit {
  public static final String JSON_PROPERTY_IMAGE_GROUP = "ImageGroup";
  private Integer imageGroup;

  public static final String JSON_PROPERTY_TITLE_GROUP = "TitleGroup";
  private Integer titleGroup;

  public static final String JSON_PROPERTY_BANNER_GROUP = "BannerGroup";
  private Integer bannerGroup;

  public static final String JSON_PROPERTY_DESCRIPTION_GROUP = "DescriptionGroup";
  private Integer descriptionGroup;

  public static final String JSON_PROPERTY_ITEM_GROUP = "ItemGroup";
  private Integer itemGroup;

  public static final String JSON_PROPERTY_THUMB_DESC_GROUP = "ThumbDescGroup";
  private Integer thumbDescGroup;

  public static final String JSON_PROPERTY_TABLE_GROUP = "TableGroup";
  private Integer tableGroup;

  public static final String JSON_PROPERTY_THUMBNAIL_GROUP = "ThumbnailGroup";
  private Integer thumbnailGroup;

  public static final String JSON_PROPERTY_NOTICE_GROUP = "NoticeGroup";
  private Integer noticeGroup;

  public static final String JSON_PROPERTY_BUTTON_GROUP = "ButtonGroup";
  private Integer buttonGroup;

  public LayoutRuleComponentLimit() {
  }

  public LayoutRuleComponentLimit imageGroup(Integer imageGroup) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_IMAGE_GROUP)
  ...
  public LayoutRuleComponentLimit titleGroup(Integer titleGroup) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TITLE_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getTitleGroup() {
    return titleGroup;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TITLE_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTitleGroup(Integer titleGroup) {
    this.titleGroup = titleGroup;
  }


  public LayoutRuleComponentLimit bannerGroup(Integer bannerGroup) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_BANNER_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public LayoutRuleComponentLimit descriptionGroup(Integer descriptionGroup) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_DESCRIPTION_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_DESCRIPTION_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDescriptionGroup(Integer descriptionGroup) {
    this.descriptionGroup = descriptionGroup;
  }


  public LayoutRuleComponentLimit itemGroup(Integer itemGroup) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ITEM_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public LayoutRuleComponentLimit thumbDescGroup(Integer thumbDescGroup) {
    
    this.thumbDescGroup = thumbDescGroup;
    return this;
  }

   /**
   * Get thumbDescGroup
   * @return thumbDescGroup
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_THUMB_DESC_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getThumbDescGroup() {
    return thumbDescGroup;
  }
  ...
  @JsonProperty(JSON_PROPERTY_THUMB_DESC_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setThumbDescGroup(Integer thumbDescGroup) {
    this.thumbDescGroup = thumbDescGroup;
  }


  public LayoutRuleComponentLimit tableGroup(Integer tableGroup) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_TABLE_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getTableGroup() {
    return tableGroup;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TABLE_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTableGroup(Integer tableGroup) {
    this.tableGroup = tableGroup;
  }


  public LayoutRuleComponentLimit thumbnailGroup(Integer thumbnailGroup) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_THUMBNAIL_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getThumbnailGroup() {
    return thumbnailGroup;
  }
  ...
  @JsonProperty(JSON_PROPERTY_THUMBNAIL_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setThumbnailGroup(Integer thumbnailGroup) {
    this.thumbnailGroup = thumbnailGroup;
  }


  public LayoutRuleComponentLimit noticeGroup(Integer noticeGroup) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_NOTICE_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public LayoutRuleComponentLimit buttonGroup(Integer buttonGroup) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_BUTTON_GROUP)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public boolean equals(Object o) {
    ...
    LayoutRuleComponentLimit layoutRuleComponentLimit = (LayoutRuleComponentLimit) o;
    return Objects.equals(this.imageGroup, layoutRuleComponentLimit.imageGroup) &&
        Objects.equals(this.titleGroup, layoutRuleComponentLimit.titleGroup) &&
        Objects.equals(this.bannerGroup, layoutRuleComponentLimit.bannerGroup) &&
        Objects.equals(this.descriptionGroup, layoutRuleComponentLimit.descriptionGroup) &&
        Objects.equals(this.itemGroup, layoutRuleComponentLimit.itemGroup) &&
        Objects.equals(this.thumbDescGroup, layoutRuleComponentLimit.thumbDescGroup) &&
        Objects.equals(this.tableGroup, layoutRuleComponentLimit.tableGroup) &&
        Objects.equals(this.thumbnailGroup, layoutRuleComponentLimit.thumbnailGroup) &&
        Objects.equals(this.noticeGroup, layoutRuleComponentLimit.noticeGroup) &&
        Objects.equals(this.buttonGroup, layoutRuleComponentLimit.buttonGroup);
  }

  @Override
  public int hashCode() {
    return Objects.hash(imageGroup, titleGroup, bannerGroup, descriptionGroup, itemGroup, thumbDescGroup, tableGroup, thumbnailGroup, noticeGroup, buttonGroup);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LayoutRuleComponentLimit {\n");
    sb.append("    imageGroup: ").append(toIndentedString(imageGroup)).append("\n");
    sb.append("    titleGroup: ").append(toIndentedString(titleGroup)).append("\n");
    sb.append("    bannerGroup: ").append(toIndentedString(bannerGroup)).append("\n");
    sb.append("    descriptionGroup: ").append(toIndentedString(descriptionGroup)).append("\n");
    sb.append("    itemGroup: ").append(toIndentedString(itemGroup)).append("\n");
    sb.append("    thumbDescGroup: ").append(toIndentedString(thumbDescGroup)).append("\n");
    sb.append("    tableGroup: ").append(toIndentedString(tableGroup)).append("\n");
    sb.append("    thumbnailGroup: ").append(toIndentedString(thumbnailGroup)).append("\n");
    sb.append("    noticeGroup: ").append(toIndentedString(noticeGroup)).append("\n");
    sb.append("    buttonGroup: ").append(toIndentedString(buttonGroup)).append("\n");
    sb.append("}");
    return sb.toString();
  }

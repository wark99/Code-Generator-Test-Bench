 ...
 */
@JsonPropertyOrder({
  TokenPostRequest.JSON_PROPERTY_CLIENT_ID,
  TokenPostRequest.JSON_PROPERTY_CLIENT_SECRET
})
@JsonTypeName("_token_post_request")
...
public class TokenPostRequest {
  ...
  public TokenPostRequest clientId(String clientId) {
   ...
   /**
   * RCS Biz Center에 계정 가입시 등록한 ID 입니다.
   * @return clientId
  **/
  ...
  public TokenPostRequest clientSecret(String clientSecret) {
   ...
   /**
   * RCS Biz Center 내 계정관리에서 확인 가능합니다.
   * @return clientSecret
  **/
  @javax.annotation.Nonnull
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clientId, tokenPostRequest.clientId) &&
        Objects.equals(this.clientSecret, tokenPostRequest.clientSecret);
  }

 ...
 */
@JsonPropertyOrder({
  ImageView.JSON_PROPERTY_WEIGHT,
  ImageView.JSON_PROPERTY_VISIBILITY,
  ImageView.JSON_PROPERTY_BACKGROUND,
  ImageView.JSON_PROPERTY_CORNER_RADIUS,
  ImageView.JSON_PROPERTY_PADDING,
  ImageView.JSON_PROPERTY_PADDING_TOP,
  ImageView.JSON_PROPERTY_PADDING_LEFT,
  ImageView.JSON_PROPERTY_PADDING_RIGHT,
  ImageView.JSON_PROPERTY_PADDING_BOTTOM,
  ImageView.JSON_PROPERTY_MARGIN,
  ImageView.JSON_PROPERTY_MARGIN_TOP,
  ImageView.JSON_PROPERTY_MARGIN_BOTTOM,
  ImageView.JSON_PROPERTY_MARGIN_LEFT,
  ImageView.JSON_PROPERTY_MARGIN_RIGHT,
  ImageView.JSON_PROPERTY_CLICK,
  ImageView.JSON_PROPERTY_WIDGET,
  ImageView.JSON_PROPERTY_MEDIA_URL,
  ImageView.JSON_PROPERTY_MEDIA_CONTENT_TYPE,
  ImageView.JSON_PROPERTY_MEDIA_FILE_SIZE,
  ImageView.JSON_PROPERTY_SCALE_TYPE,
  ImageView.JSON_PROPERTY_WIDTH,
  ImageView.JSON_PROPERTY_HEIGHT,
  ImageView.JSON_PROPERTY_WIDGET_POLICY
})
@JsonTypeName("image_view")
...
public class ImageView {
  ...
  public ImageView weight(Object weight) {
  ...
  **/
  ...
  public ImageView visibility(Visibility visibility) {
  ...
  **/
  ...
  public ImageView background(String background) {
  ...
  **/
  ...
  public ImageView cornerRadius(String cornerRadius) {
  ...
  **/
  ...
  public ImageView padding(String padding) {
  ...
  **/
  ...
  public ImageView paddingTop(String paddingTop) {
  ...
  **/
  ...
  public ImageView paddingLeft(String paddingLeft) {
  ...
  **/
  ...
  public ImageView paddingRight(String paddingRight) {
  ...
  **/
  ...
  public ImageView paddingBottom(String paddingBottom) {
  ...
  **/
  ...
  public ImageView margin(String margin) {
  ...
  **/
  ...
  public ImageView marginTop(String marginTop) {
  ...
  **/
  ...
  public ImageView marginBottom(String marginBottom) {
  ...
  **/
  ...
  public ImageView marginLeft(String marginLeft) {
  ...
  **/
  ...
  public ImageView marginRight(String marginRight) {
  ...
  **/
  ...
  public ImageView click(ViewsClick click) {
  ...
  **/
  ...
  public ImageView widget(WidgetEnum widget) {
  ...
  **/
  ...
  public ImageView mediaUrl(URI mediaUrl) {
  ...
  **/
  ...
  public ImageView mediaContentType(String mediaContentType) {
  ...
  **/
  ...
  public ImageView mediaFileSize(Integer mediaFileSize) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_MEDIA_FILE_SIZE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setMediaFileSize(Integer mediaFileSize) {
    this.mediaFileSize = mediaFileSize;
  }


  public ImageView scaleType(ScaleTypeEnum scaleType) {
  ...
  **/
  ...
  public ImageView width(String width) {
  ...
  **/
  ...
  public ImageView height(String height) {
  ...
  **/
  ...
  public ImageView widgetPolicy(WidgetPolicy widgetPolicy) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.weight, imageView.weight) &&
        Objects.equals(this.visibility, imageView.visibility) &&
        Objects.equals(this.background, imageView.background) &&
        Objects.equals(this.cornerRadius, imageView.cornerRadius) &&
        Objects.equals(this.padding, imageView.padding) &&
        Objects.equals(this.paddingTop, imageView.paddingTop) &&
        Objects.equals(this.paddingLeft, imageView.paddingLeft) &&
        Objects.equals(this.paddingRight, imageView.paddingRight) &&
        Objects.equals(this.paddingBottom, imageView.paddingBottom) &&
        Objects.equals(this.margin, imageView.margin) &&
        Objects.equals(this.marginTop, imageView.marginTop) &&
        Objects.equals(this.marginBottom, imageView.marginBottom) &&
        Objects.equals(this.marginLeft, imageView.marginLeft) &&
        Objects.equals(this.marginRight, imageView.marginRight) &&
        Objects.equals(this.click, imageView.click) &&
        Objects.equals(this.widget, imageView.widget) &&
        Objects.equals(this.mediaUrl, imageView.mediaUrl) &&
        Objects.equals(this.mediaContentType, imageView.mediaContentType) &&
        Objects.equals(this.mediaFileSize, imageView.mediaFileSize) &&
        Objects.equals(this.scaleType, imageView.scaleType) &&
        Objects.equals(this.width, imageView.width) &&
        Objects.equals(this.height, imageView.height) &&
        Objects.equals(this.widgetPolicy, imageView.widgetPolicy);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(weight), visibility, background, cornerRadius, padding, paddingTop, paddingLeft, paddingRight, paddingBottom, margin, marginTop, marginBottom, marginLeft, marginRight, click, widget, mediaUrl, mediaContentType, mediaFileSize, scaleType, width, height, widgetPolicy);
  }

 ...
 */
@JsonPropertyOrder({
  PrivilegeInfo.JSON_PROPERTY_PRIVILEGE_TYPE,
  PrivilegeInfo.JSON_PROPERTY_ID,
  PrivilegeInfo.JSON_PROPERTY_STATUS
})
...
public class PrivilegeInfo {
  /**
   * 권한은 다음과 같이 구분됩니다.  - Manager : 브랜드 관리자(&#x3D;마스터) - SubManager : 브랜드 부관리자(&#x3D;마스터, 매니저) - Agency : 브랜드 대행사 
   */
  public enum PrivilegeTypeEnum {
    ...
    @JsonCreator
    public static PrivilegeTypeEnum fromValue(String value) {
  ...
  public PrivilegeInfo privilegeType(PrivilegeTypeEnum privilegeType) {
  ...
  **/
  ...
  public PrivilegeInfo id(String id) {
  ...
  **/
  ...
  public PrivilegeInfo status(StatusEnum status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.privilegeType, privilegeInfo.privilegeType) &&
        Objects.equals(this.id, privilegeInfo.id) &&
        Objects.equals(this.status, privilegeInfo.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(privilegeType, id, status);
  }

...
import org.openapitools.client.model.MapActionMapActionOneOf;
import org.openapitools.client.model.MapActionMapActionOneOf1;
import org.openapitools.client.model.MapActionMapActionOneOf1RequestLocationPush;
import org.openapitools.client.model.MapActionMapActionOneOfShowLocation;
 ...
 */
@JsonPropertyOrder({
  MapActionMapAction.JSON_PROPERTY_SHOW_LOCATION,
  MapActionMapAction.JSON_PROPERTY_REQUEST_LOCATION_PUSH
})
@JsonTypeName("mapAction_mapAction")
...
public class MapActionMapAction {
  public static final String JSON_PROPERTY_SHOW_LOCATION = "showLocation";
  private MapActionMapActionOneOfShowLocation showLocation;

  public static final String JSON_PROPERTY_REQUEST_LOCATION_PUSH = "requestLocationPush";
  private MapActionMapActionOneOf1RequestLocationPush requestLocationPush;

  public MapActionMapAction() {
  }

  public MapActionMapAction showLocation(MapActionMapActionOneOfShowLocation showLocation) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_SHOW_LOCATION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public MapActionMapActionOneOfShowLocation getShowLocation() {
    return showLocation;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SHOW_LOCATION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setShowLocation(MapActionMapActionOneOfShowLocation showLocation) {
    this.showLocation = showLocation;
  }


  public MapActionMapAction requestLocationPush(MapActionMapActionOneOf1RequestLocationPush requestLocationPush) {
   ...
   /**
   * Get requestLocationPush
   * @return requestLocationPush
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_REQUEST_LOCATION_PUSH)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public MapActionMapActionOneOf1RequestLocationPush getRequestLocationPush() {
    return requestLocationPush;
  }
  ...
  @JsonProperty(JSON_PROPERTY_REQUEST_LOCATION_PUSH)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRequestLocationPush(MapActionMapActionOneOf1RequestLocationPush requestLocationPush) {
    this.requestLocationPush = requestLocationPush;
  }
  ...
  public boolean equals(Object o) {
    ...
    MapActionMapAction mapActionMapAction = (MapActionMapAction) o;
    return Objects.equals(this.showLocation, mapActionMapAction.showLocation) &&
        Objects.equals(this.requestLocationPush, mapActionMapAction.requestLocationPush);
  }
  ...
  public String toString() {
    ...
    sb.append("class MapActionMapAction {\n");
    sb.append("    showLocation: ").append(toIndentedString(showLocation)).append("\n");
    sb.append("    requestLocationPush: ").append(toIndentedString(requestLocationPush)).append("\n");
    sb.append("}");
    return sb.toString();
  }

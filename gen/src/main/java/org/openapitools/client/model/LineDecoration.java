 ...
 */
@JsonPropertyOrder({
  LineDecoration.JSON_PROPERTY_HEIGHT,
  LineDecoration.JSON_PROPERTY_BACKGROUND
})
...
public class LineDecoration {
  ...
  public LineDecoration height(String height) {
   ...
   /**
   * Line의 굵기 지정시 사용합니다.  숫자 뒤에 단위 dp를 반드시 붙여서 입력하여야 합니다. 
   * @return height
  **/
  ...
  public LineDecoration background(String background) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LineDecoration lineDecoration = (LineDecoration) o;
    return Objects.equals(this.height, lineDecoration.height) &&
        Objects.equals(this.background, lineDecoration.background);
  }

  @Override
  public int hashCode() {
    return Objects.hash(height, background);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LineDecoration {\n");

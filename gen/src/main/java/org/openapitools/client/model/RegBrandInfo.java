...
import org.openapitools.client.model.RegBrandInfoRegBrand;
 ...
 */
@JsonPropertyOrder({
  RegBrandInfo.JSON_PROPERTY_REG_BRAND
})
...
public class RegBrandInfo {
  public static final String JSON_PROPERTY_REG_BRAND = "regBrand";
  private RegBrandInfoRegBrand regBrand;

  public RegBrandInfo() {
  }

  public RegBrandInfo regBrand(RegBrandInfoRegBrand regBrand) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_REG_BRAND)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public RegBrandInfoRegBrand getRegBrand() {
    return regBrand;
  }
  ...
  @JsonProperty(JSON_PROPERTY_REG_BRAND)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRegBrand(RegBrandInfoRegBrand regBrand) {
    this.regBrand = regBrand;
  }
  ...
  public boolean equals(Object o) {
    ...
    RegBrandInfo regBrandInfo = (RegBrandInfo) o;
    return Objects.equals(this.regBrand, regBrandInfo.regBrand);
  }

  @Override
  public int hashCode() {
    return Objects.hash(regBrand);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegBrandInfo {\n");
    sb.append("    regBrand: ").append(toIndentedString(regBrand)).append("\n");
    sb.append("}");
    return sb.toString();
  }

 ...
 */
@JsonPropertyOrder({
  IndexPhpMethodActionsGetPageUrlsPostRequest.JSON_PROPERTY_MODULE,
  IndexPhpMethodActionsGetPageUrlsPostRequest.JSON_PROPERTY_FORMAT,
  IndexPhpMethodActionsGetPageUrlsPostRequest.JSON_PROPERTY_METHOD,
  IndexPhpMethodActionsGetPageUrlsPostRequest.JSON_PROPERTY_ID_SITE,
  IndexPhpMethodActionsGetPageUrlsPostRequest.JSON_PROPERTY_PERIOD,
  IndexPhpMethodActionsGetPageUrlsPostRequest.JSON_PROPERTY_DATE,
  IndexPhpMethodActionsGetPageUrlsPostRequest.JSON_PROPERTY_SEGMENT,
  IndexPhpMethodActionsGetPageUrlsPostRequest.JSON_PROPERTY_EXPANDED,
  IndexPhpMethodActionsGetPageUrlsPostRequest.JSON_PROPERTY_ID_SUBTABLE,
  IndexPhpMethodActionsGetPageUrlsPostRequest.JSON_PROPERTY_DEPTH,
  IndexPhpMethodActionsGetPageUrlsPostRequest.JSON_PROPERTY_FLAT,
  IndexPhpMethodActionsGetPageUrlsPostRequest.JSON_PROPERTY_FORMAT_METRICS
})
@JsonTypeName("_index_php_method_Actions_getPageUrls_post_request")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-05-13T19:20:01.495468819Z[Etc/UTC]", comments = "Generator version: 7.4.0")
public class IndexPhpMethodActionsGetPageUrlsPostRequest {
  ...
  public IndexPhpMethodActionsGetPageUrlsPostRequest() {
  }

  public IndexPhpMethodActionsGetPageUrlsPostRequest module(Object module) {
  ...
  **/
  ...
  public IndexPhpMethodActionsGetPageUrlsPostRequest format(Object format) {
  ...
  **/
  ...
  public IndexPhpMethodActionsGetPageUrlsPostRequest method(Object method) {
  ...
  **/
  ...
  public IndexPhpMethodActionsGetPageUrlsPostRequest idSite(Object idSite) {
  ...
  **/
  ...
  public IndexPhpMethodActionsGetPageUrlsPostRequest period(Object period) {
  ...
  **/
  ...
  public IndexPhpMethodActionsGetPageUrlsPostRequest date(Object date) {
  ...
  **/
  ...
  public IndexPhpMethodActionsGetPageUrlsPostRequest segment(Object segment) {
  ...
  **/
  ...
  public IndexPhpMethodActionsGetPageUrlsPostRequest expanded(Object expanded) {
  ...
  **/
  ...
  public IndexPhpMethodActionsGetPageUrlsPostRequest idSubtable(Object idSubtable) {
  ...
  **/
  ...
  public IndexPhpMethodActionsGetPageUrlsPostRequest depth(Object depth) {
  ...
  **/
  ...
  public IndexPhpMethodActionsGetPageUrlsPostRequest flat(Object flat) {
  ...
  **/
  ...
  public IndexPhpMethodActionsGetPageUrlsPostRequest formatMetrics(Object formatMetrics) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IndexPhpMethodActionsGetPageUrlsPostRequest indexPhpMethodActionsGetPageUrlsPostRequest = (IndexPhpMethodActionsGetPageUrlsPostRequest) o;
    return Objects.equals(this.module, indexPhpMethodActionsGetPageUrlsPostRequest.module) &&
        Objects.equals(this.format, indexPhpMethodActionsGetPageUrlsPostRequest.format) &&
        Objects.equals(this.method, indexPhpMethodActionsGetPageUrlsPostRequest.method) &&
        equalsNullable(this.idSite, indexPhpMethodActionsGetPageUrlsPostRequest.idSite) &&
        equalsNullable(this.period, indexPhpMethodActionsGetPageUrlsPostRequest.period) &&
        equalsNullable(this.date, indexPhpMethodActionsGetPageUrlsPostRequest.date) &&
        equalsNullable(this.segment, indexPhpMethodActionsGetPageUrlsPostRequest.segment) &&
        equalsNullable(this.expanded, indexPhpMethodActionsGetPageUrlsPostRequest.expanded) &&
        equalsNullable(this.idSubtable, indexPhpMethodActionsGetPageUrlsPostRequest.idSubtable) &&
        equalsNullable(this.depth, indexPhpMethodActionsGetPageUrlsPostRequest.depth) &&
        equalsNullable(this.flat, indexPhpMethodActionsGetPageUrlsPostRequest.flat) &&
        equalsNullable(this.formatMetrics, indexPhpMethodActionsGetPageUrlsPostRequest.formatMetrics);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(module, format, method, hashCodeNullable(idSite), hashCodeNullable(period), hashCodeNullable(date), hashCodeNullable(segment), hashCodeNullable(expanded), hashCodeNullable(idSubtable), hashCodeNullable(depth), hashCodeNullable(flat), hashCodeNullable(formatMetrics));
  }
  ...
  public String toString() {
    ...
    sb.append("class IndexPhpMethodActionsGetPageUrlsPostRequest {\n");

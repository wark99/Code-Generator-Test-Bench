 ...
 */
@JsonPropertyOrder({
  ConferenceOptionsReturn.JSON_PROPERTY_SUBJECT,
  ConferenceOptionsReturn.JSON_PROPERTY_START_AUDIO_MUTED,
  ConferenceOptionsReturn.JSON_PROPERTY_ENABLE_RECORDING,
  ConferenceOptionsReturn.JSON_PROPERTY_DRIVE_ID,
  ConferenceOptionsReturn.JSON_PROPERTY_ENABLE_MODERATOR_VIDEO,
  ConferenceOptionsReturn.JSON_PROPERTY_START_AUDIO_ONLY,
  ConferenceOptionsReturn.JSON_PROPERTY_LOBBY_ENABLED,
  ConferenceOptionsReturn.JSON_PROPERTY_PASSWORD_ENABLED,
  ConferenceOptionsReturn.JSON_PROPERTY_E2EE_ENABLED
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-05-13T19:18:35.261242100Z[Etc/UTC]", comments = "Generator version: 7.4.0")
public class ConferenceOptionsReturn {
  ...
  public ConferenceOptionsReturn() {
  }

  public ConferenceOptionsReturn subject(String subject) {
  ...
  **/
  ...
  public ConferenceOptionsReturn startAudioMuted(Boolean startAudioMuted) {
  ...
  **/
  ...
  public ConferenceOptionsReturn enableRecording(Boolean enableRecording) {
  ...
  **/
  ...
  public ConferenceOptionsReturn driveId(Integer driveId) {
  ...
  **/
  ...
  public ConferenceOptionsReturn enableModeratorVideo(Boolean enableModeratorVideo) {
  ...
  **/
  ...
  public ConferenceOptionsReturn startAudioOnly(Boolean startAudioOnly) {
  ...
  **/
  ...
  public ConferenceOptionsReturn lobbyEnabled(Boolean lobbyEnabled) {
  ...
  **/
  ...
  public ConferenceOptionsReturn passwordEnabled(Boolean passwordEnabled) {
  ...
  **/
  ...
  public ConferenceOptionsReturn e2eeEnabled(Boolean e2eeEnabled) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ConferenceOptionsReturn conferenceOptionsReturn = (ConferenceOptionsReturn) o;
    return Objects.equals(this.subject, conferenceOptionsReturn.subject) &&
        Objects.equals(this.startAudioMuted, conferenceOptionsReturn.startAudioMuted) &&
        Objects.equals(this.enableRecording, conferenceOptionsReturn.enableRecording) &&
        Objects.equals(this.driveId, conferenceOptionsReturn.driveId) &&
        Objects.equals(this.enableModeratorVideo, conferenceOptionsReturn.enableModeratorVideo) &&
        Objects.equals(this.startAudioOnly, conferenceOptionsReturn.startAudioOnly) &&
        Objects.equals(this.lobbyEnabled, conferenceOptionsReturn.lobbyEnabled) &&
        Objects.equals(this.passwordEnabled, conferenceOptionsReturn.passwordEnabled) &&
        Objects.equals(this.e2eeEnabled, conferenceOptionsReturn.e2eeEnabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subject, startAudioMuted, enableRecording, driveId, enableModeratorVideo, startAudioOnly, lobbyEnabled, passwordEnabled, e2eeEnabled);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConferenceOptionsReturn {\n");

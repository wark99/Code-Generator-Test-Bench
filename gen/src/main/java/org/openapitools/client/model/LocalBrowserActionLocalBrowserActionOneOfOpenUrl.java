 ...
 */
@JsonPropertyOrder({
  LocalBrowserActionLocalBrowserActionOneOfOpenUrl.JSON_PROPERTY_URL,
  LocalBrowserActionLocalBrowserActionOneOfOpenUrl.JSON_PROPERTY_IS_HALF_VIEW,
  LocalBrowserActionLocalBrowserActionOneOfOpenUrl.JSON_PROPERTY_POST_PARAMETER
})
@JsonTypeName("localBrowserAction_localBrowserAction_oneOf_openUrl")
...
public class LocalBrowserActionLocalBrowserActionOneOfOpenUrl {
  public static final String JSON_PROPERTY_URL = "url";
  private URI url;

  public static final String JSON_PROPERTY_IS_HALF_VIEW = "isHalfView";
  private Boolean isHalfView = false;

  public static final String JSON_PROPERTY_POST_PARAMETER = "postParameter";
  private Object postParameter;

  public LocalBrowserActionLocalBrowserActionOneOfOpenUrl() {
  }

  public LocalBrowserActionLocalBrowserActionOneOfOpenUrl url(URI url) {
  ...
  **/
  ...
  public LocalBrowserActionLocalBrowserActionOneOfOpenUrl isHalfView(Boolean isHalfView) {
    
    this.isHalfView = isHalfView;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_IS_HALF_VIEW)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getIsHalfView() {
    return isHalfView;
  }
  ...
  @JsonProperty(JSON_PROPERTY_IS_HALF_VIEW)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIsHalfView(Boolean isHalfView) {
    this.isHalfView = isHalfView;
  }


  public LocalBrowserActionLocalBrowserActionOneOfOpenUrl postParameter(Object postParameter) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_POST_PARAMETER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public boolean equals(Object o) {
    ...
    LocalBrowserActionLocalBrowserActionOneOfOpenUrl localBrowserActionLocalBrowserActionOneOfOpenUrl = (LocalBrowserActionLocalBrowserActionOneOfOpenUrl) o;
    return Objects.equals(this.url, localBrowserActionLocalBrowserActionOneOfOpenUrl.url) &&
        Objects.equals(this.isHalfView, localBrowserActionLocalBrowserActionOneOfOpenUrl.isHalfView) &&
        Objects.equals(this.postParameter, localBrowserActionLocalBrowserActionOneOfOpenUrl.postParameter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(url, isHalfView, postParameter);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LocalBrowserActionLocalBrowserActionOneOfOpenUrl {\n");
    sb.append("    url: ").append(toIndentedString(url)).append("\n");
    sb.append("    isHalfView: ").append(toIndentedString(isHalfView)).append("\n");
    sb.append("    postParameter: ").append(toIndentedString(postParameter)).append("\n");
    sb.append("}");
    return sb.toString();
  }

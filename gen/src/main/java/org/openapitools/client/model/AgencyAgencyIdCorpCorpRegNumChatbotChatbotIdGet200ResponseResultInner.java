 ...
 */
@JsonPropertyOrder({
  AgencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner.JSON_PROPERTY_CORP_REG_NUM,
  AgencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner.JSON_PROPERTY_CHATBOT_ID,
  AgencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner.JSON_PROPERTY_CONDITION_VALUE,
  AgencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner.JSON_PROPERTY_CONDITION_DESCRIPTION
})
@JsonTypeName("_agency__agencyId__corp__corpRegNum__chatbot__chatbotId__get_200_response_result_inner")
...
public class AgencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner {
  ...
  public enum ConditionValueEnum {
    ...
    ConditionValueEnum(Integer value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static ConditionValueEnum fromValue(Integer value) {
      for (ConditionValueEnum b : ConditionValueEnum.values()) {
  ...
  private ConditionValueEnum conditionValue;

  /**
   * conditionValue 에 대한 설명 
   */
  public enum ConditionDescriptionEnum {
    RBC_("RBC 미등록 발신번호"),
    ...
    ConditionDescriptionEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static ConditionDescriptionEnum fromValue(String value) {
      for (ConditionDescriptionEnum b : ConditionDescriptionEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  public static final String JSON_PROPERTY_CONDITION_DESCRIPTION = "conditionDescription";
  private ConditionDescriptionEnum conditionDescription;

  public AgencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner() {
  }

  public AgencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner corpRegNum(String corpRegNum) {
  ...
  **/
  ...
  public AgencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner chatbotId(String chatbotId) {
  ...
  **/
  ...
  public AgencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner conditionValue(ConditionValueEnum conditionValue) {
  ...
  **/
  ...
  public ConditionValueEnum getConditionValue() {
    return conditionValue;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CONDITION_VALUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConditionValue(ConditionValueEnum conditionValue) {
    this.conditionValue = conditionValue;
  }


  public AgencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner conditionDescription(ConditionDescriptionEnum conditionDescription) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CONDITION_DESCRIPTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public ConditionDescriptionEnum getConditionDescription() {
    return conditionDescription;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CONDITION_DESCRIPTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setConditionDescription(ConditionDescriptionEnum conditionDescription) {
    this.conditionDescription = conditionDescription;
  }
  ...
  public boolean equals(Object o) {
    ...
    AgencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner agencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner = (AgencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner) o;
    return Objects.equals(this.corpRegNum, agencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner.corpRegNum) &&
        Objects.equals(this.chatbotId, agencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner.chatbotId) &&
        Objects.equals(this.conditionValue, agencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner.conditionValue) &&
        Objects.equals(this.conditionDescription, agencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner.conditionDescription);
  }

  @Override
  public int hashCode() {
    return Objects.hash(corpRegNum, chatbotId, conditionValue, conditionDescription);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AgencyAgencyIdCorpCorpRegNumChatbotChatbotIdGet200ResponseResultInner {\n");

 ...
 */
@JsonPropertyOrder({
  Rubrics.JSON_PROPERTY_ID,
  Rubrics.JSON_PROPERTY_USER_ID,
  Rubrics.JSON_PROPERTY_CREATED_AT,
  Rubrics.JSON_PROPERTY_UPDATED_AT,
  Rubrics.JSON_PROPERTY_WORKFLOW_STATE,
  Rubrics.JSON_PROPERTY_POINTS_POSSIBLE,
  Rubrics.JSON_PROPERTY_CONTEXT_ID,
  Rubrics.JSON_PROPERTY_CONTEXT_TYPE,
  Rubrics.JSON_PROPERTY_MIGRATION_ID,
  Rubrics.JSON_PROPERTY_HIDE_SCORE_TOTAL,
  Rubrics.JSON_PROPERTY_ASSOCIATION_COUNT,
  Rubrics.JSON_PROPERTY_FREE_FORM_CRITERION_COMMENTS,
  Rubrics.JSON_PROPERTY_TITLE,
  Rubrics.JSON_PROPERTY_DATA
})
@JsonTypeName("rubrics")
...
public class Rubrics {
  ...
  public static final String JSON_PROPERTY_ASSOCIATION_COUNT = "association_count";
  private Object associationCount = null;

  public static final String JSON_PROPERTY_FREE_FORM_CRITERION_COMMENTS = "free_form_criterion_comments";
  private JsonNullable<Object> freeFormCriterionComments = JsonNullable.<Object>of(null);
  ...
  public Rubrics id(Object id) {
   ...
   /**
   * The unique identifier of a rubric record.
   * @return id
  **/
  ...
  public Rubrics userId(Object userId) {
  ...
  **/
  ...
  public Rubrics createdAt(Object createdAt) {
   ...
   /**
   * Timestamp showing when a rubrics record was created.
   * @return createdAt
  **/
  @javax.annotation.Nullable
  ...
  public Rubrics updatedAt(Object updatedAt) {
   ...
   /**
   * Timestamp showing when a rubrics record was updated.
   * @return updatedAt
  **/
  @javax.annotation.Nullable
  ...
  public Rubrics workflowState(WorkflowStateEnum workflowState) {
  ...
  **/
  ...
  public Rubrics pointsPossible(Object pointsPossible) {
  ...
  **/
  ...
  public Rubrics contextId(Object contextId) {
   ...
   /**
   * The unique identifier of a rubric&#39;s context (account, course).
   * @return contextId
  **/
  @javax.annotation.Nullable
  ...
  public Rubrics contextType(ContextTypeEnum contextType) {
  ...
  **/
  ...
  public Rubrics migrationId(Object migrationId) {
  ...
  **/
  ...
  public Rubrics hideScoreTotal(Object hideScoreTotal) {
  ...
  **/
  ...
  public Rubrics associationCount(Object associationCount) {
   ...
   /**
   * The number of associated objects (accounts, courses, assignments).
   * @return associationCount
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ASSOCIATION_COUNT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public Object getAssociationCount() {
    return associationCount;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ASSOCIATION_COUNT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAssociationCount(Object associationCount) {
    this.associationCount = associationCount;
  }


  public Rubrics freeFormCriterionComments(Object freeFormCriterionComments) {
    this.freeFormCriterionComments = JsonNullable.<Object>of(freeFormCriterionComments);
  ...
  **/
  ...
  public Object getFreeFormCriterionComments() {
        return freeFormCriterionComments.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_FREE_FORM_CRITERION_COMMENTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getFreeFormCriterionComments_JsonNullable() {
    return freeFormCriterionComments;
  }
  
  @JsonProperty(JSON_PROPERTY_FREE_FORM_CRITERION_COMMENTS)
  public void setFreeFormCriterionComments_JsonNullable(JsonNullable<Object> freeFormCriterionComments) {
    this.freeFormCriterionComments = freeFormCriterionComments;
  }

  public void setFreeFormCriterionComments(Object freeFormCriterionComments) {
    this.freeFormCriterionComments = JsonNullable.<Object>of(freeFormCriterionComments);
  }


  public Rubrics title(Object title) {
  ...
  **/
  ...
  public Rubrics data(Object data) {
   ...
   /**
   * The data containing all the information for the rubric including each criterion.
   * @return data
  **/
  @javax.annotation.Nullable
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    Rubrics rubrics = (Rubrics) o;
    return Objects.equals(this.id, rubrics.id) &&
        equalsNullable(this.userId, rubrics.userId) &&
        Objects.equals(this.createdAt, rubrics.createdAt) &&
        Objects.equals(this.updatedAt, rubrics.updatedAt) &&
        Objects.equals(this.workflowState, rubrics.workflowState) &&
        equalsNullable(this.pointsPossible, rubrics.pointsPossible) &&
        Objects.equals(this.contextId, rubrics.contextId) &&
        Objects.equals(this.contextType, rubrics.contextType) &&
        equalsNullable(this.migrationId, rubrics.migrationId) &&
        equalsNullable(this.hideScoreTotal, rubrics.hideScoreTotal) &&
        Objects.equals(this.associationCount, rubrics.associationCount) &&
        equalsNullable(this.freeFormCriterionComments, rubrics.freeFormCriterionComments) &&
        equalsNullable(this.title, rubrics.title) &&
        equalsNullable(this.data, rubrics.data);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, hashCodeNullable(userId), createdAt, updatedAt, workflowState, hashCodeNullable(pointsPossible), contextId, contextType, hashCodeNullable(migrationId), hashCodeNullable(hideScoreTotal), associationCount, hashCodeNullable(freeFormCriterionComments), hashCodeNullable(title), hashCodeNullable(data));
  }

 ...
 */
@JsonPropertyOrder({
  RegTemplateInfoButtonsInner.JSON_PROPERTY_SUGGESTIONS
})
@JsonTypeName("RegTemplateInfo_buttons_inner")
...
public class RegTemplateInfoButtonsInner {
  public static final String JSON_PROPERTY_SUGGESTIONS = "suggestions";
  private List<Action> suggestions;

  public RegTemplateInfoButtonsInner() {
  }

  public RegTemplateInfoButtonsInner suggestions(List<Action> suggestions) {
    
    this.suggestions = suggestions;
    return this;
  }

  public RegTemplateInfoButtonsInner addSuggestionsItem(Action suggestionsItem) {
  ...
  **/
  ...
  public List<Action> getSuggestions() {
    return suggestions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUGGESTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSuggestions(List<Action> suggestions) {
    this.suggestions = suggestions;
  }
  ...
  public boolean equals(Object o) {
    ...
    RegTemplateInfoButtonsInner regTemplateInfoButtonsInner = (RegTemplateInfoButtonsInner) o;
    return Objects.equals(this.suggestions, regTemplateInfoButtonsInner.suggestions);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegTemplateInfoButtonsInner {\n");

 ...
 */
@JsonPropertyOrder({
  RegBiChatbot.JSON_PROPERTY_CHATBOT_ID,
  RegBiChatbot.JSON_PROPERTY_SUB_NUM,
  RegBiChatbot.JSON_PROPERTY_SUB_TITLE,
  RegBiChatbot.JSON_PROPERTY_DISPLAY,
  RegBiChatbot.JSON_PROPERTY_SERVICE,
  RegBiChatbot.JSON_PROPERTY_INPUT_FIELD,
  RegBiChatbot.JSON_PROPERTY_BOT_AGENCY_ID,
  RegBiChatbot.JSON_PROPERTY_SUB_DESCR,
  RegBiChatbot.JSON_PROPERTY_SAFTY_STATUS_YN
})
...
public class RegBiChatbot {
  ...
  public RegBiChatbot chatbotId(String chatbotId) {
  ...
  **/
  ...
  public RegBiChatbot subNum(String subNum) {
   ...
   /**
   * 회신번호 입니다.   A2P는 chatbotId와 동일하며, 생략 가능합니다.   service가 chat인 경우 사전에 승인된 대화방(발신번호) 중 하나를 반드시 지정해야 합니다. 
   * @return subNum
  **/
  @javax.annotation.Nonnull
  ...
  public RegBiChatbot subTitle(String subTitle) {
  ...
  **/
  ...
  public RegBiChatbot display(DisplayEnum display) {
  ...
  **/
  ...
  public RegBiChatbot service(ServiceEnum service) {
  ...
  **/
  ...
  public RegBiChatbot inputField(InputFieldEnum inputField) {
  ...
  **/
  ...
  public RegBiChatbot botAgencyId(String botAgencyId) {
  ...
  **/
  ...
  public RegBiChatbot subDescr(String subDescr) {
  ...
  **/
  ...
  public RegBiChatbot saftyStatusYn(SaftyStatusYnEnum saftyStatusYn) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RegBiChatbot regBiChatbot = (RegBiChatbot) o;
    return Objects.equals(this.chatbotId, regBiChatbot.chatbotId) &&
        Objects.equals(this.subNum, regBiChatbot.subNum) &&
        Objects.equals(this.subTitle, regBiChatbot.subTitle) &&
        Objects.equals(this.display, regBiChatbot.display) &&
        Objects.equals(this.service, regBiChatbot.service) &&
        Objects.equals(this.inputField, regBiChatbot.inputField) &&
        Objects.equals(this.botAgencyId, regBiChatbot.botAgencyId) &&
        Objects.equals(this.subDescr, regBiChatbot.subDescr) &&
        Objects.equals(this.saftyStatusYn, regBiChatbot.saftyStatusYn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chatbotId, subNum, subTitle, display, service, inputField, botAgencyId, subDescr, saftyStatusYn);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegBiChatbot {\n");

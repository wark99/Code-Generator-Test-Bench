...
import org.openapitools.client.model.SettingsActionSettingsActionOneOf;
import org.openapitools.client.model.SettingsActionSettingsActionOneOf1;
 ...
 */
@JsonPropertyOrder({
  SettingsActionSettingsAction.JSON_PROPERTY_DISABLE_ANONYMIZATION,
  SettingsActionSettingsAction.JSON_PROPERTY_ENABLE_DISPLAYED_NOTIFICATIONS
})
@JsonTypeName("settingsAction_settingsAction")
...
public class SettingsActionSettingsAction {
  public static final String JSON_PROPERTY_DISABLE_ANONYMIZATION = "disableAnonymization";
  private Object disableAnonymization = null;

  public static final String JSON_PROPERTY_ENABLE_DISPLAYED_NOTIFICATIONS = "enableDisplayedNotifications";
  private Object enableDisplayedNotifications = null;

  public SettingsActionSettingsAction() {
  }

  public SettingsActionSettingsAction disableAnonymization(Object disableAnonymization) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DISABLE_ANONYMIZATION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public Object getDisableAnonymization() {
    return disableAnonymization;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DISABLE_ANONYMIZATION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDisableAnonymization(Object disableAnonymization) {
    this.disableAnonymization = disableAnonymization;
  }


  public SettingsActionSettingsAction enableDisplayedNotifications(Object enableDisplayedNotifications) {
  ...
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_ENABLE_DISPLAYED_NOTIFICATIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public Object getEnableDisplayedNotifications() {
    return enableDisplayedNotifications;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ENABLE_DISPLAYED_NOTIFICATIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEnableDisplayedNotifications(Object enableDisplayedNotifications) {
    this.enableDisplayedNotifications = enableDisplayedNotifications;
  }
  ...
  public boolean equals(Object o) {
    ...
    SettingsActionSettingsAction settingsActionSettingsAction = (SettingsActionSettingsAction) o;
    return Objects.equals(this.disableAnonymization, settingsActionSettingsAction.disableAnonymization) &&
        Objects.equals(this.enableDisplayedNotifications, settingsActionSettingsAction.enableDisplayedNotifications);
  }

  @Override
  public int hashCode() {
    return Objects.hash(disableAnonymization, enableDisplayedNotifications);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SettingsActionSettingsAction {\n");
    sb.append("    disableAnonymization: ").append(toIndentedString(disableAnonymization)).append("\n");
    sb.append("    enableDisplayedNotifications: ").append(toIndentedString(enableDisplayedNotifications)).append("\n");
    sb.append("}");
    return sb.toString();
  }

 ...
 */
@JsonPropertyOrder({
  FixConnectParameters.JSON_PROPERTY_LANGUAGE,
  FixConnectParameters.JSON_PROPERTY_PARTNER_ID,
  FixConnectParameters.JSON_PROPERTY_CUSTOMER_ID,
  FixConnectParameters.JSON_PROPERTY_INSTITUTION_LOGIN_ID,
  FixConnectParameters.JSON_PROPERTY_REDIRECT_URI,
  FixConnectParameters.JSON_PROPERTY_WEBHOOK,
  FixConnectParameters.JSON_PROPERTY_WEBHOOK_CONTENT_TYPE,
  FixConnectParameters.JSON_PROPERTY_WEBHOOK_DATA,
  FixConnectParameters.JSON_PROPERTY_WEBHOOK_HEADERS,
  FixConnectParameters.JSON_PROPERTY_EXPERIENCE,
  FixConnectParameters.JSON_PROPERTY_SINGLE_USE_URL,
  FixConnectParameters.JSON_PROPERTY_IS_WEB_VIEW
})
...
public class FixConnectParameters {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(language, partnerId, customerId, institutionLoginId, redirectUri, webhook, webhookContentType, webhookData, webhookHeaders, experience, singleUseUrl, isWebView);
  }

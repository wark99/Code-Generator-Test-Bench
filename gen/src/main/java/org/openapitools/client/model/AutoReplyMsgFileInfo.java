 ...
 */
@JsonPropertyOrder({
  AutoReplyMsgFileInfo.JSON_PROPERTY_FILE_ID,
  AutoReplyMsgFileInfo.JSON_PROPERTY_URL,
  AutoReplyMsgFileInfo.JSON_PROPERTY_FILE_NAME
})
...
public class AutoReplyMsgFileInfo {
  ...
  public AutoReplyMsgFileInfo() {
  }

  public AutoReplyMsgFileInfo fileId(String fileId) {
  ...
  **/
  ...
  public AutoReplyMsgFileInfo url(String url) {
  ...
  **/
  ...
  public AutoReplyMsgFileInfo fileName(String fileName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AutoReplyMsgFileInfo autoReplyMsgFileInfo = (AutoReplyMsgFileInfo) o;
    return Objects.equals(this.fileId, autoReplyMsgFileInfo.fileId) &&
        Objects.equals(this.url, autoReplyMsgFileInfo.url) &&
        Objects.equals(this.fileName, autoReplyMsgFileInfo.fileName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileId, url, fileName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AutoReplyMsgFileInfo {\n");

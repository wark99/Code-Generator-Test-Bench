 ...
 */
@JsonPropertyOrder({
  MapActionMapActionOneOf1RequestLocationPush.JSON_PROPERTY_CURRENT_LOCATION
})
@JsonTypeName("mapAction_mapAction_oneOf_1_requestLocationPush")
...
public class MapActionMapActionOneOf1RequestLocationPush {
  public static final String JSON_PROPERTY_CURRENT_LOCATION = "currentLocation";
  private Boolean currentLocation;

  public MapActionMapActionOneOf1RequestLocationPush() {
  }

  public MapActionMapActionOneOf1RequestLocationPush currentLocation(Boolean currentLocation) {
   ...
   /**
   * set true to send current location without location selection
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MapActionMapActionOneOf1RequestLocationPush mapActionMapActionOneOf1RequestLocationPush = (MapActionMapActionOneOf1RequestLocationPush) o;
    return Objects.equals(this.currentLocation, mapActionMapActionOneOf1RequestLocationPush.currentLocation);
  }
  ...
  public String toString() {
    ...
    sb.append("class MapActionMapActionOneOf1RequestLocationPush {\n");

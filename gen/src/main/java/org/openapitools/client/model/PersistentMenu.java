...
import org.openapitools.client.model.RegPersistentMenuL0Action;
 ...
 */
@JsonPropertyOrder({
  PersistentMenu.JSON_PROPERTY_POSTBACK_ID,
  PersistentMenu.JSON_PROPERTY_UP_POSTBACK_ID,
  PersistentMenu.JSON_PROPERTY_TYPE,
  PersistentMenu.JSON_PROPERTY_TITLE,
  PersistentMenu.JSON_PROPERTY_ORD_NO,
  PersistentMenu.JSON_PROPERTY_AUTO_REPLY_MSG_ID,
  PersistentMenu.JSON_PROPERTY_ACTION_TYPE,
  PersistentMenu.JSON_PROPERTY_ACTION
})
...
public class PersistentMenu {
  ...
  public static final String JSON_PROPERTY_UP_POSTBACK_ID = "upPostbackId";
  private String upPostbackId;

  /**
   * 대화방 메뉴를 구성하는 메뉴버튼의 유형입니다.   RBC 개편 이후 하위메뉴(type menu)는 허용하지 않습니다.      + menu : 하위메뉴를 갖는 메뉴 버튼 (deprecated)     + reply : 응답 메뉴 버튼(챗봇응답 or 자동메시지)     + feed : 브랜드 소식 연결 버튼   + action : RCS 액션 지정 버튼  
   */
  ...
  private RegPersistentMenuL0Action action;

  public PersistentMenu() {
  }

  public PersistentMenu postbackId(String postbackId) {
   ...
   /**
   * 메뉴에 자동 부여되는 고유ID이며, RBC 자동할당하므로 별도 입력이 불가합니다.
   * @return postbackId
  **/
  ...
  public PersistentMenu upPostbackId(String upPostbackId) {
    
    this.upPostbackId = upPostbackId;
    return this;
  }

   /**
   * 현재 메뉴가 속한 상위 메뉴 버튼의 Postback ID, RBC 자동할당하므로 별도 입력이 불가합니다.
   * @return upPostbackId
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_UP_POSTBACK_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public String getUpPostbackId() {
    return upPostbackId;
  }
  ...
  @JsonProperty(JSON_PROPERTY_UP_POSTBACK_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUpPostbackId(String upPostbackId) {
    this.upPostbackId = upPostbackId;
  }


  public PersistentMenu type(TypeEnum type) {
  ...
  **/
  ...
  public PersistentMenu title(String title) {
  ...
  **/
  ...
  public PersistentMenu ordNo(BigDecimal ordNo) {
  ...
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_ORD_NO)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  public PersistentMenu autoReplyMsgId(String autoReplyMsgId) {
  ...
  **/
  ...
  public String getAutoReplyMsgId() {
    return autoReplyMsgId;
  }
  ...
  @JsonProperty(JSON_PROPERTY_AUTO_REPLY_MSG_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAutoReplyMsgId(String autoReplyMsgId) {
    this.autoReplyMsgId = autoReplyMsgId;
  }


  public PersistentMenu actionType(ActionTypeEnum actionType) {
  ...
  **/
  ...
  public PersistentMenu action(RegPersistentMenuL0Action action) {
  ...
  **/
  ...
  public RegPersistentMenuL0Action getAction() {
    return action;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ACTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAction(RegPersistentMenuL0Action action) {
    this.action = action;
  }
  ...
  public boolean equals(Object o) {
    ...
    PersistentMenu persistentMenu = (PersistentMenu) o;
    return Objects.equals(this.postbackId, persistentMenu.postbackId) &&
        Objects.equals(this.upPostbackId, persistentMenu.upPostbackId) &&
        Objects.equals(this.type, persistentMenu.type) &&
        Objects.equals(this.title, persistentMenu.title) &&
        Objects.equals(this.ordNo, persistentMenu.ordNo) &&
        Objects.equals(this.autoReplyMsgId, persistentMenu.autoReplyMsgId) &&
        Objects.equals(this.actionType, persistentMenu.actionType) &&
        Objects.equals(this.action, persistentMenu.action);
  }

  @Override
  public int hashCode() {
    return Objects.hash(postbackId, upPostbackId, type, title, ordNo, autoReplyMsgId, actionType, action);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PersistentMenu {\n");
    sb.append("    postbackId: ").append(toIndentedString(postbackId)).append("\n");
    sb.append("    upPostbackId: ").append(toIndentedString(upPostbackId)).append("\n");
    sb.append("    type: ").append(toIndentedString(type)).append("\n");
    sb.append("    title: ").append(toIndentedString(title)).append("\n");
    sb.append("    ordNo: ").append(toIndentedString(ordNo)).append("\n");

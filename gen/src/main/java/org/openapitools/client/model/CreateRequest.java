...
import org.openapitools.client.model.CreateRequestBookingDetails;
 ...
 */
@JsonPropertyOrder({
  CreateRequest.JSON_PROPERTY_BOOKING_DETAILS,
  CreateRequest.JSON_PROPERTY_CUSTOMER,
  CreateRequest.JSON_PROPERTY_PRODUCT,
  CreateRequest.JSON_PROPERTY_PARTS
})
...
public class CreateRequest {
  ...
  private CreateRequestBookingDetails bookingDetails;
  ...
  public CreateRequest bookingDetails(CreateRequestBookingDetails bookingDetails) {
  ...
  **/
  ...
  public CreateRequestBookingDetails getBookingDetails() {
    return bookingDetails;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BOOKING_DETAILS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBookingDetails(CreateRequestBookingDetails bookingDetails) {
    this.bookingDetails = bookingDetails;
  }


  public CreateRequest customer(CreateRequestCustomer customer) {
  ...
  **/
  ...
  public CreateRequest product(CreateRequestProduct product) {
  ...
  **/
  ...
  public CreateRequest parts(List<CreateRequestPartsInner> parts) {
    
    this.parts = parts;
    return this;
  }

  public CreateRequest addPartsItem(CreateRequestPartsInner partsItem) {
    if (this.parts == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bookingDetails, createRequest.bookingDetails) &&
        Objects.equals(this.customer, createRequest.customer) &&
        Objects.equals(this.product, createRequest.product) &&
        Objects.equals(this.parts, createRequest.parts);
  }

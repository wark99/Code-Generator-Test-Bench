...
import org.openapitools.client.model.Model204ErrorInfoError;
 ...
 */
@JsonPropertyOrder({
  Model204ErrorInfo.JSON_PROPERTY_STATUS,
  Model204ErrorInfo.JSON_PROPERTY_ERROR
})
@JsonTypeName("204ErrorInfo")
...
public class Model204ErrorInfo {
  public static final String JSON_PROPERTY_STATUS = "status";
  private Integer status;

  public static final String JSON_PROPERTY_ERROR = "error";
  private Model204ErrorInfoError error;

  public Model204ErrorInfo() {
  }

  public Model204ErrorInfo status(Integer status) {
  ...
  **/
  ...
  public Model204ErrorInfo error(Model204ErrorInfoError error) {
  ...
  **/
  ...
  public Model204ErrorInfoError getError() {
    return error;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ERROR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setError(Model204ErrorInfoError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    Model204ErrorInfo _204errorInfo = (Model204ErrorInfo) o;
    return Objects.equals(this.status, _204errorInfo.status) &&
        Objects.equals(this.error, _204errorInfo.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class Model204ErrorInfo {\n");

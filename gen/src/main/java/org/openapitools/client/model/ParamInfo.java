 ...
 */
@JsonPropertyOrder({
  ParamInfo.JSON_PROPERTY_PARAM,
  ParamInfo.JSON_PROPERTY_IS_MANDATORY,
  ParamInfo.JSON_PROPERTY_TYPE,
  ParamInfo.JSON_PROPERTY_CONTENT_TYPE,
  ParamInfo.JSON_PROPERTY_STR_SIZE,
  ParamInfo.JSON_PROPERTY_FILE_SIZE,
  ParamInfo.JSON_PROPERTY_STR_REGX,
  ParamInfo.JSON_PROPERTY_VERIFICATION,
  ParamInfo.JSON_PROPERTY_IMAGE_WIDTH,
  ParamInfo.JSON_PROPERTY_IMAGE_HEIGHT,
  ParamInfo.JSON_PROPERTY_COUPLING_ID,
  ParamInfo.JSON_PROPERTY_INPUT_TEXT,
  ParamInfo.JSON_PROPERTY_RELATION_ID
})
...
public class ParamInfo {
  ...
  public static final String JSON_PROPERTY_STR_SIZE = "strSize";
  private Integer strSize;

  public static final String JSON_PROPERTY_FILE_SIZE = "fileSize";
  private Integer fileSize;

  public static final String JSON_PROPERTY_STR_REGX = "strRegx";
  private String strRegx;
  ...
  public static final String JSON_PROPERTY_COUPLING_ID = "couplingId";
  private String couplingId;

  public static final String JSON_PROPERTY_INPUT_TEXT = "inputText";
  private String inputText;

  public static final String JSON_PROPERTY_RELATION_ID = "relationId";
  private String relationId;

  public ParamInfo() {
  }

  public ParamInfo param(String param) {
  ...
  **/
  ...
  public ParamInfo contentType(ContentTypeEnum contentType) {
  ...
  **/
  ...
  public ParamInfo strSize(Integer strSize) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_STR_SIZE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public ParamInfo fileSize(Integer fileSize) {
  ...
  **/
  ...
  public ParamInfo strRegx(String strRegx) {
   ...
   /**
   * java regular expression, null 인경우 사용하지 않음. 예)      1) 숫자만 : &#39;^[0-9]\\*$&#39;     2) 영문자만 : &#39;[a-zA-Z]\\*$&#39;     3) 한글만 : &#39;^[가-힣]\\*$&#39;     4) 영어 &amp; 숫자만 : &#39;^[a-zA-Z0-9]\\*$&#39;     5) E-Mail : &#39;^[a-zA-Z0-9]+@[a-zA-Z0-9]+$&#39;     6) 휴대폰 : &#39;^01(?:0|1|[6-9])-(?:\\d{3}|\\d{4})-\\d{4}$&#39;     7) 일반전화 : &#39;^\\d{2,3}-\\d{3,4}-\\d{4}$&#39;     8) 주민등록번호 : &#39;\\d{6}\\-[1-4]\\d{6}&#39;     9) IP 주소 : &#39;([0-9]{1,3})\\.([0-9]{1,3})\\.([0-9]{1,3})\\.([0-9]{1,3})&#39;   
   * @return strRegx
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_STR_REGX)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_STR_REGX)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setStrRegx(String strRegx) {
    this.strRegx = strRegx;
  }


  public ParamInfo verification(List<String> verification) {
    
    this.verification = verification;
    return this;
  }

  public ParamInfo addVerificationItem(String verificationItem) {
  ...
  **/
  ...
  public ParamInfo imageWidth(Integer imageWidth) {
  ...
  **/
  ...
  public ParamInfo imageHeight(Integer imageHeight) {
  ...
  **/
  ...
  public ParamInfo couplingId(String couplingId) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_COUPLING_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public ParamInfo inputText(String inputText) {
  ...
  **/
  ...
  public ParamInfo relationId(String relationId) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_RELATION_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.param, paramInfo.param) &&
        Objects.equals(this.isMandatory, paramInfo.isMandatory) &&
        Objects.equals(this.type, paramInfo.type) &&
        Objects.equals(this.contentType, paramInfo.contentType) &&
        Objects.equals(this.strSize, paramInfo.strSize) &&
        Objects.equals(this.fileSize, paramInfo.fileSize) &&
        Objects.equals(this.strRegx, paramInfo.strRegx) &&
        Objects.equals(this.verification, paramInfo.verification) &&
        Objects.equals(this.imageWidth, paramInfo.imageWidth) &&
        Objects.equals(this.imageHeight, paramInfo.imageHeight) &&
        Objects.equals(this.couplingId, paramInfo.couplingId) &&
        Objects.equals(this.inputText, paramInfo.inputText) &&
        Objects.equals(this.relationId, paramInfo.relationId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(param, isMandatory, type, contentType, strSize, fileSize, strRegx, verification, imageWidth, imageHeight, couplingId, inputText, relationId);
  }
  ...
  public String toString() {
    ...
    sb.append("    strSize: ").append(toIndentedString(strSize)).append("\n");
    sb.append("    fileSize: ").append(toIndentedString(fileSize)).append("\n");
    sb.append("    strRegx: ").append(toIndentedString(strRegx)).append("\n");
    ...
    sb.append("    couplingId: ").append(toIndentedString(couplingId)).append("\n");

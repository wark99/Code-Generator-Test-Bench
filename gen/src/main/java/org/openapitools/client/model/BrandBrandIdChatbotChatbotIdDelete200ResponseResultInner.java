...
import org.openapitools.client.model.BrandBrandIdChatbotChatbotIdDelete200ResponseResultInnerReleatedChatbotsInner;
 ...
 */
@JsonPropertyOrder({
  BrandBrandIdChatbotChatbotIdDelete200ResponseResultInner.JSON_PROPERTY_CHATBOT_ID,
  BrandBrandIdChatbotChatbotIdDelete200ResponseResultInner.JSON_PROPERTY_RELEATED_CHATBOTS
})
@JsonTypeName("_brand__brandId__chatbot__chatbotId__delete_200_response_result_inner")
...
public class BrandBrandIdChatbotChatbotIdDelete200ResponseResultInner {
  public static final String JSON_PROPERTY_CHATBOT_ID = "chatbotId";
  private String chatbotId;

  public static final String JSON_PROPERTY_RELEATED_CHATBOTS = "releatedChatbots";
  private List<BrandBrandIdChatbotChatbotIdDelete200ResponseResultInnerReleatedChatbotsInner> releatedChatbots;

  public BrandBrandIdChatbotChatbotIdDelete200ResponseResultInner() {
  }

  public BrandBrandIdChatbotChatbotIdDelete200ResponseResultInner chatbotId(String chatbotId) {
  ...
  **/
  ...
  public BrandBrandIdChatbotChatbotIdDelete200ResponseResultInner releatedChatbots(List<BrandBrandIdChatbotChatbotIdDelete200ResponseResultInnerReleatedChatbotsInner> releatedChatbots) {
    
    this.releatedChatbots = releatedChatbots;
    return this;
  }

  public BrandBrandIdChatbotChatbotIdDelete200ResponseResultInner addReleatedChatbotsItem(BrandBrandIdChatbotChatbotIdDelete200ResponseResultInnerReleatedChatbotsInner releatedChatbotsItem) {
    if (this.releatedChatbots == null) {
      this.releatedChatbots = new ArrayList<>();
    }
    this.releatedChatbots.add(releatedChatbotsItem);
    return this;
  }

   /**
   * 삭제된 chatbotId를 회신번호로 사용하는 함께 삭제된 양방향대화방 리스트
   * @return releatedChatbots
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_RELEATED_CHATBOTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<BrandBrandIdChatbotChatbotIdDelete200ResponseResultInnerReleatedChatbotsInner> getReleatedChatbots() {
    return releatedChatbots;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RELEATED_CHATBOTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setReleatedChatbots(List<BrandBrandIdChatbotChatbotIdDelete200ResponseResultInnerReleatedChatbotsInner> releatedChatbots) {
    this.releatedChatbots = releatedChatbots;
  }
  ...
  public boolean equals(Object o) {
    ...
    BrandBrandIdChatbotChatbotIdDelete200ResponseResultInner brandBrandIdChatbotChatbotIdDelete200ResponseResultInner = (BrandBrandIdChatbotChatbotIdDelete200ResponseResultInner) o;
    return Objects.equals(this.chatbotId, brandBrandIdChatbotChatbotIdDelete200ResponseResultInner.chatbotId) &&
        Objects.equals(this.releatedChatbots, brandBrandIdChatbotChatbotIdDelete200ResponseResultInner.releatedChatbots);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chatbotId, releatedChatbots);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BrandBrandIdChatbotChatbotIdDelete200ResponseResultInner {\n");
    sb.append("    chatbotId: ").append(toIndentedString(chatbotId)).append("\n");
    sb.append("    releatedChatbots: ").append(toIndentedString(releatedChatbots)).append("\n");
    sb.append("}");
    return sb.toString();
  }

...
import org.openapitools.client.model.RegRCSMessageRCSMessage;
 ...
 */
@JsonPropertyOrder({
  RegRCSMessage.JSON_PROPERTY_RC_S_MESSAGE
})
...
public class RegRCSMessage {
  public static final String JSON_PROPERTY_RC_S_MESSAGE = "RCSMessage";
  private RegRCSMessageRCSMessage rcSMessage;

  public RegRCSMessage() {
  }

  public RegRCSMessage rcSMessage(RegRCSMessageRCSMessage rcSMessage) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_RC_S_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public RegRCSMessageRCSMessage getRcSMessage() {
    return rcSMessage;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RC_S_MESSAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRcSMessage(RegRCSMessageRCSMessage rcSMessage) {
    this.rcSMessage = rcSMessage;
  }
  ...
  public boolean equals(Object o) {
    ...
    RegRCSMessage regRCSMessage = (RegRCSMessage) o;
    return Objects.equals(this.rcSMessage, regRCSMessage.rcSMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rcSMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegRCSMessage {\n");
    sb.append("    rcSMessage: ").append(toIndentedString(rcSMessage)).append("\n");
    sb.append("}");
    return sb.toString();
  }

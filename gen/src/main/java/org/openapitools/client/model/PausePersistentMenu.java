 ...
 */
@JsonPropertyOrder({
  PausePersistentMenu.JSON_PROPERTY_IS_PAUSE
})
...
public class PausePersistentMenu {
  public static final String JSON_PROPERTY_IS_PAUSE = "isPause";
  private Boolean isPause = true;

  public PausePersistentMenu() {
  }

  public PausePersistentMenu isPause(Boolean isPause) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PausePersistentMenu pausePersistentMenu = (PausePersistentMenu) o;
    return Objects.equals(this.isPause, pausePersistentMenu.isPause);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isPause);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PausePersistentMenu {\n");

 ...
 */
@JsonPropertyOrder({
  CustomReplyReplyPostback.JSON_PROPERTY_DATA
})
@JsonTypeName("CustomReply_reply_postback")
...
public class CustomReplyReplyPostback {
  public static final String JSON_PROPERTY_DATA = "data";
  private String data;

  public CustomReplyReplyPostback() {
  }

  public CustomReplyReplyPostback data(String data) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomReplyReplyPostback customReplyReplyPostback = (CustomReplyReplyPostback) o;
    return Objects.equals(this.data, customReplyReplyPostback.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomReplyReplyPostback {\n");

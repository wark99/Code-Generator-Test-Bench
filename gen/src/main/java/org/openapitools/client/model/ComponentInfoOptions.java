...
import org.openapitools.client.model.ButtonOption;
import org.openapitools.client.model.TableOption;
 ...
 */
@JsonPropertyOrder({
  ComponentInfoOptions.JSON_PROPERTY_LEFT_ALIGN,
  ComponentInfoOptions.JSON_PROPERTY_RIGHT_ALIGN,
  ComponentInfoOptions.JSON_PROPERTY_LEFT_TEXT_STYLE,
  ComponentInfoOptions.JSON_PROPERTY_RIGHT_TEXT_STYLE,
  ComponentInfoOptions.JSON_PROPERTY_MAX_COUNT,
  ComponentInfoOptions.JSON_PROPERTY_COLOR
})
@JsonTypeName("ComponentInfo_options")
...
public class ComponentInfoOptions {
  /**
   * 좌측 컬럼(열) 전체의 글자 정렬 위치를 설정합니다.      + left : 좌측 정렬     + right : 우측 정렬     + center : 중앙 정렬 
   */
  public enum LeftAlignEnum {
    LEFT("left"),
    ...
    @JsonCreator
    public static LeftAlignEnum fromValue(Object value) {
      for (LeftAlignEnum b : LeftAlignEnum.values()) {
  ...
  public static final String JSON_PROPERTY_LEFT_ALIGN = "leftAlign";
  private JsonNullable<LeftAlignEnum> leftAlign = JsonNullable.<LeftAlignEnum>of(left);

  /**
   * 우측 컬럼(열) 전체의 글자 정렬 위치를 설정합니다.      + left : 좌측 정렬     + right : 우측 정렬     + center : 중앙 정렬 
   */
  public enum RightAlignEnum {
    LEFT("left"),
    ...
    @JsonCreator
    public static RightAlignEnum fromValue(Object value) {
      for (RightAlignEnum b : RightAlignEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  public static final String JSON_PROPERTY_RIGHT_ALIGN = "rightAlign";
  private JsonNullable<RightAlignEnum> rightAlign = JsonNullable.<RightAlignEnum>of(right);

  /**
   * 좌측 컬럼(열)에 입력되는 글자 스타일을 지정합니다.      + normal : 기본 스타일   + bold : bold 스타일 적용 
   */
  public enum LeftTextStyleEnum {
    NORMAL("normal"),
    ...
    LeftTextStyleEnum(Object value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static LeftTextStyleEnum fromValue(Object value) {
      for (LeftTextStyleEnum b : LeftTextStyleEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  public static final String JSON_PROPERTY_LEFT_TEXT_STYLE = "leftTextStyle";
  private JsonNullable<LeftTextStyleEnum> leftTextStyle = JsonNullable.<LeftTextStyleEnum>of(normal);

  /**
   * 우측 컬럼(열)에 입력되는 글자 스타일을 지정합니다.      + normal : 기본 스타일   + bold : bold 스타일 적용 
   */
  public enum RightTextStyleEnum {
    NORMAL("normal"),
    ...
    RightTextStyleEnum(Object value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static RightTextStyleEnum fromValue(Object value) {
      for (RightTextStyleEnum b : RightTextStyleEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  public static final String JSON_PROPERTY_RIGHT_TEXT_STYLE = "rightTextStyle";
  private JsonNullable<RightTextStyleEnum> rightTextStyle = JsonNullable.<RightTextStyleEnum>of(normal);

  /**
   * 테이블의 행 개수를 지정합니다. 정의된 숫자 이외에는 지정할 수 없습니다.      + 5 : 5행   + 10 : 10행 
   */
  public enum MaxCountEnum {
    ...
    @JsonCreator
    public static MaxCountEnum fromValue(Object value) {
      for (MaxCountEnum b : MaxCountEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  private JsonNullable<MaxCountEnum> maxCount = JsonNullable.<MaxCountEnum>of(5);

  public static final String JSON_PROPERTY_COLOR = "color";
  private JsonNullable<Object> color = JsonNullable.<Object>of(null);

  public ComponentInfoOptions() {
  }

  public ComponentInfoOptions leftAlign(LeftAlignEnum leftAlign) {
    this.leftAlign = JsonNullable.<LeftAlignEnum>of(leftAlign);
  ...
  **/
  ...
  public LeftAlignEnum getLeftAlign() {
        return leftAlign.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_LEFT_ALIGN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<LeftAlignEnum> getLeftAlign_JsonNullable() {
    return leftAlign;
  }
  
  @JsonProperty(JSON_PROPERTY_LEFT_ALIGN)
  public void setLeftAlign_JsonNullable(JsonNullable<LeftAlignEnum> leftAlign) {
    this.leftAlign = leftAlign;
  }

  public void setLeftAlign(LeftAlignEnum leftAlign) {
    this.leftAlign = JsonNullable.<LeftAlignEnum>of(leftAlign);
  }


  public ComponentInfoOptions rightAlign(RightAlignEnum rightAlign) {
    this.rightAlign = JsonNullable.<RightAlignEnum>of(rightAlign);
  ...
  **/
  ...
  public RightAlignEnum getRightAlign() {
        return rightAlign.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_RIGHT_ALIGN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<RightAlignEnum> getRightAlign_JsonNullable() {
    return rightAlign;
  }
  
  @JsonProperty(JSON_PROPERTY_RIGHT_ALIGN)
  public void setRightAlign_JsonNullable(JsonNullable<RightAlignEnum> rightAlign) {
    this.rightAlign = rightAlign;
  }

  public void setRightAlign(RightAlignEnum rightAlign) {
    this.rightAlign = JsonNullable.<RightAlignEnum>of(rightAlign);
  }


  public ComponentInfoOptions leftTextStyle(LeftTextStyleEnum leftTextStyle) {
    this.leftTextStyle = JsonNullable.<LeftTextStyleEnum>of(leftTextStyle);
  ...
  **/
  ...
  public LeftTextStyleEnum getLeftTextStyle() {
        return leftTextStyle.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_LEFT_TEXT_STYLE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<LeftTextStyleEnum> getLeftTextStyle_JsonNullable() {
    return leftTextStyle;
  }
  
  @JsonProperty(JSON_PROPERTY_LEFT_TEXT_STYLE)
  public void setLeftTextStyle_JsonNullable(JsonNullable<LeftTextStyleEnum> leftTextStyle) {
    this.leftTextStyle = leftTextStyle;
  }

  public void setLeftTextStyle(LeftTextStyleEnum leftTextStyle) {
    this.leftTextStyle = JsonNullable.<LeftTextStyleEnum>of(leftTextStyle);
  }


  public ComponentInfoOptions rightTextStyle(RightTextStyleEnum rightTextStyle) {
    this.rightTextStyle = JsonNullable.<RightTextStyleEnum>of(rightTextStyle);
  ...
  **/
  ...
  public RightTextStyleEnum getRightTextStyle() {
        return rightTextStyle.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_RIGHT_TEXT_STYLE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<RightTextStyleEnum> getRightTextStyle_JsonNullable() {
    return rightTextStyle;
  }
  
  @JsonProperty(JSON_PROPERTY_RIGHT_TEXT_STYLE)
  public void setRightTextStyle_JsonNullable(JsonNullable<RightTextStyleEnum> rightTextStyle) {
    this.rightTextStyle = rightTextStyle;
  }

  public void setRightTextStyle(RightTextStyleEnum rightTextStyle) {
    this.rightTextStyle = JsonNullable.<RightTextStyleEnum>of(rightTextStyle);
  }


  public ComponentInfoOptions maxCount(MaxCountEnum maxCount) {
    this.maxCount = JsonNullable.<MaxCountEnum>of(maxCount);
  ...
  **/
  ...
  public MaxCountEnum getMaxCount() {
        return maxCount.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_MAX_COUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<MaxCountEnum> getMaxCount_JsonNullable() {
    return maxCount;
  }
  
  @JsonProperty(JSON_PROPERTY_MAX_COUNT)
  public void setMaxCount_JsonNullable(JsonNullable<MaxCountEnum> maxCount) {
    this.maxCount = maxCount;
  }

  public void setMaxCount(MaxCountEnum maxCount) {
    this.maxCount = JsonNullable.<MaxCountEnum>of(maxCount);
  }


  public ComponentInfoOptions color(Object color) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ComponentInfoOptions componentInfoOptions = (ComponentInfoOptions) o;
    return equalsNullable(this.leftAlign, componentInfoOptions.leftAlign) &&
        equalsNullable(this.rightAlign, componentInfoOptions.rightAlign) &&
        equalsNullable(this.leftTextStyle, componentInfoOptions.leftTextStyle) &&
        equalsNullable(this.rightTextStyle, componentInfoOptions.rightTextStyle) &&
        equalsNullable(this.maxCount, componentInfoOptions.maxCount) &&
        equalsNullable(this.color, componentInfoOptions.color);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(leftAlign), hashCodeNullable(rightAlign), hashCodeNullable(leftTextStyle), hashCodeNullable(rightTextStyle), hashCodeNullable(maxCount), hashCodeNullable(color));
  }
  ...
  public String toString() {
    ...
    sb.append("class ComponentInfoOptions {\n");
    sb.append("    leftAlign: ").append(toIndentedString(leftAlign)).append("\n");
    sb.append("    rightAlign: ").append(toIndentedString(rightAlign)).append("\n");
    sb.append("    leftTextStyle: ").append(toIndentedString(leftTextStyle)).append("\n");
    sb.append("    rightTextStyle: ").append(toIndentedString(rightTextStyle)).append("\n");

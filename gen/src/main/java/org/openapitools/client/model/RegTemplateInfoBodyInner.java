...
import org.openapitools.client.model.LineDecoration;
import org.openapitools.client.model.LineObject;
import org.openapitools.client.model.StringObject;
 ...
 */
@JsonPropertyOrder({
  RegTemplateInfoBodyInner.JSON_PROPERTY_PARAM,
  RegTemplateInfoBodyInner.JSON_PROPERTY_VALUE,
  RegTemplateInfoBodyInner.JSON_PROPERTY_DECORATION,
  RegTemplateInfoBodyInner.JSON_PROPERTY_LINE_INDEX
})
@JsonTypeName("RegTemplateInfo_body_inner")
...
public class RegTemplateInfoBodyInner {
  ...
  /**
   * 템플릿에 Line을 행별로 표시합니다.  현재는 스타일(Cell) 템플릿에서 Text 행 아래 삽입되며 총 9개까지 지원합니다.   lineIndex 값은 템플릿 내의 지정 위치 값을 의미 합니다. 예를 들어 lineIndex 2는 두번째 Text 행 아래 입니다. 
   */
  public enum LineIndexEnum {
    _1("1"),
    ...
    @JsonCreator
    public static LineIndexEnum fromValue(Object value) {
      for (LineIndexEnum b : LineIndexEnum.values()) {
  ...
  public static final String JSON_PROPERTY_LINE_INDEX = "lineIndex";
  private LineIndexEnum lineIndex = null;

  public RegTemplateInfoBodyInner() {
  }

  public RegTemplateInfoBodyInner param(Object param) {
   ...
   /**
   * messagebaseform JSON의 ROOT.params[n-1].param 과 동일한 값으로 템플릿 구성 File(이미지)의 표시 위치에 해당합니다.
   * maximum: 20
   * @return param
  **/
  ...
  public RegTemplateInfoBodyInner value(Object value) {
   ...
   /**
   * 템플릿에 지정할 File(이미지) - maapfile://{fileId} 형식으로 입력합니다.
   * maximum: 20
   * @return value
  **/
  @javax.annotation.Nullable
  ...
  public RegTemplateInfoBodyInner decoration(LineDecoration decoration) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_DECORATION)
  ...
  @JsonProperty(JSON_PROPERTY_DECORATION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDecoration(LineDecoration decoration) {
    this.decoration = decoration;
  }


  public RegTemplateInfoBodyInner lineIndex(LineIndexEnum lineIndex) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_LINE_INDEX)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public LineIndexEnum getLineIndex() {
    return lineIndex;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LINE_INDEX)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLineIndex(LineIndexEnum lineIndex) {
    this.lineIndex = lineIndex;
  }
  ...
  public boolean equals(Object o) {
    ...
    RegTemplateInfoBodyInner regTemplateInfoBodyInner = (RegTemplateInfoBodyInner) o;
    return Objects.equals(this.param, regTemplateInfoBodyInner.param) &&
        Objects.equals(this.value, regTemplateInfoBodyInner.value) &&
        Objects.equals(this.decoration, regTemplateInfoBodyInner.decoration) &&
        Objects.equals(this.lineIndex, regTemplateInfoBodyInner.lineIndex);
  }

  @Override
  public int hashCode() {
    return Objects.hash(param, value, decoration, lineIndex);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegTemplateInfoBodyInner {\n");
    sb.append("    param: ").append(toIndentedString(param)).append("\n");
    sb.append("    value: ").append(toIndentedString(value)).append("\n");
    sb.append("    decoration: ").append(toIndentedString(decoration)).append("\n");
    sb.append("    lineIndex: ").append(toIndentedString(lineIndex)).append("\n");
    sb.append("}");
    return sb.toString();
  }

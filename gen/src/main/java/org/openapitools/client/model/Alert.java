...
public class Alert {
  ...
  /**
   * Event source:   - beakon: Public Safety Radio   - news: Internet News   - 511: 511.org API   - NWS: National Weather Service API
   */
  ...
  **/
  ...
  public Alert source(SourceEnum source) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, source, tags, dateCreated, location, hashCodeNullable(geometry), title, description, certainty, urgency, severity);
  }

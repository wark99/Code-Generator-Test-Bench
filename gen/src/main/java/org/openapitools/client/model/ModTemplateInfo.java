 ...
 */
@JsonPropertyOrder({
  ModTemplateInfo.JSON_PROPERTY_BRAND_ID,
  ModTemplateInfo.JSON_PROPERTY_MESSAGEBASEFORM_ID,
  ModTemplateInfo.JSON_PROPERTY_TMPLT_NAME,
  ModTemplateInfo.JSON_PROPERTY_AGENCY_ID,
  ModTemplateInfo.JSON_PROPERTY_BODY,
  ModTemplateInfo.JSON_PROPERTY_BUTTONS
})
...
public class ModTemplateInfo {
  ...
  public ModTemplateInfo() {
  }

  public ModTemplateInfo brandId(String brandId) {
  ...
  **/
  ...
  public ModTemplateInfo messagebaseformId(String messagebaseformId) {
  ...
  **/
  ...
  public ModTemplateInfo tmpltName(String tmpltName) {
  ...
  **/
  ...
  public ModTemplateInfo agencyId(String agencyId) {
  ...
  **/
  ...
  public ModTemplateInfo body(List<RegTemplateInfoBodyInner> body) {
    
    this.body = body;
    return this;
  }

  public ModTemplateInfo addBodyItem(RegTemplateInfoBodyInner bodyItem) {
    if (this.body == null) {
   ...
   /**
   * messagebaseform JSON의 ROOT.params[n-1] object의 type 이 file, string 인 경우, 각 속성에 맞는 데이터 Object를 사용하여 템플릿을 구성합니다. messageabseform JSON의 ROOT.params[n-1].isMandatory 가 true 이면 템플릿 등록을 위해 필수로 등록해야 하는 요소이므로 반드시 데이터를 설정해야 템플릿 등록이 가능합니다. 
   * @return body
  **/
  @javax.annotation.Nonnull
  ...
  public ModTemplateInfo buttons(List<RegTemplateInfoButtonsInner> buttons) {
    
    this.buttons = buttons;
    return this;
  }

  public ModTemplateInfo addButtonsItem(RegTemplateInfoButtonsInner buttonsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModTemplateInfo modTemplateInfo = (ModTemplateInfo) o;
    return Objects.equals(this.brandId, modTemplateInfo.brandId) &&
        Objects.equals(this.messagebaseformId, modTemplateInfo.messagebaseformId) &&
        Objects.equals(this.tmpltName, modTemplateInfo.tmpltName) &&
        Objects.equals(this.agencyId, modTemplateInfo.agencyId) &&
        Objects.equals(this.body, modTemplateInfo.body) &&
        Objects.equals(this.buttons, modTemplateInfo.buttons);
  }

  @Override
  public int hashCode() {
    return Objects.hash(brandId, messagebaseformId, tmpltName, agencyId, body, buttons);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ModTemplateInfo {\n");

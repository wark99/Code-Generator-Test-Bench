 ...
 */
@JsonPropertyOrder({
  ComposeAction.JSON_PROPERTY_COMPOSE_ACTION
})
@JsonTypeName("composeAction")
...
public class ComposeAction {
  ...
  public ComposeAction composeAction(ComposeActionComposeAction composeAction) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ComposeAction composeAction = (ComposeAction) o;
    return Objects.equals(this.composeAction, composeAction.composeAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(composeAction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ComposeAction {\n");

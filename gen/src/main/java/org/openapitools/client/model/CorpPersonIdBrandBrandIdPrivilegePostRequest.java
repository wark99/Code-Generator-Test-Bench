...
import org.openapitools.client.model.RegPrivilegeInfo;
 ...
 */
@JsonPropertyOrder({
  CorpPersonIdBrandBrandIdPrivilegePostRequest.JSON_PROPERTY_REG_PRIVILEGES
})
@JsonTypeName("_corp__personId__brand__brandId__privilege_post_request")
...
public class CorpPersonIdBrandBrandIdPrivilegePostRequest {
  public static final String JSON_PROPERTY_REG_PRIVILEGES = "regPrivileges";
  private List<RegPrivilegeInfo> regPrivileges;

  public CorpPersonIdBrandBrandIdPrivilegePostRequest() {
  }

  public CorpPersonIdBrandBrandIdPrivilegePostRequest regPrivileges(List<RegPrivilegeInfo> regPrivileges) {
    
    this.regPrivileges = regPrivileges;
    return this;
  }

  public CorpPersonIdBrandBrandIdPrivilegePostRequest addRegPrivilegesItem(RegPrivilegeInfo regPrivilegesItem) {
    if (this.regPrivileges == null) {
      this.regPrivileges = new ArrayList<>();
    }
    this.regPrivileges.add(regPrivilegesItem);
    return this;
  }

   /**
   * Get regPrivileges
   * @return regPrivileges
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_REG_PRIVILEGES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<RegPrivilegeInfo> getRegPrivileges() {
    return regPrivileges;
  }
  ...
  @JsonProperty(JSON_PROPERTY_REG_PRIVILEGES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRegPrivileges(List<RegPrivilegeInfo> regPrivileges) {
    this.regPrivileges = regPrivileges;
  }
  ...
  public boolean equals(Object o) {
    ...
    CorpPersonIdBrandBrandIdPrivilegePostRequest corpPersonIdBrandBrandIdPrivilegePostRequest = (CorpPersonIdBrandBrandIdPrivilegePostRequest) o;
    return Objects.equals(this.regPrivileges, corpPersonIdBrandBrandIdPrivilegePostRequest.regPrivileges);
  }

  @Override
  public int hashCode() {
    return Objects.hash(regPrivileges);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CorpPersonIdBrandBrandIdPrivilegePostRequest {\n");
    sb.append("    regPrivileges: ").append(toIndentedString(regPrivileges)).append("\n");
    sb.append("}");
    return sb.toString();
  }

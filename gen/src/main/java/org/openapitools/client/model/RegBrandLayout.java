...
import org.openapitools.client.model.LayoutComponent;
 ...
 */
@JsonPropertyOrder({
  RegBrandLayout.JSON_PROPERTY_LAYOUT_NAME,
  RegBrandLayout.JSON_PROPERTY_PRODUCT_CODE,
  RegBrandLayout.JSON_PROPERTY_SAMPLE_LAYOUT_ID,
  RegBrandLayout.JSON_PROPERTY_HEADER_COMPOSITION,
  RegBrandLayout.JSON_PROPERTY_BODY_COMPOSITION,
  RegBrandLayout.JSON_PROPERTY_FOOTER_COMPOSITION
})
...
public class RegBrandLayout {
  public static final String JSON_PROPERTY_LAYOUT_NAME = "layoutName";
  ...
  private String sampleLayoutId;

  public static final String JSON_PROPERTY_HEADER_COMPOSITION = "headerComposition";
  private List<LayoutComponent> headerComposition = new ArrayList<>();

  public static final String JSON_PROPERTY_BODY_COMPOSITION = "bodyComposition";
  private List<LayoutComponent> bodyComposition = new ArrayList<>();

  public static final String JSON_PROPERTY_FOOTER_COMPOSITION = "footerComposition";
  private List<LayoutComponent> footerComposition = new ArrayList<>();

  public RegBrandLayout() {
  }

  public RegBrandLayout layoutName(String layoutName) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_LAYOUT_NAME)
  ...
  public RegBrandLayout productCode(ProductCodeEnum productCode) {
  ...
  **/
  ...
  public RegBrandLayout sampleLayoutId(String sampleLayoutId) {
   ...
   /**
   * 샘플 레이아웃 ID 입니다. 샘플 레이아웃을 이용하여 부분적으로 컴포넌트 변경하여 등록하는 경우 설정합니다.
  ...
  **/
  ...
  public String getSampleLayoutId() {
    return sampleLayoutId;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SAMPLE_LAYOUT_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSampleLayoutId(String sampleLayoutId) {
    this.sampleLayoutId = sampleLayoutId;
  }


  public RegBrandLayout headerComposition(List<LayoutComponent> headerComposition) {
    
    this.headerComposition = headerComposition;
    return this;
  }

  public RegBrandLayout addHeaderCompositionItem(LayoutComponent headerCompositionItem) {
    if (this.headerComposition == null) {
      this.headerComposition = new ArrayList<>();
    }
    this.headerComposition.add(headerCompositionItem);
    return this;
  }

   /**
   * 카드 내의 최상위 영역으로 1개의 컴포넌트를 지정할 수 있습니다.   컴포넌트 중 headerYn &#x3D; &#39;Y&#39; 인 컴포넌트만 등록이 가능합니다.   컴포넌트를 지정하지 않을 경우 빈 배열로 등록 합니다.   
  ...
  **/
  ...
  public List<LayoutComponent> getHeaderComposition() {
    return headerComposition;
  }
  ...
  @JsonProperty(JSON_PROPERTY_HEADER_COMPOSITION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setHeaderComposition(List<LayoutComponent> headerComposition) {
    this.headerComposition = headerComposition;
  }


  public RegBrandLayout bodyComposition(List<LayoutComponent> bodyComposition) {
    
    this.bodyComposition = bodyComposition;
    return this;
  }

  public RegBrandLayout addBodyCompositionItem(LayoutComponent bodyCompositionItem) {
    if (this.bodyComposition == null) {
      this.bodyComposition = new ArrayList<>();
    }
    this.bodyComposition.add(bodyCompositionItem);
    return this;
  }
  ...
  **/
  ...
  public List<LayoutComponent> getBodyComposition() {
    return bodyComposition;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BODY_COMPOSITION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBodyComposition(List<LayoutComponent> bodyComposition) {
    this.bodyComposition = bodyComposition;
  }


  public RegBrandLayout footerComposition(List<LayoutComponent> footerComposition) {
    
    this.footerComposition = footerComposition;
    return this;
  }

  public RegBrandLayout addFooterCompositionItem(LayoutComponent footerCompositionItem) {
    if (this.footerComposition == null) {
      this.footerComposition = new ArrayList<>();
    }
    this.footerComposition.add(footerCompositionItem);
    return this;
  }

   /**
   * 카드 내의 최하단 영역으로 1개의 컴포넌트를 지정할 수 있습니다.   컴포넌트 중 footerYn &#x3D; &#39;Y&#39; 인 컴포넌트만 등록이 가능합니다.   컴포넌트를 지정하지 않을 경우 빈 배열로 등록 합니다.   현재는 footer에 사용자가 직접 지정하는 컴포넌트는 없습니다. 
  ...
  **/
  ...
  public List<LayoutComponent> getFooterComposition() {
    return footerComposition;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FOOTER_COMPOSITION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFooterComposition(List<LayoutComponent> footerComposition) {
    this.footerComposition = footerComposition;
  }
  ...
  public boolean equals(Object o) {
    ...
    RegBrandLayout regBrandLayout = (RegBrandLayout) o;
    return Objects.equals(this.layoutName, regBrandLayout.layoutName) &&
        Objects.equals(this.productCode, regBrandLayout.productCode) &&
        Objects.equals(this.sampleLayoutId, regBrandLayout.sampleLayoutId) &&
        Objects.equals(this.headerComposition, regBrandLayout.headerComposition) &&
        Objects.equals(this.bodyComposition, regBrandLayout.bodyComposition) &&
        Objects.equals(this.footerComposition, regBrandLayout.footerComposition);
  }

  @Override
  public int hashCode() {
    return Objects.hash(layoutName, productCode, sampleLayoutId, headerComposition, bodyComposition, footerComposition);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegBrandLayout {\n");

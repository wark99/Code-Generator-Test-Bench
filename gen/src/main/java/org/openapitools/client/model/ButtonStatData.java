 ...
 */
@JsonPropertyOrder({
  ButtonStatData.JSON_PROPERTY_BUTTON_NUM,
  ButtonStatData.JSON_PROPERTY_ACTION_TYPE,
  ButtonStatData.JSON_PROPERTY_TITLE,
  ButtonStatData.JSON_PROPERTY_CLICK_COUNT
})
...
public class ButtonStatData {
  public static final String JSON_PROPERTY_BUTTON_NUM = "buttonNum";
  private Integer buttonNum = 0;

  /**
   * 메시지 버튼에 할당된 RCS 액션 유형 이미지 영역에 동영상 스트리밍을 설정한 경우 iframeplayB로 별도 구분 
   */
  ...
  public ButtonStatData() {
  }

  public ButtonStatData buttonNum(Integer buttonNum) {
   ...
   /**
   * 이미지, 칩리스트 또는 버튼 reactionType별 메시지 내 위치를 나타내는 번호(식별 불가시 0)    좌에서 우, 위에서 아래로 1부터 번호 부여하며 Carousel은 각 카드별로 1부터 부여  
   * @return buttonNum
  **/
  ...
  public ButtonStatData actionType(ActionTypeEnum actionType) {
  ...
  **/
  ...
  public ButtonStatData title(String title) {
  ...
  **/
  ...
  public ButtonStatData clickCount(Integer clickCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ButtonStatData buttonStatData = (ButtonStatData) o;
    return Objects.equals(this.buttonNum, buttonStatData.buttonNum) &&
        Objects.equals(this.actionType, buttonStatData.actionType) &&
        Objects.equals(this.title, buttonStatData.title) &&
        Objects.equals(this.clickCount, buttonStatData.clickCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(buttonNum, actionType, title, clickCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ButtonStatData {\n");

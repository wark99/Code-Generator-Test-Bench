...
import org.openapitools.client.model.ButtonStatData;
 ...
 */
@JsonPropertyOrder({
  MessageButtonStatData.JSON_PROPERTY_STAT_DATE,
  MessageButtonStatData.JSON_PROPERTY_CORP_ID,
  MessageButtonStatData.JSON_PROPERTY_CORP_REG_NUM,
  MessageButtonStatData.JSON_PROPERTY_BRAND_ID,
  MessageButtonStatData.JSON_PROPERTY_CHATBOT_ID,
  MessageButtonStatData.JSON_PROPERTY_GROUP_ID,
  MessageButtonStatData.JSON_PROPERTY_MESSAGEBASE_ID,
  MessageButtonStatData.JSON_PROPERTY_REACTION_TYPE,
  MessageButtonStatData.JSON_PROPERTY_CARD_NUM,
  MessageButtonStatData.JSON_PROPERTY_BUTTON_LIST
})
...
public class MessageButtonStatData {
  ...
  public static final String JSON_PROPERTY_BUTTON_LIST = "buttonList";
  private List<ButtonStatData> buttonList;

  public MessageButtonStatData() {
  }

  public MessageButtonStatData statDate(String statDate) {
  ...
  **/
  ...
  public MessageButtonStatData corpId(String corpId) {
  ...
  **/
  ...
  public MessageButtonStatData corpRegNum(String corpRegNum) {
  ...
  **/
  ...
  public MessageButtonStatData brandId(String brandId) {
  ...
  **/
  ...
  public MessageButtonStatData chatbotId(String chatbotId) {
  ...
  **/
  ...
  public MessageButtonStatData groupId(String groupId) {
  ...
  **/
  ...
  public MessageButtonStatData messagebaseId(String messagebaseId) {
  ...
  **/
  ...
  public MessageButtonStatData reactionType(ReactionTypeEnum reactionType) {
  ...
  **/
  ...
  public MessageButtonStatData cardNum(Integer cardNum) {
   ...
   /**
   * 클릭한 이미지 또는 버튼이 있는 card 의 위치(식별 불가시 0)      - ex1) Standalone 인 경우 1   - ex2) Card 4장 Carousel 1,2,3,4 중 버튼이 위치한 카드 번호   - ex3) 칩리스트인 경우 1   
   * @return cardNum
  **/
  @javax.annotation.Nullable
  ...
  public MessageButtonStatData buttonList(List<ButtonStatData> buttonList) {
    
    this.buttonList = buttonList;
    return this;
  }

  public MessageButtonStatData addButtonListItem(ButtonStatData buttonListItem) {
   ...
   /**
   * 발송 캠페인 메시지에 포함된 RCS 액션 버튼 통계 Data
   * @return buttonList
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_BUTTON_LIST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<ButtonStatData> getButtonList() {
    return buttonList;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BUTTON_LIST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setButtonList(List<ButtonStatData> buttonList) {
    this.buttonList = buttonList;
  }
  ...
  public boolean equals(Object o) {
    ...
    MessageButtonStatData messageButtonStatData = (MessageButtonStatData) o;
    return Objects.equals(this.statDate, messageButtonStatData.statDate) &&
        Objects.equals(this.corpId, messageButtonStatData.corpId) &&
        Objects.equals(this.corpRegNum, messageButtonStatData.corpRegNum) &&
        Objects.equals(this.brandId, messageButtonStatData.brandId) &&
        Objects.equals(this.chatbotId, messageButtonStatData.chatbotId) &&
        Objects.equals(this.groupId, messageButtonStatData.groupId) &&
        Objects.equals(this.messagebaseId, messageButtonStatData.messagebaseId) &&
        Objects.equals(this.reactionType, messageButtonStatData.reactionType) &&
        Objects.equals(this.cardNum, messageButtonStatData.cardNum) &&
        Objects.equals(this.buttonList, messageButtonStatData.buttonList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(statDate, corpId, corpRegNum, brandId, chatbotId, groupId, messagebaseId, reactionType, cardNum, buttonList);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MessageButtonStatData {\n");

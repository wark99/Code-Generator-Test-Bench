...
import org.openapitools.client.model.FilterSetsResponseAllOfData;
import org.openapitools.client.model.FilterSetsResponseAllOfRefs;
 ...
 */
@JsonPropertyOrder({
  FilterSetsResponse.JSON_PROPERTY_TRUNCATED,
  FilterSetsResponse.JSON_PROPERTY_NEXT_TOKEN,
  FilterSetsResponse.JSON_PROPERTY_DATA,
  FilterSetsResponse.JSON_PROPERTY_REFS
})
...
public class FilterSetsResponse {
  ...
  private FilterSetsResponseAllOfData data;

  public static final String JSON_PROPERTY_REFS = "refs";
  private FilterSetsResponseAllOfRefs refs;

  public FilterSetsResponse() {
  }

  public FilterSetsResponse truncated(Object truncated) {
  ...
  **/
  ...
  public FilterSetsResponse nextToken(Object nextToken) {
  ...
  **/
  ...
  public FilterSetsResponse data(FilterSetsResponseAllOfData data) {
  ...
  **/
  ...
  public FilterSetsResponseAllOfData getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(FilterSetsResponseAllOfData data) {
    this.data = data;
  }


  public FilterSetsResponse refs(FilterSetsResponseAllOfRefs refs) {
  ...
  **/
  ...
  public FilterSetsResponseAllOfRefs getRefs() {
    return refs;
  }
  ...
  @JsonProperty(JSON_PROPERTY_REFS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRefs(FilterSetsResponseAllOfRefs refs) {
    this.refs = refs;
  }
  ...
  public boolean equals(Object o) {
    ...
    FilterSetsResponse filterSetsResponse = (FilterSetsResponse) o;
    return Objects.equals(this.truncated, filterSetsResponse.truncated) &&
        equalsNullable(this.nextToken, filterSetsResponse.nextToken) &&
        Objects.equals(this.data, filterSetsResponse.data) &&
        Objects.equals(this.refs, filterSetsResponse.refs);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(truncated, hashCodeNullable(nextToken), data, refs);
  }
  ...
  public String toString() {
    ...
    sb.append("class FilterSetsResponse {\n");

 ...
 */
@JsonPropertyOrder({
  ContractInfo.JSON_PROPERTY_CORP_ID,
  ContractInfo.JSON_PROPERTY_CORP_REG_NUM,
  ContractInfo.JSON_PROPERTY_BRAND_ID,
  ContractInfo.JSON_PROPERTY_BRAND_NAME,
  ContractInfo.JSON_PROPERTY_AGENCY_ID,
  ContractInfo.JSON_PROPERTY_CONTRACTS,
  ContractInfo.JSON_PROPERTY_REGISTER_DATE,
  ContractInfo.JSON_PROPERTY_UPDATE_DATE,
  ContractInfo.JSON_PROPERTY_BRAND_DATE,
  ContractInfo.JSON_PROPERTY_CHATBOT_DATE,
  ContractInfo.JSON_PROPERTY_MESSAGEBASE_DATE,
  ContractInfo.JSON_PROPERTY_LOGO_DATE
})
...
public class ContractInfo {
  ...
  public enum ContractsEnum {
    ...
    @JsonCreator
    public static ContractsEnum fromValue(String value) {
      for (ContractsEnum b : ContractsEnum.values()) {
  ...
  private List<ContractsEnum> contracts;
  ...
  public static final String JSON_PROPERTY_BRAND_DATE = "brandDate";
  private OffsetDateTime brandDate;

  public static final String JSON_PROPERTY_CHATBOT_DATE = "chatbotDate";
  private OffsetDateTime chatbotDate;

  public static final String JSON_PROPERTY_MESSAGEBASE_DATE = "messagebaseDate";
  private OffsetDateTime messagebaseDate;

  public static final String JSON_PROPERTY_LOGO_DATE = "logoDate";
  private OffsetDateTime logoDate;

  public ContractInfo() {
  }

  public ContractInfo corpId(String corpId) {
  ...
  **/
  ...
  public ContractInfo corpRegNum(String corpRegNum) {
   ...
   /**
   * RCS Biz Center에 등록된 기업의 사업자등록번호 입니다.
   * @return corpRegNum
  **/
  ...
  public ContractInfo brandId(String brandId) {
  ...
  **/
  ...
  public ContractInfo brandName(String brandName) {
  ...
  **/
  ...
  public ContractInfo agencyId(String agencyId) {
  ...
  **/
  ...
  public ContractInfo contracts(List<ContractsEnum> contracts) {
    
    this.contracts = contracts;
    return this;
  }

  public ContractInfo addContractsItem(ContractsEnum contractsItem) {
  ...
  **/
  ...
  public List<ContractsEnum> getContracts() {
    return contracts;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CONTRACTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setContracts(List<ContractsEnum> contracts) {
    this.contracts = contracts;
  }


  public ContractInfo registerDate(OffsetDateTime registerDate) {
  ...
  **/
  ...
  public ContractInfo updateDate(OffsetDateTime updateDate) {
  ...
  **/
  ...
  public ContractInfo brandDate(OffsetDateTime brandDate) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_BRAND_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public OffsetDateTime getBrandDate() {
    return brandDate;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BRAND_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBrandDate(OffsetDateTime brandDate) {
    this.brandDate = brandDate;
  }


  public ContractInfo chatbotDate(OffsetDateTime chatbotDate) {
  ...
  **/
  ...
  public OffsetDateTime getChatbotDate() {
    return chatbotDate;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CHATBOT_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChatbotDate(OffsetDateTime chatbotDate) {
    this.chatbotDate = chatbotDate;
  }


  public ContractInfo messagebaseDate(OffsetDateTime messagebaseDate) {
  ...
  **/
  ...
  public OffsetDateTime getMessagebaseDate() {
    return messagebaseDate;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MESSAGEBASE_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMessagebaseDate(OffsetDateTime messagebaseDate) {
    this.messagebaseDate = messagebaseDate;
  }


  public ContractInfo logoDate(OffsetDateTime logoDate) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_LOGO_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public OffsetDateTime getLogoDate() {
    return logoDate;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LOGO_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setLogoDate(OffsetDateTime logoDate) {
    this.logoDate = logoDate;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.corpId, contractInfo.corpId) &&
        Objects.equals(this.corpRegNum, contractInfo.corpRegNum) &&
        Objects.equals(this.brandId, contractInfo.brandId) &&
        Objects.equals(this.brandName, contractInfo.brandName) &&
        Objects.equals(this.agencyId, contractInfo.agencyId) &&
        Objects.equals(this.contracts, contractInfo.contracts) &&
        Objects.equals(this.registerDate, contractInfo.registerDate) &&
        Objects.equals(this.updateDate, contractInfo.updateDate) &&
        Objects.equals(this.brandDate, contractInfo.brandDate) &&
        Objects.equals(this.chatbotDate, contractInfo.chatbotDate) &&
        Objects.equals(this.messagebaseDate, contractInfo.messagebaseDate) &&
        Objects.equals(this.logoDate, contractInfo.logoDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(corpId, corpRegNum, brandId, brandName, agencyId, contracts, registerDate, updateDate, brandDate, chatbotDate, messagebaseDate, logoDate);
  }
  ...
  public String toString() {
    ...
    sb.append("    brandDate: ").append(toIndentedString(brandDate)).append("\n");
    ...
    sb.append("    logoDate: ").append(toIndentedString(logoDate)).append("\n");
    sb.append("}");
    return sb.toString();
  }

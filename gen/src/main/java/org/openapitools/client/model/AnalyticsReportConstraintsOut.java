 ...
 */
@JsonPropertyOrder({
  AnalyticsReportConstraintsOut.JSON_PROPERTY_ANALYTICS_REPORT_DATA,
  AnalyticsReportConstraintsOut.JSON_PROPERTY_ACCOUNT_IDS,
  AnalyticsReportConstraintsOut.JSON_PROPERTY_REPORT_CUSTOM_FIELDS,
  AnalyticsReportConstraintsOut.JSON_PROPERTY_FROM_DATE
})
...
public class AnalyticsReportConstraintsOut {
  ...
  public AnalyticsReportConstraintsOut() {
  }

  public AnalyticsReportConstraintsOut analyticsReportData(AnalyticsReportData analyticsReportData) {
  ...
  **/
  ...
  public AnalyticsReportConstraintsOut accountIds(List<String> accountIds) {
    
    this.accountIds = accountIds;
    return this;
  }

  public AnalyticsReportConstraintsOut addAccountIdsItem(String accountIdsItem) {
  ...
  **/
  ...
  public AnalyticsReportConstraintsOut reportCustomFields(List<ReportCustomField> reportCustomFields) {
    
    this.reportCustomFields = reportCustomFields;
    return this;
  }

  public AnalyticsReportConstraintsOut addReportCustomFieldsItem(ReportCustomField reportCustomFieldsItem) {
  ...
  **/
  ...
  public AnalyticsReportConstraintsOut fromDate(Long fromDate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AnalyticsReportConstraintsOut analyticsReportConstraintsOut = (AnalyticsReportConstraintsOut) o;
    return Objects.equals(this.analyticsReportData, analyticsReportConstraintsOut.analyticsReportData) &&
        Objects.equals(this.accountIds, analyticsReportConstraintsOut.accountIds) &&
        Objects.equals(this.reportCustomFields, analyticsReportConstraintsOut.reportCustomFields) &&
        Objects.equals(this.fromDate, analyticsReportConstraintsOut.fromDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(analyticsReportData, accountIds, reportCustomFields, fromDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AnalyticsReportConstraintsOut {\n");

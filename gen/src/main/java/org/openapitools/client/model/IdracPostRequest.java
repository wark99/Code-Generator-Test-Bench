 ...
 */
@JsonPropertyOrder({
  IdracPostRequest.JSON_PROPERTY_CEPHX,
  IdracPostRequest.JSON_PROPERTY_NAME
})
@JsonTypeName("_idrac_post_request")
...
public class IdracPostRequest {
  ...
  public IdracPostRequest() {
  }

  public IdracPostRequest cephx(IdracPostRequestCephx cephx) {
  ...
  **/
  ...
  public IdracPostRequest name(String name) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IdracPostRequest idracPostRequest = (IdracPostRequest) o;
    return Objects.equals(this.cephx, idracPostRequest.cephx) &&
        Objects.equals(this.name, idracPostRequest.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cephx, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IdracPostRequest {\n");

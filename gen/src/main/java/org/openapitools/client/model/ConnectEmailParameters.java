 ...
 */
@JsonPropertyOrder({
  ConnectEmailParameters.JSON_PROPERTY_LANGUAGE,
  ConnectEmailParameters.JSON_PROPERTY_PARTNER_ID,
  ConnectEmailParameters.JSON_PROPERTY_CUSTOMER_ID,
  ConnectEmailParameters.JSON_PROPERTY_CONSUMER_ID,
  ConnectEmailParameters.JSON_PROPERTY_REDIRECT_URI,
  ConnectEmailParameters.JSON_PROPERTY_WEBHOOK,
  ConnectEmailParameters.JSON_PROPERTY_WEBHOOK_CONTENT_TYPE,
  ConnectEmailParameters.JSON_PROPERTY_WEBHOOK_DATA,
  ConnectEmailParameters.JSON_PROPERTY_WEBHOOK_HEADERS,
  ConnectEmailParameters.JSON_PROPERTY_INSTITUTION_SETTINGS,
  ConnectEmailParameters.JSON_PROPERTY_EMAIL,
  ConnectEmailParameters.JSON_PROPERTY_EXPERIENCE,
  ConnectEmailParameters.JSON_PROPERTY_SINGLE_USE_URL,
  ConnectEmailParameters.JSON_PROPERTY_FROM_DATE,
  ConnectEmailParameters.JSON_PROPERTY_REPORT_CUSTOM_FIELDS,
  ConnectEmailParameters.JSON_PROPERTY_OPTIONAL_CONSUMER_INFO
})
...
public class ConnectEmailParameters {
  ...
  public ConnectEmailParameters() {
  }

  public ConnectEmailParameters language(String language) {
  ...
  **/
  ...
  public ConnectEmailParameters partnerId(String partnerId) {
  ...
  **/
  ...
  public ConnectEmailParameters customerId(String customerId) {
  ...
  **/
  ...
  public ConnectEmailParameters consumerId(String consumerId) {
  ...
  **/
  ...
  public ConnectEmailParameters redirectUri(String redirectUri) {
  ...
  **/
  ...
  public ConnectEmailParameters webhook(String webhook) {
  ...
  **/
  ...
  public ConnectEmailParameters webhookContentType(String webhookContentType) {
  ...
  **/
  ...
  public ConnectEmailParameters webhookData(Object webhookData) {
  ...
  **/
  ...
  public ConnectEmailParameters webhookHeaders(Object webhookHeaders) {
  ...
  **/
  ...
  public ConnectEmailParameters institutionSettings(Object institutionSettings) {
  ...
  **/
  ...
  public ConnectEmailParameters email(EmailOptions email) {
  ...
  **/
  ...
  public ConnectEmailParameters experience(String experience) {
  ...
  **/
  ...
  public ConnectEmailParameters singleUseUrl(Boolean singleUseUrl) {
  ...
  **/
  ...
  public ConnectEmailParameters fromDate(Long fromDate) {
  ...
  **/
  ...
  public ConnectEmailParameters reportCustomFields(List<ReportCustomField> reportCustomFields) {
    
    this.reportCustomFields = reportCustomFields;
    return this;
  }

  public ConnectEmailParameters addReportCustomFieldsItem(ReportCustomField reportCustomFieldsItem) {
  ...
  **/
  ...
  public ConnectEmailParameters optionalConsumerInfo(ConsumerInfo optionalConsumerInfo) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ConnectEmailParameters connectEmailParameters = (ConnectEmailParameters) o;
    return Objects.equals(this.language, connectEmailParameters.language) &&
        Objects.equals(this.partnerId, connectEmailParameters.partnerId) &&
        Objects.equals(this.customerId, connectEmailParameters.customerId) &&
        Objects.equals(this.consumerId, connectEmailParameters.consumerId) &&
        Objects.equals(this.redirectUri, connectEmailParameters.redirectUri) &&
        Objects.equals(this.webhook, connectEmailParameters.webhook) &&
        Objects.equals(this.webhookContentType, connectEmailParameters.webhookContentType) &&
        Objects.equals(this.webhookData, connectEmailParameters.webhookData) &&
        Objects.equals(this.webhookHeaders, connectEmailParameters.webhookHeaders) &&
        Objects.equals(this.institutionSettings, connectEmailParameters.institutionSettings) &&
        Objects.equals(this.email, connectEmailParameters.email) &&
        Objects.equals(this.experience, connectEmailParameters.experience) &&
        Objects.equals(this.singleUseUrl, connectEmailParameters.singleUseUrl) &&
        Objects.equals(this.fromDate, connectEmailParameters.fromDate) &&
        Objects.equals(this.reportCustomFields, connectEmailParameters.reportCustomFields) &&
        Objects.equals(this.optionalConsumerInfo, connectEmailParameters.optionalConsumerInfo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(language, partnerId, customerId, consumerId, redirectUri, webhook, webhookContentType, webhookData, webhookHeaders, institutionSettings, email, experience, singleUseUrl, fromDate, reportCustomFields, optionalConsumerInfo);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConnectEmailParameters {\n");

 ...
 */
@JsonPropertyOrder({
  SubActionData.JSON_PROPERTY_POSTBACK_ID,
  SubActionData.JSON_PROPERTY_ACTION_TYPE,
  SubActionData.JSON_PROPERTY_TITLE,
  SubActionData.JSON_PROPERTY_CLICK_COUNT
})
...
public class SubActionData {
  ...
  public SubActionData() {
  }

  public SubActionData postbackId(String postbackId) {
  ...
  **/
  ...
  public SubActionData actionType(ActionTypeEnum actionType) {
  ...
  **/
  ...
  public SubActionData title(String title) {
  ...
  **/
  ...
  public SubActionData clickCount(Integer clickCount) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SubActionData subActionData = (SubActionData) o;
    return Objects.equals(this.postbackId, subActionData.postbackId) &&
        Objects.equals(this.actionType, subActionData.actionType) &&
        Objects.equals(this.title, subActionData.title) &&
        Objects.equals(this.clickCount, subActionData.clickCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(postbackId, actionType, title, clickCount);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SubActionData {\n");

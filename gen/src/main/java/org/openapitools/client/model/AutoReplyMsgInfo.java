 ...
 */
@JsonPropertyOrder({
  AutoReplyMsgInfo.JSON_PROPERTY_COPY_ALLOWED,
  AutoReplyMsgInfo.JSON_PROPERTY_BODY,
  AutoReplyMsgInfo.JSON_PROPERTY_BUTTONS,
  AutoReplyMsgInfo.JSON_PROPERTY_CHIP_LIST,
  AutoReplyMsgInfo.JSON_PROPERTY_BRAND_ID,
  AutoReplyMsgInfo.JSON_PROPERTY_AUTO_REPLY_MSG_ID,
  AutoReplyMsgInfo.JSON_PROPERTY_AUTO_REPLY_MSG_NAME,
  AutoReplyMsgInfo.JSON_PROPERTY_MESSAGEBASE_ID,
  AutoReplyMsgInfo.JSON_PROPERTY_APPROVAL_RESULT,
  AutoReplyMsgInfo.JSON_PROPERTY_REGISTER_DATE,
  AutoReplyMsgInfo.JSON_PROPERTY_UPDATE_DATE,
  AutoReplyMsgInfo.JSON_PROPERTY_REGISTER_ID,
  AutoReplyMsgInfo.JSON_PROPERTY_UPDATE_ID
})
...
public class AutoReplyMsgInfo {
  public static final String JSON_PROPERTY_COPY_ALLOWED = "copyAllowed";
  private JsonNullable<Object> copyAllowed = JsonNullable.<Object>of(true);

  public static final String JSON_PROPERTY_BODY = "body";
  private Object body = null;

  public static final String JSON_PROPERTY_BUTTONS = "buttons";
  private JsonNullable<Object> buttons = JsonNullable.<Object>of(null);

  public static final String JSON_PROPERTY_CHIP_LIST = "chipList";
  private JsonNullable<Object> chipList = JsonNullable.<Object>of(null);
  ...
  private Object autoReplyMsgId = null;

  public static final String JSON_PROPERTY_AUTO_REPLY_MSG_NAME = "autoReplyMsgName";
  private Object autoReplyMsgName = null;

  public static final String JSON_PROPERTY_MESSAGEBASE_ID = "messagebaseId";
  private Object messagebaseId = null;

  /**
   * 자동응답메시지 등록 상태입니다. 자동응답메시지는 운영자 검수 없이 자동 등록됩니다.        - 등록완료 : 이통3사에 자동응답메시지가 정상 등록된 상태입니다.                   - 저장 : RBC 웹에서 저장만 했을 경우 상태이며 별도 등록요청을 해야 합니다.      - 처리중 : 이통 3사 등록 중 에러로 인해 최종 완료가 되지 않은 상태로 수정이나 삭제가 불가능한 상태입니다.    
   */
  ...
  public AutoReplyMsgInfo() {
  }

  public AutoReplyMsgInfo copyAllowed(Object copyAllowed) {
    this.copyAllowed = JsonNullable.<Object>of(copyAllowed);
  ...
  **/
  ...
  public Object getCopyAllowed() {
        return copyAllowed.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_COPY_ALLOWED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getCopyAllowed_JsonNullable() {
    return copyAllowed;
  }
  
  @JsonProperty(JSON_PROPERTY_COPY_ALLOWED)
  public void setCopyAllowed_JsonNullable(JsonNullable<Object> copyAllowed) {
    this.copyAllowed = copyAllowed;
  }

  public void setCopyAllowed(Object copyAllowed) {
    this.copyAllowed = JsonNullable.<Object>of(copyAllowed);
  }


  public AutoReplyMsgInfo body(Object body) {
  ...
  **/
  ...
  public AutoReplyMsgInfo buttons(Object buttons) {
    this.buttons = JsonNullable.<Object>of(buttons);
  ...
  **/
  ...
  public JsonNullable<Object> getButtons_JsonNullable() {
    return buttons;
  }
  
  @JsonProperty(JSON_PROPERTY_BUTTONS)
  public void setButtons_JsonNullable(JsonNullable<Object> buttons) {
  ...
  public AutoReplyMsgInfo chipList(Object chipList) {
    this.chipList = JsonNullable.<Object>of(chipList);
  ...
  **/
  ...
  public Object getChipList() {
        return chipList.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_CHIP_LIST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getChipList_JsonNullable() {
    return chipList;
  }
  
  @JsonProperty(JSON_PROPERTY_CHIP_LIST)
  public void setChipList_JsonNullable(JsonNullable<Object> chipList) {
    this.chipList = chipList;
  }

  public void setChipList(Object chipList) {
    this.chipList = JsonNullable.<Object>of(chipList);
  }


  public AutoReplyMsgInfo brandId(Object brandId) {
  ...
  **/
  ...
  public AutoReplyMsgInfo autoReplyMsgId(Object autoReplyMsgId) {
  ...
  **/
  ...
  public AutoReplyMsgInfo autoReplyMsgName(Object autoReplyMsgName) {
    
    this.autoReplyMsgName = autoReplyMsgName;
    return this;
  }

   /**
   * Get autoReplyMsgName
   * maximum: 100
   * @return autoReplyMsgName
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_AUTO_REPLY_MSG_NAME)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public Object getAutoReplyMsgName() {
    return autoReplyMsgName;
  }
  ...
  @JsonProperty(JSON_PROPERTY_AUTO_REPLY_MSG_NAME)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAutoReplyMsgName(Object autoReplyMsgName) {
    this.autoReplyMsgName = autoReplyMsgName;
  }


  public AutoReplyMsgInfo messagebaseId(Object messagebaseId) {
  ...
  **/
  ...
  public AutoReplyMsgInfo approvalResult(ApprovalResultEnum approvalResult) {
  ...
  **/
  ...
  public AutoReplyMsgInfo registerDate(Object registerDate) {
  ...
  **/
  ...
  public AutoReplyMsgInfo updateDate(Object updateDate) {
  ...
  **/
  ...
  public AutoReplyMsgInfo registerId(Object registerId) {
  ...
  **/
  ...
  public AutoReplyMsgInfo updateId(Object updateId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AutoReplyMsgInfo autoReplyMsgInfo = (AutoReplyMsgInfo) o;
    return equalsNullable(this.copyAllowed, autoReplyMsgInfo.copyAllowed) &&
        Objects.equals(this.body, autoReplyMsgInfo.body) &&
        equalsNullable(this.buttons, autoReplyMsgInfo.buttons) &&
        equalsNullable(this.chipList, autoReplyMsgInfo.chipList) &&
        Objects.equals(this.brandId, autoReplyMsgInfo.brandId) &&
        Objects.equals(this.autoReplyMsgId, autoReplyMsgInfo.autoReplyMsgId) &&
        Objects.equals(this.autoReplyMsgName, autoReplyMsgInfo.autoReplyMsgName) &&
        Objects.equals(this.messagebaseId, autoReplyMsgInfo.messagebaseId) &&
        equalsNullable(this.approvalResult, autoReplyMsgInfo.approvalResult) &&
        equalsNullable(this.registerDate, autoReplyMsgInfo.registerDate) &&
        equalsNullable(this.updateDate, autoReplyMsgInfo.updateDate) &&
        equalsNullable(this.registerId, autoReplyMsgInfo.registerId) &&
        equalsNullable(this.updateId, autoReplyMsgInfo.updateId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(copyAllowed), body, hashCodeNullable(buttons), hashCodeNullable(chipList), brandId, autoReplyMsgId, autoReplyMsgName, messagebaseId, hashCodeNullable(approvalResult), hashCodeNullable(registerDate), hashCodeNullable(updateDate), hashCodeNullable(registerId), hashCodeNullable(updateId));
  }

 ...
 */
@JsonPropertyOrder({
  DetailInfoCombinationsInnerCondition.JSON_PROPERTY_MEDIA_PHASE,
  DetailInfoCombinationsInnerCondition.JSON_PROPERTY_NUMBER_OF_LINES_ON_TITLE,
  DetailInfoCombinationsInnerCondition.JSON_PROPERTY_NUMBER_OF_BUTTONS
})
@JsonTypeName("DetailInfo_combinations_inner_condition")
...
public class DetailInfoCombinationsInnerCondition {
  public static final String JSON_PROPERTY_MEDIA_PHASE = "mediaPhase";
  private String mediaPhase;

  public static final String JSON_PROPERTY_NUMBER_OF_LINES_ON_TITLE = "numberOfLinesOnTitle";
  private Integer numberOfLinesOnTitle;

  public static final String JSON_PROPERTY_NUMBER_OF_BUTTONS = "numberOfButtons";
  private Integer numberOfButtons;

  public DetailInfoCombinationsInnerCondition() {
  }

  public DetailInfoCombinationsInnerCondition mediaPhase(String mediaPhase) {
    
    this.mediaPhase = mediaPhase;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_MEDIA_PHASE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public String getMediaPhase() {
    return mediaPhase;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MEDIA_PHASE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMediaPhase(String mediaPhase) {
    this.mediaPhase = mediaPhase;
  }


  public DetailInfoCombinationsInnerCondition numberOfLinesOnTitle(Integer numberOfLinesOnTitle) {
    
    this.numberOfLinesOnTitle = numberOfLinesOnTitle;
    return this;
  }

   /**
   * 타이틀 라인수
   * @return numberOfLinesOnTitle
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_NUMBER_OF_LINES_ON_TITLE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getNumberOfLinesOnTitle() {
    return numberOfLinesOnTitle;
  }
  ...
  @JsonProperty(JSON_PROPERTY_NUMBER_OF_LINES_ON_TITLE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNumberOfLinesOnTitle(Integer numberOfLinesOnTitle) {
    this.numberOfLinesOnTitle = numberOfLinesOnTitle;
  }


  public DetailInfoCombinationsInnerCondition numberOfButtons(Integer numberOfButtons) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_NUMBER_OF_BUTTONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public boolean equals(Object o) {
    ...
    DetailInfoCombinationsInnerCondition detailInfoCombinationsInnerCondition = (DetailInfoCombinationsInnerCondition) o;
    return Objects.equals(this.mediaPhase, detailInfoCombinationsInnerCondition.mediaPhase) &&
        Objects.equals(this.numberOfLinesOnTitle, detailInfoCombinationsInnerCondition.numberOfLinesOnTitle) &&
        Objects.equals(this.numberOfButtons, detailInfoCombinationsInnerCondition.numberOfButtons);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mediaPhase, numberOfLinesOnTitle, numberOfButtons);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DetailInfoCombinationsInnerCondition {\n");
    sb.append("    mediaPhase: ").append(toIndentedString(mediaPhase)).append("\n");
    sb.append("    numberOfLinesOnTitle: ").append(toIndentedString(numberOfLinesOnTitle)).append("\n");
    sb.append("    numberOfButtons: ").append(toIndentedString(numberOfButtons)).append("\n");
    sb.append("}");
    return sb.toString();
  }

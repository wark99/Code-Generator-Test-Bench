 ...
 */
@JsonPropertyOrder({
  BrandBrandIdLayoutLayoutIdPut200ResponseResultInner.JSON_PROPERTY_LAYOUT_ID,
  BrandBrandIdLayoutLayoutIdPut200ResponseResultInner.JSON_PROPERTY_BODY
})
@JsonTypeName("_brand__brandId__layout__layoutId__put_200_response_result_inner")
...
public class BrandBrandIdLayoutLayoutIdPut200ResponseResultInner {
  ...
  public BrandBrandIdLayoutLayoutIdPut200ResponseResultInner() {
  }

  public BrandBrandIdLayoutLayoutIdPut200ResponseResultInner layoutId(String layoutId) {
   ...
   /**
   * 수정된 레이아웃 ID(&#x3D; messagebaseId) 입니다.   레이아웃 ID는 RCS 발송에 사용하는 messagebaseId 로 사용됩니다. 
   * @return layoutId
  **/
  ...
  public BrandBrandIdLayoutLayoutIdPut200ResponseResultInner body(Object body) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BrandBrandIdLayoutLayoutIdPut200ResponseResultInner brandBrandIdLayoutLayoutIdPut200ResponseResultInner = (BrandBrandIdLayoutLayoutIdPut200ResponseResultInner) o;
    return Objects.equals(this.layoutId, brandBrandIdLayoutLayoutIdPut200ResponseResultInner.layoutId) &&
        Objects.equals(this.body, brandBrandIdLayoutLayoutIdPut200ResponseResultInner.body);
  }

  @Override
  public int hashCode() {
    return Objects.hash(layoutId, body);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BrandBrandIdLayoutLayoutIdPut200ResponseResultInner {\n");

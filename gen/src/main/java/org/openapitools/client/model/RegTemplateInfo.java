...
import org.openapitools.client.model.RegTemplateInfoBodyInner;
import org.openapitools.client.model.RegTemplateInfoButtonsInner;
 ...
 */
@JsonPropertyOrder({
  RegTemplateInfo.JSON_PROPERTY_BRAND_ID,
  RegTemplateInfo.JSON_PROPERTY_MESSAGEBASEFORM_ID,
  RegTemplateInfo.JSON_PROPERTY_CUST_TMPLT_ID,
  RegTemplateInfo.JSON_PROPERTY_TMPLT_NAME,
  RegTemplateInfo.JSON_PROPERTY_AGENCY_ID,
  RegTemplateInfo.JSON_PROPERTY_BODY,
  RegTemplateInfo.JSON_PROPERTY_BUTTONS
})
...
public class RegTemplateInfo {
  ...
  public static final String JSON_PROPERTY_CUST_TMPLT_ID = "custTmpltId";
  private String custTmpltId;
  ...
  private List<RegTemplateInfoBodyInner> body = new ArrayList<>();

  public static final String JSON_PROPERTY_BUTTONS = "buttons";
  private List<RegTemplateInfoButtonsInner> buttons;

  public RegTemplateInfo() {
  }

  public RegTemplateInfo brandId(String brandId) {
  ...
  **/
  ...
  public RegTemplateInfo messagebaseformId(String messagebaseformId) {
  ...
  **/
  ...
  public RegTemplateInfo custTmpltId(String custTmpltId) {
    
    this.custTmpltId = custTmpltId;
    return this;
  }

   /**
   * 사용자 지정 템플릿ID로 영문/숫자 25자 이내만 가능
   * @return custTmpltId
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_CUST_TMPLT_ID)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public String getCustTmpltId() {
    return custTmpltId;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CUST_TMPLT_ID)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCustTmpltId(String custTmpltId) {
    this.custTmpltId = custTmpltId;
  }


  public RegTemplateInfo tmpltName(String tmpltName) {
  ...
  **/
  ...
  public RegTemplateInfo agencyId(String agencyId) {
  ...
  **/
  ...
  public RegTemplateInfo body(List<RegTemplateInfoBodyInner> body) {
    
    this.body = body;
    return this;
  }

  public RegTemplateInfo addBodyItem(RegTemplateInfoBodyInner bodyItem) {
    if (this.body == null) {
   ...
   /**
   * messagebaseform JSON의 ROOT.params[n-1] object의 type 이 file, string 인 경우, 각 속성에 맞는 데이터 Object를 사용하여 템플릿을 구성합니다. messageabseform JSON의 ROOT.params[n-1].isMandatory 가 true 이면 템플릿 등록을 위해 필수로 등록해야 하는 요소이므로 반드시 데이터를 설정해야 템플릿 등록이 가능합니다.   변수 mTitleMedia, itemMedia 에 사용할 이미지는 브랜드 로고(logo) 등록 후 발급된 fileId를 지정해야 합니다. 
   * @return body
  **/
  @javax.annotation.Nonnull
  ...
  public List<RegTemplateInfoBodyInner> getBody() {
    return body;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BODY)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBody(List<RegTemplateInfoBodyInner> body) {
    this.body = body;
  }


  public RegTemplateInfo buttons(List<RegTemplateInfoButtonsInner> buttons) {
    
    this.buttons = buttons;
    return this;
  }

  public RegTemplateInfo addButtonsItem(RegTemplateInfoButtonsInner buttonsItem) {
  ...
  **/
  ...
  public List<RegTemplateInfoButtonsInner> getButtons() {
    return buttons;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BUTTONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setButtons(List<RegTemplateInfoButtonsInner> buttons) {
    this.buttons = buttons;
  }
  ...
  public boolean equals(Object o) {
    ...
    RegTemplateInfo regTemplateInfo = (RegTemplateInfo) o;
    return Objects.equals(this.brandId, regTemplateInfo.brandId) &&
        Objects.equals(this.messagebaseformId, regTemplateInfo.messagebaseformId) &&
        Objects.equals(this.custTmpltId, regTemplateInfo.custTmpltId) &&
        Objects.equals(this.tmpltName, regTemplateInfo.tmpltName) &&
        Objects.equals(this.agencyId, regTemplateInfo.agencyId) &&
        Objects.equals(this.body, regTemplateInfo.body) &&
        Objects.equals(this.buttons, regTemplateInfo.buttons);
  }

  @Override
  public int hashCode() {
    return Objects.hash(brandId, messagebaseformId, custTmpltId, tmpltName, agencyId, body, buttons);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegTemplateInfo {\n");
    sb.append("    brandId: ").append(toIndentedString(brandId)).append("\n");
    sb.append("    messagebaseformId: ").append(toIndentedString(messagebaseformId)).append("\n");
    sb.append("    custTmpltId: ").append(toIndentedString(custTmpltId)).append("\n");

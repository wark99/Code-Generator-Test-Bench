 ...
 */
@JsonPropertyOrder({
  AppLinkItemInfo.JSON_PROPERTY_PACKAGE_NAME,
  AppLinkItemInfo.JSON_PROPERTY_ACTION,
  AppLinkItemInfo.JSON_PROPERTY_URI
})
...
public class AppLinkItemInfo {
  ...
  public AppLinkItemInfo() {
  }

  public AppLinkItemInfo packageName(String packageName) {
  ...
  **/
  ...
  public AppLinkItemInfo action(String action) {
  ...
  **/
  ...
  public AppLinkItemInfo uri(String uri) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AppLinkItemInfo appLinkItemInfo = (AppLinkItemInfo) o;
    return Objects.equals(this.packageName, appLinkItemInfo.packageName) &&
        Objects.equals(this.action, appLinkItemInfo.action) &&
        Objects.equals(this.uri, appLinkItemInfo.uri);
  }

  @Override
  public int hashCode() {
    return Objects.hash(packageName, action, uri);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AppLinkItemInfo {\n");

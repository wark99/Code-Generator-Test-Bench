 ...
 */
@JsonPropertyOrder({
  TextDecoration.JSON_PROPERTY_TEXT_SIZE,
  TextDecoration.JSON_PROPERTY_TEXT_ALIGNMENT,
  TextDecoration.JSON_PROPERTY_TEXT_STYLE,
  TextDecoration.JSON_PROPERTY_TEXT_COLOR
})
...
public class TextDecoration {
  ...
  /**
   * 문장 정렬 지정시 사용합니다. 지원하는 정렬의 종류는 다음과 같습니다. - textStart: 왼쪽 정렬 - center: 중앙 정렬 - textEnd: 오른쪽 정렬 
   */
  public enum TextAlignmentEnum {
    ...
    @JsonCreator
    public static TextAlignmentEnum fromValue(String value) {
      for (TextAlignmentEnum b : TextAlignmentEnum.values()) {
  ...
  public enum TextStyleEnum {
    ...
    @JsonCreator
    public static TextStyleEnum fromValue(String value) {
      for (TextStyleEnum b : TextStyleEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  public TextDecoration textSize(String textSize) {
   ...
   /**
   * 글자 크기 지정시 사용합니다.  숫자 뒤에 단위 dp를 반드시 붙여서 입력하여야 합니다. 
   * @return textSize
  **/
  ...
  public TextDecoration textAlignment(TextAlignmentEnum textAlignment) {
  ...
  **/
  ...
  public TextAlignmentEnum getTextAlignment() {
    return textAlignment;
  }
  ...
  @JsonProperty(JSON_PROPERTY_TEXT_ALIGNMENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTextAlignment(TextAlignmentEnum textAlignment) {
    this.textAlignment = textAlignment;
  }


  public TextDecoration textStyle(TextStyleEnum textStyle) {
  ...
  **/
  ...
  public TextDecoration textColor(String textColor) {
   ...
   /**
   * 문장의 글자 색상을 지정한 색상 값으로 설정합니다. - 색상코드 Hex 표현식
   * @return textColor
  **/
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.textSize, textDecoration.textSize) &&
        Objects.equals(this.textAlignment, textDecoration.textAlignment) &&
        Objects.equals(this.textStyle, textDecoration.textStyle) &&
        Objects.equals(this.textColor, textDecoration.textColor);
  }

  @Override
  public int hashCode() {
    return Objects.hash(textSize, textAlignment, textStyle, textColor);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TextDecoration {\n");

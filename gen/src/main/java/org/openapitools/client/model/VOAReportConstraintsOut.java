 ...
 */
@JsonPropertyOrder({
  VOAReportConstraintsOut.JSON_PROPERTY_ACCOUNT_IDS,
  VOAReportConstraintsOut.JSON_PROPERTY_REPORT_CUSTOM_FIELDS,
  VOAReportConstraintsOut.JSON_PROPERTY_TO_DATE,
  VOAReportConstraintsOut.JSON_PROPERTY_SHOW_NSF,
  VOAReportConstraintsOut.JSON_PROPERTY_FROM_DATE
})
...
public class VOAReportConstraintsOut {
  ...
  public VOAReportConstraintsOut() {
  }

  public VOAReportConstraintsOut accountIds(List<String> accountIds) {
    
    this.accountIds = accountIds;
    return this;
  }

  public VOAReportConstraintsOut addAccountIdsItem(String accountIdsItem) {
  ...
  **/
  ...
  public VOAReportConstraintsOut reportCustomFields(List<ReportCustomField> reportCustomFields) {
    
    this.reportCustomFields = reportCustomFields;
    return this;
  }

  public VOAReportConstraintsOut addReportCustomFieldsItem(ReportCustomField reportCustomFieldsItem) {
  ...
  **/
  ...
  public VOAReportConstraintsOut toDate(Long toDate) {
  ...
  **/
  ...
  public VOAReportConstraintsOut showNsf(Boolean showNsf) {
  ...
  **/
  ...
  public VOAReportConstraintsOut fromDate(Long fromDate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    VOAReportConstraintsOut voAReportConstraintsOut = (VOAReportConstraintsOut) o;
    return Objects.equals(this.accountIds, voAReportConstraintsOut.accountIds) &&
        Objects.equals(this.reportCustomFields, voAReportConstraintsOut.reportCustomFields) &&
        Objects.equals(this.toDate, voAReportConstraintsOut.toDate) &&
        Objects.equals(this.showNsf, voAReportConstraintsOut.showNsf) &&
        Objects.equals(this.fromDate, voAReportConstraintsOut.fromDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountIds, reportCustomFields, toDate, showNsf, fromDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VOAReportConstraintsOut {\n");

...
import org.openapitools.client.model.TextDecoration;
 ...
 */
@JsonPropertyOrder({
  StringObject.JSON_PROPERTY_PARAM,
  StringObject.JSON_PROPERTY_VALUE,
  StringObject.JSON_PROPERTY_DECORATION
})
...
public class StringObject {
  ...
  public StringObject param(String param) {
  ...
  **/
  ...
  public StringObject value(String value) {
   ...
   /**
   * 영역에 지정할 Text 형식에 맞게 입력해야 합니다. - messagebaseform의 ROOT.params[n-1].contentType이 title, description, cell 인 경우: 고정부와 변수부로 이루어진 문장 - messagebaseform의 ROOT.params[n-1].contentType이 url인 경우: http(s)://로 시작하는 URL 입력 
   * @return value
  **/
  @javax.annotation.Nonnull
  ...
  public StringObject decoration(TextDecoration decoration) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StringObject stringObject = (StringObject) o;
    return Objects.equals(this.param, stringObject.param) &&
        Objects.equals(this.value, stringObject.value) &&
        Objects.equals(this.decoration, stringObject.decoration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(param, value, decoration);
  }

 ...
 */
@JsonPropertyOrder({
  RegPrivilegeInfo.JSON_PROPERTY_PRIVILEGE_TYPE,
  RegPrivilegeInfo.JSON_PROPERTY_ID
})
...
public class RegPrivilegeInfo {
  /**
   * 권한은 다음과 같이 구분됩니다.      - Manager : 대표운영자     - SubManager : 운영자(기업의 마스터 또는 매니저)   - Agency : 운영자(대행사) 
   */
  ...
  public RegPrivilegeInfo() {
  }

  public RegPrivilegeInfo privilegeType(PrivilegeTypeEnum privilegeType) {
  ...
  **/
  ...
  public RegPrivilegeInfo id(String id) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RegPrivilegeInfo regPrivilegeInfo = (RegPrivilegeInfo) o;
    return Objects.equals(this.privilegeType, regPrivilegeInfo.privilegeType) &&
        Objects.equals(this.id, regPrivilegeInfo.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(privilegeType, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegPrivilegeInfo {\n");

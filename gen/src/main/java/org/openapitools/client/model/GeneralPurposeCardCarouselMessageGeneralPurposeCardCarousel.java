...
import org.openapitools.client.model.GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout;
import org.openapitools.client.model.GeneralPurposeCardMessageGeneralPurposeCardContent;
 ...
 */
@JsonPropertyOrder({
  GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel.JSON_PROPERTY_LAYOUT,
  GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel.JSON_PROPERTY_CONTENT,
  GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel.JSON_PROPERTY_ZOOM_ALLOWED
})
@JsonTypeName("generalPurposeCardCarouselMessage_generalPurposeCardCarousel")
...
public class GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel {
  public static final String JSON_PROPERTY_LAYOUT = "layout";
  private GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout layout;

  public static final String JSON_PROPERTY_CONTENT = "content";
  private List<GeneralPurposeCardMessageGeneralPurposeCardContent> content = new ArrayList<>();

  public static final String JSON_PROPERTY_ZOOM_ALLOWED = "zoomAllowed";
  private Boolean zoomAllowed;

  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel() {
  }

  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel layout(GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout layout) {
  ...
  **/
  ...
  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout getLayout() {
    return layout;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LAYOUT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLayout(GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout layout) {
    this.layout = layout;
  }


  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel content(List<GeneralPurposeCardMessageGeneralPurposeCardContent> content) {
    
    this.content = content;
    return this;
  }

  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel addContentItem(GeneralPurposeCardMessageGeneralPurposeCardContent contentItem) {
  ...
  **/
  ...
  public List<GeneralPurposeCardMessageGeneralPurposeCardContent> getContent() {
    return content;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CONTENT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setContent(List<GeneralPurposeCardMessageGeneralPurposeCardContent> content) {
    this.content = content;
  }


  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel zoomAllowed(Boolean zoomAllowed) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel generalPurposeCardCarouselMessageGeneralPurposeCardCarousel = (GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel) o;
    return Objects.equals(this.layout, generalPurposeCardCarouselMessageGeneralPurposeCardCarousel.layout) &&
        Objects.equals(this.content, generalPurposeCardCarouselMessageGeneralPurposeCardCarousel.content) &&
        Objects.equals(this.zoomAllowed, generalPurposeCardCarouselMessageGeneralPurposeCardCarousel.zoomAllowed);
  }

  @Override
  public int hashCode() {
    return Objects.hash(layout, content, zoomAllowed);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel {\n");

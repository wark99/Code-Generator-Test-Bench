 ...
 */
@JsonPropertyOrder({
  ConnectJointBorrowerParameters.JSON_PROPERTY_LANGUAGE,
  ConnectJointBorrowerParameters.JSON_PROPERTY_PARTNER_ID,
  ConnectJointBorrowerParameters.JSON_PROPERTY_BORROWERS,
  ConnectJointBorrowerParameters.JSON_PROPERTY_REDIRECT_URI,
  ConnectJointBorrowerParameters.JSON_PROPERTY_WEBHOOK,
  ConnectJointBorrowerParameters.JSON_PROPERTY_WEBHOOK_CONTENT_TYPE,
  ConnectJointBorrowerParameters.JSON_PROPERTY_WEBHOOK_DATA,
  ConnectJointBorrowerParameters.JSON_PROPERTY_WEBHOOK_HEADERS,
  ConnectJointBorrowerParameters.JSON_PROPERTY_INSTITUTION_SETTINGS,
  ConnectJointBorrowerParameters.JSON_PROPERTY_EXPERIENCE,
  ConnectJointBorrowerParameters.JSON_PROPERTY_FROM_DATE,
  ConnectJointBorrowerParameters.JSON_PROPERTY_REPORT_CUSTOM_FIELDS,
  ConnectJointBorrowerParameters.JSON_PROPERTY_SINGLE_USE_URL
})
...
public class ConnectJointBorrowerParameters {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(language, partnerId, borrowers, redirectUri, webhook, webhookContentType, webhookData, webhookHeaders, institutionSettings, experience, fromDate, reportCustomFields, singleUseUrl);
  }

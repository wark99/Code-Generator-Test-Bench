 ...
 */
@JsonPropertyOrder({
  GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout.JSON_PROPERTY_CARD_WIDTH,
  GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout.JSON_PROPERTY_TITLE_FONT_STYLE,
  GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout.JSON_PROPERTY_DESCRIPTION_FONT_STYLE,
  GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout.JSON_PROPERTY_STYLE
})
@JsonTypeName("generalPurposeCardCarouselMessage_generalPurposeCardCarousel_layout")
...
public class GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout {
  /**
  ...
  public static final String JSON_PROPERTY_CARD_WIDTH = "cardWidth";
  private CardWidthEnum cardWidth = CardWidthEnum.SMALL_WIDTH;
  ...
  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout() {
  }

  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout cardWidth(CardWidthEnum cardWidth) {
  ...
  **/
  ...
  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout titleFontStyle(List<TitleFontStyleEnum> titleFontStyle) {
    
    this.titleFontStyle = titleFontStyle;
    return this;
  }

  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout addTitleFontStyleItem(TitleFontStyleEnum titleFontStyleItem) {
  ...
  **/
  ...
  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout descriptionFontStyle(List<DescriptionFontStyleEnum> descriptionFontStyle) {
    
    this.descriptionFontStyle = descriptionFontStyle;
    return this;
  }

  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout addDescriptionFontStyleItem(DescriptionFontStyleEnum descriptionFontStyleItem) {
  ...
  **/
  ...
  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout style(URI style) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout generalPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout = (GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout) o;
    return Objects.equals(this.cardWidth, generalPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout.cardWidth) &&
        Objects.equals(this.titleFontStyle, generalPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout.titleFontStyle) &&
        Objects.equals(this.descriptionFontStyle, generalPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout.descriptionFontStyle) &&
        Objects.equals(this.style, generalPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout.style);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cardWidth, titleFontStyle, descriptionFontStyle, style);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GeneralPurposeCardCarouselMessageGeneralPurposeCardCarouselLayout {\n");

 ...
 */
@JsonPropertyOrder({
  CalendarAction.JSON_PROPERTY_CALENDAR_ACTION
})
@JsonTypeName("calendarAction")
...
public class CalendarAction {
  ...
  public CalendarAction calendarAction(CalendarActionCalendarAction calendarAction) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CalendarAction calendarAction = (CalendarAction) o;
    return Objects.equals(this.calendarAction, calendarAction.calendarAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(calendarAction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CalendarAction {\n");

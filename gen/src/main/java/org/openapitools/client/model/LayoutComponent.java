 ...
 */
@JsonPropertyOrder({
  LayoutComponent.JSON_PROPERTY_INDEX,
  LayoutComponent.JSON_PROPERTY_COMPONENT_ID,
  LayoutComponent.JSON_PROPERTY_OPTIONS
})
...
public class LayoutComponent {
  ...
  public LayoutComponent index(Integer index) {
  ...
  **/
  ...
  public LayoutComponent componentId(String componentId) {
  ...
  **/
  ...
  public LayoutComponent options(ComponentInfoOptions options) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LayoutComponent layoutComponent = (LayoutComponent) o;
    return Objects.equals(this.index, layoutComponent.index) &&
        Objects.equals(this.componentId, layoutComponent.componentId) &&
        Objects.equals(this.options, layoutComponent.options);
  }

  @Override
  public int hashCode() {
    return Objects.hash(index, componentId, options);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LayoutComponent {\n");

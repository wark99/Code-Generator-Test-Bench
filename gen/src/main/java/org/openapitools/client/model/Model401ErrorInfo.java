...
import org.openapitools.client.model.Model401ErrorInfoError;
 ...
 */
@JsonPropertyOrder({
  Model401ErrorInfo.JSON_PROPERTY_STATUS,
  Model401ErrorInfo.JSON_PROPERTY_ERROR
})
@JsonTypeName("401ErrorInfo")
...
public class Model401ErrorInfo {
  public static final String JSON_PROPERTY_STATUS = "status";
  private Integer status;

  public static final String JSON_PROPERTY_ERROR = "error";
  private Model401ErrorInfoError error;

  public Model401ErrorInfo() {
  }

  public Model401ErrorInfo status(Integer status) {
  ...
  **/
  ...
  public Model401ErrorInfo error(Model401ErrorInfoError error) {
  ...
  **/
  ...
  public Model401ErrorInfoError getError() {
    return error;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ERROR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setError(Model401ErrorInfoError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    Model401ErrorInfo _401errorInfo = (Model401ErrorInfo) o;
    return Objects.equals(this.status, _401errorInfo.status) &&
        Objects.equals(this.error, _401errorInfo.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class Model401ErrorInfo {\n");

 ...
 */
@JsonPropertyOrder({
  PolicyInfo.JSON_PROPERTY_BUTTONS_ALLOWED,
  PolicyInfo.JSON_PROPERTY_AD_HEADER_ALLOWED,
  PolicyInfo.JSON_PROPERTY_AD_BODY_ALLOWED,
  PolicyInfo.JSON_PROPERTY_CARD_COUNT,
  PolicyInfo.JSON_PROPERTY_MAX_TITLE_SIZE,
  PolicyInfo.JSON_PROPERTY_MAX_BUTTON_COUNT,
  PolicyInfo.JSON_PROPERTY_MAX_DESCRIPTION_SIZE,
  PolicyInfo.JSON_PROPERTY_MAX_MEDIA_SIZE
})
...
public class PolicyInfo {
  public static final String JSON_PROPERTY_BUTTONS_ALLOWED = "buttonsAllowed";
  private Boolean buttonsAllowed;

  public static final String JSON_PROPERTY_AD_HEADER_ALLOWED = "adHeaderAllowed";
  private Boolean adHeaderAllowed;

  public static final String JSON_PROPERTY_AD_BODY_ALLOWED = "adBodyAllowed";
  private Boolean adBodyAllowed;

  public static final String JSON_PROPERTY_CARD_COUNT = "cardCount";
  private Integer cardCount;

  public static final String JSON_PROPERTY_MAX_TITLE_SIZE = "maxTitleSize";
  private Integer maxTitleSize = 30;

  public static final String JSON_PROPERTY_MAX_BUTTON_COUNT = "maxButtonCount";
  private Integer maxButtonCount;

  public static final String JSON_PROPERTY_MAX_DESCRIPTION_SIZE = "maxDescriptionSize";
  private Integer maxDescriptionSize;

  public static final String JSON_PROPERTY_MAX_MEDIA_SIZE = "maxMediaSize";
  private Integer maxMediaSize;

  public PolicyInfo() {
  }

  public PolicyInfo buttonsAllowed(Boolean buttonsAllowed) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_BUTTONS_ALLOWED)
  ...
  @JsonProperty(JSON_PROPERTY_BUTTONS_ALLOWED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setButtonsAllowed(Boolean buttonsAllowed) {
    this.buttonsAllowed = buttonsAllowed;
  }


  public PolicyInfo adHeaderAllowed(Boolean adHeaderAllowed) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_AD_HEADER_ALLOWED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_AD_HEADER_ALLOWED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdHeaderAllowed(Boolean adHeaderAllowed) {
    this.adHeaderAllowed = adHeaderAllowed;
  }


  public PolicyInfo adBodyAllowed(Boolean adBodyAllowed) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_AD_BODY_ALLOWED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_AD_BODY_ALLOWED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdBodyAllowed(Boolean adBodyAllowed) {
    this.adBodyAllowed = adBodyAllowed;
  }


  public PolicyInfo cardCount(Integer cardCount) {
  ...
  **/
  ...
  public PolicyInfo maxTitleSize(Integer maxTitleSize) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_MAX_TITLE_SIZE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getMaxTitleSize() {
    return maxTitleSize;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MAX_TITLE_SIZE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMaxTitleSize(Integer maxTitleSize) {
    this.maxTitleSize = maxTitleSize;
  }


  public PolicyInfo maxButtonCount(Integer maxButtonCount) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_MAX_BUTTON_COUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public PolicyInfo maxDescriptionSize(Integer maxDescriptionSize) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_MAX_DESCRIPTION_SIZE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public PolicyInfo maxMediaSize(Integer maxMediaSize) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_MAX_MEDIA_SIZE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.buttonsAllowed, policyInfo.buttonsAllowed) &&
        Objects.equals(this.adHeaderAllowed, policyInfo.adHeaderAllowed) &&
        Objects.equals(this.adBodyAllowed, policyInfo.adBodyAllowed) &&
        Objects.equals(this.cardCount, policyInfo.cardCount) &&
        Objects.equals(this.maxTitleSize, policyInfo.maxTitleSize) &&
        Objects.equals(this.maxButtonCount, policyInfo.maxButtonCount) &&
        Objects.equals(this.maxDescriptionSize, policyInfo.maxDescriptionSize) &&
        Objects.equals(this.maxMediaSize, policyInfo.maxMediaSize);
  }

  @Override
  public int hashCode() {
    return Objects.hash(buttonsAllowed, adHeaderAllowed, adBodyAllowed, cardCount, maxTitleSize, maxButtonCount, maxDescriptionSize, maxMediaSize);
  }
  ...
  public String toString() {
    ...
    sb.append("    buttonsAllowed: ").append(toIndentedString(buttonsAllowed)).append("\n");
    sb.append("    adHeaderAllowed: ").append(toIndentedString(adHeaderAllowed)).append("\n");
    sb.append("    adBodyAllowed: ").append(toIndentedString(adBodyAllowed)).append("\n");
    sb.append("    cardCount: ").append(toIndentedString(cardCount)).append("\n");
    sb.append("    maxTitleSize: ").append(toIndentedString(maxTitleSize)).append("\n");
    sb.append("    maxButtonCount: ").append(toIndentedString(maxButtonCount)).append("\n");
    sb.append("    maxDescriptionSize: ").append(toIndentedString(maxDescriptionSize)).append("\n");
    sb.append("    maxMediaSize: ").append(toIndentedString(maxMediaSize)).append("\n");
    sb.append("}");
    return sb.toString();
  }

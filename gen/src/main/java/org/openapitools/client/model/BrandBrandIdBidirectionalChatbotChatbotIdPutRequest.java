...
import org.openapitools.client.model.ModBiChatbot;
 ...
 */
@JsonPropertyOrder({
  BrandBrandIdBidirectionalChatbotChatbotIdPutRequest.JSON_PROPERTY_CHATBOT
})
@JsonTypeName("_brand__brandId__bidirectional_chatbot__chatbotId__put_request")
...
public class BrandBrandIdBidirectionalChatbotChatbotIdPutRequest {
  public static final String JSON_PROPERTY_CHATBOT = "chatbot";
  private ModBiChatbot chatbot;

  public BrandBrandIdBidirectionalChatbotChatbotIdPutRequest() {
  }

  public BrandBrandIdBidirectionalChatbotChatbotIdPutRequest chatbot(ModBiChatbot chatbot) {
  ...
  **/
  ...
  public ModBiChatbot getChatbot() {
    return chatbot;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CHATBOT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChatbot(ModBiChatbot chatbot) {
    this.chatbot = chatbot;
  }
  ...
  public boolean equals(Object o) {
    ...
    BrandBrandIdBidirectionalChatbotChatbotIdPutRequest brandBrandIdBidirectionalChatbotChatbotIdPutRequest = (BrandBrandIdBidirectionalChatbotChatbotIdPutRequest) o;
    return Objects.equals(this.chatbot, brandBrandIdBidirectionalChatbotChatbotIdPutRequest.chatbot);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chatbot);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BrandBrandIdBidirectionalChatbotChatbotIdPutRequest {\n");

 ...
 */
@JsonPropertyOrder({
  BaseProfile.JSON_PROPERTY_OTHER_REQUIREMENTS,
  BaseProfile.JSON_PROPERTY_REFERENCE_CHECKS,
  BaseProfile.JSON_PROPERTY_PAY_OFFER
})
...
public class BaseProfile {
  ...
  public BaseProfile otherRequirements(AccountGet200ResponseOneOfAllOfOtherRequirements otherRequirements) {
  ...
  **/
  ...
  public BaseProfile referenceChecks(List<AccountGet200ResponseOneOfAllOfReferenceChecksInner> referenceChecks) {
    
    this.referenceChecks = referenceChecks;
    return this;
  }

  public BaseProfile addReferenceChecksItem(AccountGet200ResponseOneOfAllOfReferenceChecksInner referenceChecksItem) {
  ...
  **/
  ...
  public BaseProfile payOffer(JobIdEditPutRequestPay payOffer) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BaseProfile baseProfile = (BaseProfile) o;
    return Objects.equals(this.otherRequirements, baseProfile.otherRequirements) &&
        Objects.equals(this.referenceChecks, baseProfile.referenceChecks) &&
        Objects.equals(this.payOffer, baseProfile.payOffer);
  }

  @Override
  public int hashCode() {
    return Objects.hash(otherRequirements, referenceChecks, payOffer);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BaseProfile {\n");

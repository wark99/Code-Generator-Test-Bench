 ...
 */
@JsonPropertyOrder({
  WidgetPolicy.JSON_PROPERTY_ALLOWED_ATTRIBUTES
})
@JsonTypeName("widgetPolicy")
...
public class WidgetPolicy {
  public static final String JSON_PROPERTY_ALLOWED_ATTRIBUTES = "allowedAttributes";
  private List<String> allowedAttributes = new ArrayList<>();

  public WidgetPolicy() {
  }

  public WidgetPolicy allowedAttributes(List<String> allowedAttributes) {
    
    this.allowedAttributes = allowedAttributes;
    return this;
  }

  public WidgetPolicy addAllowedAttributesItem(String allowedAttributesItem) {
    if (this.allowedAttributes == null) {
      this.allowedAttributes = new ArrayList<>();
    }
    this.allowedAttributes.add(allowedAttributesItem);
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ALLOWED_ATTRIBUTES)
  ...
  public boolean equals(Object o) {
    ...
    WidgetPolicy widgetPolicy = (WidgetPolicy) o;
    return Objects.equals(this.allowedAttributes, widgetPolicy.allowedAttributes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(allowedAttributes);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class WidgetPolicy {\n");
    sb.append("    allowedAttributes: ").append(toIndentedString(allowedAttributes)).append("\n");
    sb.append("}");
    return sb.toString();
  }

...
import org.openapitools.client.model.ComponentInfoOptions;
 ...
 */
@JsonPropertyOrder({
  ComponentInfo.JSON_PROPERTY_COMPONENT_ID,
  ComponentInfo.JSON_PROPERTY_COMPONENT_NAME,
  ComponentInfo.JSON_PROPERTY_ICON_IMG_FILE_URL,
  ComponentInfo.JSON_PROPERTY_STATUS,
  ComponentInfo.JSON_PROPERTY_HEADER_YN,
  ComponentInfo.JSON_PROPERTY_BODY_YN,
  ComponentInfo.JSON_PROPERTY_FOOTER_YN,
  ComponentInfo.JSON_PROPERTY_OPTIONS,
  ComponentInfo.JSON_PROPERTY_GROUP_COMPONENT_ID
})
...
public class ComponentInfo {
  ...
  public static final String JSON_PROPERTY_ICON_IMG_FILE_URL = "iconImgFileUrl";
  private String iconImgFileUrl;

  public static final String JSON_PROPERTY_STATUS = "status";
  private String status;

  /**
   * 레이아웃의 Header 영역 내 사용 가능 여부입니다.      + Y: 가능   + N: 불가능 
   */
  public enum HeaderYnEnum {
    Y("Y"),
    ...
    @JsonCreator
    public static HeaderYnEnum fromValue(String value) {
      for (HeaderYnEnum b : HeaderYnEnum.values()) {
  ...
  public static final String JSON_PROPERTY_HEADER_YN = "headerYn";
  private HeaderYnEnum headerYn;

  /**
   * 레이아웃의 Body 영역 내 사용 가능 여부입니다.      + Y: 가능   + N: 불가능 
   */
  public enum BodyYnEnum {
    Y("Y"),
    ...
    @JsonCreator
    public static BodyYnEnum fromValue(String value) {
      for (BodyYnEnum b : BodyYnEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  public static final String JSON_PROPERTY_BODY_YN = "bodyYn";
  private BodyYnEnum bodyYn;

  /**
   * 레이아웃의 footer 영역 내 사용 가능 여부입니다.      + Y: 가능   + N: 불가능 
   */
  public enum FooterYnEnum {
    Y("Y"),
    ...
    @JsonCreator
    public static FooterYnEnum fromValue(String value) {
      for (FooterYnEnum b : FooterYnEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  public static final String JSON_PROPERTY_FOOTER_YN = "footerYn";
  private FooterYnEnum footerYn;

  public static final String JSON_PROPERTY_OPTIONS = "options";
  private ComponentInfoOptions options;

  public static final String JSON_PROPERTY_GROUP_COMPONENT_ID = "groupComponentId";
  private String groupComponentId;

  public ComponentInfo() {
  }

  public ComponentInfo componentId(String componentId) {
  ...
  **/
  ...
  public ComponentInfo componentName(String componentName) {
  ...
  **/
  ...
  public ComponentInfo iconImgFileUrl(String iconImgFileUrl) {
    
    this.iconImgFileUrl = iconImgFileUrl;
    return this;
  }

   /**
   * 컴포넌트 모양을 아이콘으로 표현한 이미지 파일 주소입니다.
   * @return iconImgFileUrl
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ICON_IMG_FILE_URL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public String getIconImgFileUrl() {
    return iconImgFileUrl;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ICON_IMG_FILE_URL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIconImgFileUrl(String iconImgFileUrl) {
    this.iconImgFileUrl = iconImgFileUrl;
  }


  public ComponentInfo status(String status) {
   ...
   /**
   * 컴포넌트의 사용 가능 여부, 범위를 표시합니다.      + public: 레이아웃 등록/수정 시 사용 가능한 컴포넌트 입니다.     + private: RBC에서 특정 케이스별 추가하는 컴포넌트로 레이아웃 등록/수정 시 별도 사용할 수 없습니다.     + tpl: 템플릿에서 사용되는 컴포넌트로 레이아웃 등록/수정 시 사용할 수 없습니다.     + disable: 사용할 수 없는 컴포넌트 입니다. 제공 중이던 컴포넌트가 사용 중지된 경우 설정됩니다. 
   * @return status
  **/
  @javax.annotation.Nullable
  ...
  public ComponentInfo headerYn(HeaderYnEnum headerYn) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_HEADER_YN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public HeaderYnEnum getHeaderYn() {
    return headerYn;
  }
  ...
  @JsonProperty(JSON_PROPERTY_HEADER_YN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHeaderYn(HeaderYnEnum headerYn) {
    this.headerYn = headerYn;
  }


  public ComponentInfo bodyYn(BodyYnEnum bodyYn) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_BODY_YN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public BodyYnEnum getBodyYn() {
    return bodyYn;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BODY_YN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBodyYn(BodyYnEnum bodyYn) {
    this.bodyYn = bodyYn;
  }


  public ComponentInfo footerYn(FooterYnEnum footerYn) {
    
    this.footerYn = footerYn;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_FOOTER_YN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public FooterYnEnum getFooterYn() {
    return footerYn;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FOOTER_YN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFooterYn(FooterYnEnum footerYn) {
    this.footerYn = footerYn;
  }


  public ComponentInfo options(ComponentInfoOptions options) {
  ...
  **/
  ...
  public ComponentInfoOptions getOptions() {
    return options;
  }
  ...
  @JsonProperty(JSON_PROPERTY_OPTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOptions(ComponentInfoOptions options) {
    this.options = options;
  }


  public ComponentInfo groupComponentId(String groupComponentId) {
    
    this.groupComponentId = groupComponentId;
    return this;
  }

   /**
   * 컴포넌트 그룹 ID 입니다.   동일한 컴포넌트 그룹ID를 갖는 컴포넌트는 레이아웃의 body 영역에서 함께 사용될 수 없습니다. 
   * @return groupComponentId
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_GROUP_COMPONENT_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public String getGroupComponentId() {
    return groupComponentId;
  }
  ...
  @JsonProperty(JSON_PROPERTY_GROUP_COMPONENT_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setGroupComponentId(String groupComponentId) {
    this.groupComponentId = groupComponentId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.componentId, componentInfo.componentId) &&
        Objects.equals(this.componentName, componentInfo.componentName) &&
        Objects.equals(this.iconImgFileUrl, componentInfo.iconImgFileUrl) &&
        Objects.equals(this.status, componentInfo.status) &&
        Objects.equals(this.headerYn, componentInfo.headerYn) &&
        Objects.equals(this.bodyYn, componentInfo.bodyYn) &&
        Objects.equals(this.footerYn, componentInfo.footerYn) &&
        Objects.equals(this.options, componentInfo.options) &&
        Objects.equals(this.groupComponentId, componentInfo.groupComponentId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(componentId, componentName, iconImgFileUrl, status, headerYn, bodyYn, footerYn, options, groupComponentId);
  }
  ...
  public String toString() {
    ...
    sb.append("    iconImgFileUrl: ").append(toIndentedString(iconImgFileUrl)).append("\n");
    sb.append("    status: ").append(toIndentedString(status)).append("\n");
    sb.append("    headerYn: ").append(toIndentedString(headerYn)).append("\n");
    sb.append("    bodyYn: ").append(toIndentedString(bodyYn)).append("\n");
    sb.append("    footerYn: ").append(toIndentedString(footerYn)).append("\n");
    sb.append("    options: ").append(toIndentedString(options)).append("\n");
    sb.append("    groupComponentId: ").append(toIndentedString(groupComponentId)).append("\n");
    sb.append("}");
    return sb.toString();
  }

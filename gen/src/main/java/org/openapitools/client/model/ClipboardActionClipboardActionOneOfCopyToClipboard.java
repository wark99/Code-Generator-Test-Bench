 ...
 */
@JsonPropertyOrder({
  ClipboardActionClipboardActionOneOfCopyToClipboard.JSON_PROPERTY_TEXT
})
@JsonTypeName("clipboardAction_clipboardAction_oneOf_copyToClipboard")
...
public class ClipboardActionClipboardActionOneOfCopyToClipboard {
  public static final String JSON_PROPERTY_TEXT = "text";
  private String text;

  public ClipboardActionClipboardActionOneOfCopyToClipboard() {
  }

  public ClipboardActionClipboardActionOneOfCopyToClipboard text(String text) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ClipboardActionClipboardActionOneOfCopyToClipboard clipboardActionClipboardActionOneOfCopyToClipboard = (ClipboardActionClipboardActionOneOfCopyToClipboard) o;
    return Objects.equals(this.text, clipboardActionClipboardActionOneOfCopyToClipboard.text);
  }
  ...
  public String toString() {
    ...
    sb.append("class ClipboardActionClipboardActionOneOfCopyToClipboard {\n");

...
import org.openapitools.client.model.AppLinkItemInfo;
 ...
 */
@JsonPropertyOrder({
  MenuItemInfo.JSON_PROPERTY_BUTTON_TYPE,
  MenuItemInfo.JSON_PROPERTY_APPLINK,
  MenuItemInfo.JSON_PROPERTY_WEBLINK
})
...
public class MenuItemInfo {
  ...
  public enum ButtonTypeEnum {
    ...
    @JsonCreator
    public static ButtonTypeEnum fromValue(String value) {
      for (ButtonTypeEnum b : ButtonTypeEnum.values()) {
  ...
  public static final String JSON_PROPERTY_BUTTON_TYPE = "buttonType";
  private ButtonTypeEnum buttonType;

  public static final String JSON_PROPERTY_APPLINK = "applink";
  private AppLinkItemInfo applink;

  public static final String JSON_PROPERTY_WEBLINK = "weblink";
  private String weblink;

  public MenuItemInfo() {
  }

  public MenuItemInfo buttonType(ButtonTypeEnum buttonType) {
  ...
  **/
  ...
  public MenuItemInfo applink(AppLinkItemInfo applink) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_APPLINK)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public AppLinkItemInfo getApplink() {
    return applink;
  }
  ...
  @JsonProperty(JSON_PROPERTY_APPLINK)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setApplink(AppLinkItemInfo applink) {
    this.applink = applink;
  }


  public MenuItemInfo weblink(String weblink) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_WEBLINK)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public boolean equals(Object o) {
    ...
    MenuItemInfo menuItemInfo = (MenuItemInfo) o;
    return Objects.equals(this.buttonType, menuItemInfo.buttonType) &&
        Objects.equals(this.applink, menuItemInfo.applink) &&
        Objects.equals(this.weblink, menuItemInfo.weblink);
  }

 ...
 */
@JsonPropertyOrder({
  UrlAction.JSON_PROPERTY_URL_ACTION
})
@JsonTypeName("urlAction")
...
public class UrlAction {
  ...
  public UrlAction urlAction(UrlActionUrlAction urlAction) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.urlAction, urlAction.urlAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(urlAction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UrlAction {\n");

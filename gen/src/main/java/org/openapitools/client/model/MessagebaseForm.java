 ...
 */
@JsonPropertyOrder({
  MessagebaseForm.JSON_PROPERTY_MESSAGEBASEFORM_ID,
  MessagebaseForm.JSON_PROPERTY_FORM_NAME,
  MessagebaseForm.JSON_PROPERTY_CARD_TYPE,
  MessagebaseForm.JSON_PROPERTY_BIZ_CONDITION,
  MessagebaseForm.JSON_PROPERTY_BIZ_CATEGORY,
  MessagebaseForm.JSON_PROPERTY_BIZ_SERVICE,
  MessagebaseForm.JSON_PROPERTY_REGISTER_DATE,
  MessagebaseForm.JSON_PROPERTY_UPDATE_DATE
})
...
public class MessagebaseForm {
  ...
  public MessagebaseForm messagebaseformId(String messagebaseformId) {
  ...
  **/
  ...
  public MessagebaseForm formName(String formName) {
  ...
  **/
  ...
  public MessagebaseForm cardType(String cardType) {
  ...
  **/
  ...
  public MessagebaseForm bizCondition(List<String> bizCondition) {
    
    this.bizCondition = bizCondition;
    return this;
  }

  public MessagebaseForm addBizConditionItem(String bizConditionItem) {
    if (this.bizCondition == null) {
      this.bizCondition = new ArrayList<>();
    }
    this.bizCondition.add(bizConditionItem);
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_BIZ_CONDITION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBizCondition(List<String> bizCondition) {
    this.bizCondition = bizCondition;
  }


  public MessagebaseForm bizCategory(String bizCategory) {
  ...
  **/
  ...
  public MessagebaseForm bizService(String bizService) {
  ...
  **/
  ...
  public MessagebaseForm registerDate(OffsetDateTime registerDate) {
  ...
  **/
  ...
  public MessagebaseForm updateDate(OffsetDateTime updateDate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MessagebaseForm messagebaseForm = (MessagebaseForm) o;
    return Objects.equals(this.messagebaseformId, messagebaseForm.messagebaseformId) &&
        Objects.equals(this.formName, messagebaseForm.formName) &&
        Objects.equals(this.cardType, messagebaseForm.cardType) &&
        Objects.equals(this.bizCondition, messagebaseForm.bizCondition) &&
        Objects.equals(this.bizCategory, messagebaseForm.bizCategory) &&
        Objects.equals(this.bizService, messagebaseForm.bizService) &&
        Objects.equals(this.registerDate, messagebaseForm.registerDate) &&
        Objects.equals(this.updateDate, messagebaseForm.updateDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(messagebaseformId, formName, cardType, bizCondition, bizCategory, bizService, registerDate, updateDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MessagebaseForm {\n");

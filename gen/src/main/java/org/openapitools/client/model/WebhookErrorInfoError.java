...
/**
 * WebhookErrorInfoError
 */
@JsonPropertyOrder({
  WebhookErrorInfoError.JSON_PROPERTY_CODE,
  WebhookErrorInfoError.JSON_PROPERTY_MESSAGE
})
@JsonTypeName("WebhookErrorInfo_error")
...
public class WebhookErrorInfoError {
  ...
  public WebhookErrorInfoError() {
  }

  public WebhookErrorInfoError code(String code) {
  ...
  **/
  ...
  public WebhookErrorInfoError message(String message) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhookErrorInfoError webhookErrorInfoError = (WebhookErrorInfoError) o;
    return Objects.equals(this.code, webhookErrorInfoError.code) &&
        Objects.equals(this.message, webhookErrorInfoError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookErrorInfoError {\n");

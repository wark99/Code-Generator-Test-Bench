 ...
 */
@JsonPropertyOrder({
  TokenInfo.JSON_PROPERTY_ACCESS_TOKEN,
  TokenInfo.JSON_PROPERTY_EXPIRES_IN,
  TokenInfo.JSON_PROPERTY_USER_ID,
  TokenInfo.JSON_PROPERTY_ALLOWED_IP
})
...
public class TokenInfo {
  ...
  public static final String JSON_PROPERTY_ALLOWED_IP = "allowedIp";
  ...
  **/
  ...
  public TokenInfo expiresIn(String expiresIn) {
  ...
  **/
  ...
  public TokenInfo allowedIp(List<String> allowedIp) {
    
    this.allowedIp = allowedIp;
    return this;
  }

  public TokenInfo addAllowedIpItem(String allowedIpItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessToken, tokenInfo.accessToken) &&
        Objects.equals(this.expiresIn, tokenInfo.expiresIn) &&
        Objects.equals(this.userId, tokenInfo.userId) &&
        Objects.equals(this.allowedIp, tokenInfo.allowedIp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessToken, expiresIn, userId, allowedIp);
  }

...
import org.openapitools.client.model.OpenrichcardMessageOpenrichcardMessageLayout;
import org.openapitools.client.model.OpenrichcardMessageOpenrichcardMessageSuggestionsInner;
 ...
 */
@JsonPropertyOrder({
  OpenrichcardMessageOpenrichcardMessage.JSON_PROPERTY_CARD,
  OpenrichcardMessageOpenrichcardMessage.JSON_PROPERTY_COPY_ALLOWED,
  OpenrichcardMessageOpenrichcardMessage.JSON_PROPERTY_ZOOM_ALLOWED,
  OpenrichcardMessageOpenrichcardMessage.JSON_PROPERTY_SCALE_ALLOWED,
  OpenrichcardMessageOpenrichcardMessage.JSON_PROPERTY_LAYOUT,
  OpenrichcardMessageOpenrichcardMessage.JSON_PROPERTY_SUGGESTIONS
})
@JsonTypeName("OpenrichcardMessage_openrichcardMessage")
...
public class OpenrichcardMessageOpenrichcardMessage {
  /**
   * Gets or Sets card
   */
  public enum CardEnum {
    ...
    @JsonCreator
    public static CardEnum fromValue(String value) {
  ...
  public static final String JSON_PROPERTY_ZOOM_ALLOWED = "zoomAllowed";
  private Boolean zoomAllowed;

  public static final String JSON_PROPERTY_SCALE_ALLOWED = "scaleAllowed";
  private Boolean scaleAllowed;

  public static final String JSON_PROPERTY_LAYOUT = "layout";
  private OpenrichcardMessageOpenrichcardMessageLayout layout;

  public static final String JSON_PROPERTY_SUGGESTIONS = "suggestions";
  private List<OpenrichcardMessageOpenrichcardMessageSuggestionsInner> suggestions;

  public OpenrichcardMessageOpenrichcardMessage() {
  }

  public OpenrichcardMessageOpenrichcardMessage card(CardEnum card) {
  ...
  **/
  ...
  public OpenrichcardMessageOpenrichcardMessage copyAllowed(Boolean copyAllowed) {
   ...
   /**
   * set true to allow text copy of card text
   * @return copyAllowed
  **/
  ...
  public OpenrichcardMessageOpenrichcardMessage zoomAllowed(Boolean zoomAllowed) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ZOOM_ALLOWED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public OpenrichcardMessageOpenrichcardMessage scaleAllowed(Boolean scaleAllowed) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SCALE_ALLOWED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getScaleAllowed() {
    return scaleAllowed;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SCALE_ALLOWED)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setScaleAllowed(Boolean scaleAllowed) {
    this.scaleAllowed = scaleAllowed;
  }


  public OpenrichcardMessageOpenrichcardMessage layout(OpenrichcardMessageOpenrichcardMessageLayout layout) {
  ...
  **/
  ...
  public OpenrichcardMessageOpenrichcardMessageLayout getLayout() {
    return layout;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LAYOUT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLayout(OpenrichcardMessageOpenrichcardMessageLayout layout) {
    this.layout = layout;
  }


  public OpenrichcardMessageOpenrichcardMessage suggestions(List<OpenrichcardMessageOpenrichcardMessageSuggestionsInner> suggestions) {
    
    this.suggestions = suggestions;
    return this;
  }

  public OpenrichcardMessageOpenrichcardMessage addSuggestionsItem(OpenrichcardMessageOpenrichcardMessageSuggestionsInner suggestionsItem) {
   ...
   /**
   * Suggested replies and/or suggested actions for a chatbot message, send from chatbot platform to client.
   * @return suggestions
  **/
  @javax.annotation.Nullable
  ...
  public List<OpenrichcardMessageOpenrichcardMessageSuggestionsInner> getSuggestions() {
    return suggestions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUGGESTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSuggestions(List<OpenrichcardMessageOpenrichcardMessageSuggestionsInner> suggestions) {
    this.suggestions = suggestions;
  }
  ...
  public boolean equals(Object o) {
    ...
    OpenrichcardMessageOpenrichcardMessage openrichcardMessageOpenrichcardMessage = (OpenrichcardMessageOpenrichcardMessage) o;
    return Objects.equals(this.card, openrichcardMessageOpenrichcardMessage.card) &&
        Objects.equals(this.copyAllowed, openrichcardMessageOpenrichcardMessage.copyAllowed) &&
        Objects.equals(this.zoomAllowed, openrichcardMessageOpenrichcardMessage.zoomAllowed) &&
        Objects.equals(this.scaleAllowed, openrichcardMessageOpenrichcardMessage.scaleAllowed) &&
        Objects.equals(this.layout, openrichcardMessageOpenrichcardMessage.layout) &&
        Objects.equals(this.suggestions, openrichcardMessageOpenrichcardMessage.suggestions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(card, copyAllowed, zoomAllowed, scaleAllowed, layout, suggestions);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OpenrichcardMessageOpenrichcardMessage {\n");
    sb.append("    card: ").append(toIndentedString(card)).append("\n");
    sb.append("    copyAllowed: ").append(toIndentedString(copyAllowed)).append("\n");
    sb.append("    zoomAllowed: ").append(toIndentedString(zoomAllowed)).append("\n");
    sb.append("    scaleAllowed: ").append(toIndentedString(scaleAllowed)).append("\n");

 ...
 */
@JsonPropertyOrder({
  MapAction.JSON_PROPERTY_MAP_ACTION
})
@JsonTypeName("mapAction")
...
public class MapAction {
  ...
  public MapAction mapAction(MapActionMapAction mapAction) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mapAction, mapAction.mapAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mapAction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MapAction {\n");

 ...
 */
@JsonPropertyOrder({
  NotFoundError.JSON_PROPERTY_TYPE,
  NotFoundError.JSON_PROPERTY_UUID,
  NotFoundError.JSON_PROPERTY_MESSAGE,
  NotFoundError.JSON_PROPERTY_ID,
  NotFoundError.JSON_PROPERTY_KIND
})
...
public class NotFoundError {
  ...
  **/
  ...
  public NotFoundError uuid(String uuid) {
  ...
  **/
  ...
  public NotFoundError id(String id) {
   ...
   /**
   * The identifier of the entity not found, e.g. the name of a table or the UUID of a job.
   * @return id
  **/
  @javax.annotation.Nonnull
  ...
  public NotFoundError kind(String kind) {
   ...
   /**
   * The entity that is not found such as a namespace, table, object or job.
   * @return kind
  **/
  @javax.annotation.Nonnull
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, notFoundError.type) &&
        Objects.equals(this.uuid, notFoundError.uuid) &&
        Objects.equals(this.message, notFoundError.message) &&
        Objects.equals(this.id, notFoundError.id) &&
        Objects.equals(this.kind, notFoundError.kind);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, uuid, message, id, kind);
  }

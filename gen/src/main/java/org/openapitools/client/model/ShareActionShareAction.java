...
import org.openapitools.client.model.ShareActionShareActionOneOf;
 ...
 */
@JsonPropertyOrder({
  ShareActionShareAction.JSON_PROPERTY_SHARE_TEXT
})
@JsonTypeName("shareAction_shareAction")
...
public class ShareActionShareAction {
  public static final String JSON_PROPERTY_SHARE_TEXT = "shareText";
  private ClipboardActionClipboardActionOneOfCopyToClipboard shareText;

  public ShareActionShareAction() {
  }

  public ShareActionShareAction shareText(ClipboardActionClipboardActionOneOfCopyToClipboard shareText) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_SHARE_TEXT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public ClipboardActionClipboardActionOneOfCopyToClipboard getShareText() {
    return shareText;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SHARE_TEXT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setShareText(ClipboardActionClipboardActionOneOfCopyToClipboard shareText) {
    this.shareText = shareText;
  }
  ...
  public boolean equals(Object o) {
    ...
    ShareActionShareAction shareActionShareAction = (ShareActionShareAction) o;
    return Objects.equals(this.shareText, shareActionShareAction.shareText);
  }

  @Override
  public int hashCode() {
    return Objects.hash(shareText);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ShareActionShareAction {\n");
    sb.append("    shareText: ").append(toIndentedString(shareText)).append("\n");
    sb.append("}");
    return sb.toString();
  }

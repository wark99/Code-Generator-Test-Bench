...
import org.openapitools.client.model.PersistentMenu;
 ...
 */
@JsonPropertyOrder({
  BiChatbotDetail.JSON_PROPERTY_CHATBOT_ID,
  BiChatbotDetail.JSON_PROPERTY_BRAND_ID,
  BiChatbotDetail.JSON_PROPERTY_SUB_NUM,
  BiChatbotDetail.JSON_PROPERTY_SUB_TITLE,
  BiChatbotDetail.JSON_PROPERTY_SERVICE,
  BiChatbotDetail.JSON_PROPERTY_DISPLAY,
  BiChatbotDetail.JSON_PROPERTY_INPUT_FIELD,
  BiChatbotDetail.JSON_PROPERTY_BOT_AGENCY_ID,
  BiChatbotDetail.JSON_PROPERTY_SUB_DESCR,
  BiChatbotDetail.JSON_PROPERTY_SAFTY_STATUS_YN,
  BiChatbotDetail.JSON_PROPERTY_PS_MENU_USE,
  BiChatbotDetail.JSON_PROPERTY_APPROVAL_RESULT,
  BiChatbotDetail.JSON_PROPERTY_REGISTER_DATE,
  BiChatbotDetail.JSON_PROPERTY_APPROVAL_DATE,
  BiChatbotDetail.JSON_PROPERTY_UPDATE_DATE,
  BiChatbotDetail.JSON_PROPERTY_REGISTER_ID,
  BiChatbotDetail.JSON_PROPERTY_UPDATE_ID,
  BiChatbotDetail.JSON_PROPERTY_GROUP_ID,
  BiChatbotDetail.JSON_PROPERTY_IS_MAIN_NUM,
  BiChatbotDetail.JSON_PROPERTY_MEDIA_URL,
  BiChatbotDetail.JSON_PROPERTY_RCS_REPLY,
  BiChatbotDetail.JSON_PROPERTY_APPROVAL_REASON,
  BiChatbotDetail.JSON_PROPERTY_STATUS,
  BiChatbotDetail.JSON_PROPERTY_SEARCH_WEIGHT,
  BiChatbotDetail.JSON_PROPERTY_WEBHOOK,
  BiChatbotDetail.JSON_PROPERTY_BOT_TC_PAGE,
  BiChatbotDetail.JSON_PROPERTY_PERSISTENT_MENU
})
...
public class BiChatbotDetail {
  ...
  public enum RcsReplyEnum {
    ...
    @JsonCreator
    public static RcsReplyEnum fromValue(String value) {
  ...
  private RcsReplyEnum rcsReply = RcsReplyEnum._1;
  ...
  private String searchWeight = "512";
  ...
  public BiChatbotDetail() {
  }

  public BiChatbotDetail chatbotId(Object chatbotId) {
  ...
  **/
  ...
  public BiChatbotDetail brandId(Object brandId) {
  ...
  **/
  ...
  public BiChatbotDetail subNum(Object subNum) {
  ...
  **/
  ...
  public BiChatbotDetail subTitle(Object subTitle) {
  ...
  **/
  ...
  public BiChatbotDetail service(ServiceEnum service) {
  ...
  **/
  ...
  public BiChatbotDetail display(DisplayEnum display) {
  ...
  **/
  ...
  public BiChatbotDetail inputField(InputFieldEnum inputField) {
  ...
  **/
  ...
  public BiChatbotDetail botAgencyId(Object botAgencyId) {
  ...
  **/
  ...
  public BiChatbotDetail subDescr(Object subDescr) {
  ...
  **/
  ...
  public BiChatbotDetail saftyStatusYn(SaftyStatusYnEnum saftyStatusYn) {
  ...
  **/
  ...
  public BiChatbotDetail psMenuUse(Object psMenuUse) {
  ...
  **/
  ...
  public BiChatbotDetail approvalResult(ApprovalResultEnum approvalResult) {
  ...
  **/
  ...
  public BiChatbotDetail registerDate(Object registerDate) {
  ...
  **/
  ...
  public BiChatbotDetail approvalDate(Object approvalDate) {
  ...
  **/
  ...
  public BiChatbotDetail updateDate(Object updateDate) {
  ...
  **/
  ...
  public BiChatbotDetail registerId(Object registerId) {
  ...
  **/
  ...
  public BiChatbotDetail updateId(Object updateId) {
  ...
  **/
  ...
  public BiChatbotDetail groupId(Object groupId) {
  ...
  **/
  ...
  public BiChatbotDetail isMainNum(Object isMainNum) {
  ...
  **/
  ...
  public BiChatbotDetail mediaUrl(List<MediaUrlInner> mediaUrl) {
    
    this.mediaUrl = mediaUrl;
    return this;
  }

  public BiChatbotDetail addMediaUrlItem(MediaUrlInner mediaUrlItem) {
  ...
  **/
  ...
  public BiChatbotDetail rcsReply(RcsReplyEnum rcsReply) {
  ...
  **/
  ...
  public BiChatbotDetail approvalReason(String approvalReason) {
  ...
  **/
  ...
  public BiChatbotDetail status(StatusEnum status) {
  ...
  **/
  ...
  public BiChatbotDetail searchWeight(String searchWeight) {
  ...
  **/
  ...
  public BiChatbotDetail webhook(String webhook) {
  ...
  **/
  ...
  public BiChatbotDetail botTcPage(String botTcPage) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_BOT_TC_PAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBotTcPage(String botTcPage) {
    this.botTcPage = botTcPage;
  }


  public BiChatbotDetail persistentMenu(List<PersistentMenu> persistentMenu) {
    
    this.persistentMenu = persistentMenu;
    return this;
  }

  public BiChatbotDetail addPersistentMenuItem(PersistentMenu persistentMenuItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BiChatbotDetail biChatbotDetail = (BiChatbotDetail) o;
    return Objects.equals(this.chatbotId, biChatbotDetail.chatbotId) &&
        Objects.equals(this.brandId, biChatbotDetail.brandId) &&
        Objects.equals(this.subNum, biChatbotDetail.subNum) &&
        equalsNullable(this.subTitle, biChatbotDetail.subTitle) &&
        equalsNullable(this.service, biChatbotDetail.service) &&
        equalsNullable(this.display, biChatbotDetail.display) &&
        equalsNullable(this.inputField, biChatbotDetail.inputField) &&
        equalsNullable(this.botAgencyId, biChatbotDetail.botAgencyId) &&
        equalsNullable(this.subDescr, biChatbotDetail.subDescr) &&
        equalsNullable(this.saftyStatusYn, biChatbotDetail.saftyStatusYn) &&
        equalsNullable(this.psMenuUse, biChatbotDetail.psMenuUse) &&
        equalsNullable(this.approvalResult, biChatbotDetail.approvalResult) &&
        equalsNullable(this.registerDate, biChatbotDetail.registerDate) &&
        equalsNullable(this.approvalDate, biChatbotDetail.approvalDate) &&
        equalsNullable(this.updateDate, biChatbotDetail.updateDate) &&
        equalsNullable(this.registerId, biChatbotDetail.registerId) &&
        equalsNullable(this.updateId, biChatbotDetail.updateId) &&
        equalsNullable(this.groupId, biChatbotDetail.groupId) &&
        equalsNullable(this.isMainNum, biChatbotDetail.isMainNum) &&
        Objects.equals(this.mediaUrl, biChatbotDetail.mediaUrl) &&
        Objects.equals(this.rcsReply, biChatbotDetail.rcsReply) &&
        Objects.equals(this.approvalReason, biChatbotDetail.approvalReason) &&
        Objects.equals(this.status, biChatbotDetail.status) &&
        Objects.equals(this.searchWeight, biChatbotDetail.searchWeight) &&
        Objects.equals(this.webhook, biChatbotDetail.webhook) &&
        Objects.equals(this.botTcPage, biChatbotDetail.botTcPage) &&
        Objects.equals(this.persistentMenu, biChatbotDetail.persistentMenu);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(chatbotId, brandId, subNum, hashCodeNullable(subTitle), hashCodeNullable(service), hashCodeNullable(display), hashCodeNullable(inputField), hashCodeNullable(botAgencyId), hashCodeNullable(subDescr), hashCodeNullable(saftyStatusYn), hashCodeNullable(psMenuUse), hashCodeNullable(approvalResult), hashCodeNullable(registerDate), hashCodeNullable(approvalDate), hashCodeNullable(updateDate), hashCodeNullable(registerId), hashCodeNullable(updateId), hashCodeNullable(groupId), hashCodeNullable(isMainNum), mediaUrl, rcsReply, approvalReason, status, searchWeight, webhook, botTcPage, persistentMenu);
  }
  ...
  public String toString() {
    ...
    sb.append("class BiChatbotDetail {\n");

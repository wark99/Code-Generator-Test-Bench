 ...
 */
@JsonPropertyOrder({
  SampleLayoutDetail.JSON_PROPERTY_SPEC,
  SampleLayoutDetail.JSON_PROPERTY_CARD_TYPE,
  SampleLayoutDetail.JSON_PROPERTY_BUTTON_COLOR,
  SampleLayoutDetail.JSON_PROPERTY_HEADER_COMPOSITION,
  SampleLayoutDetail.JSON_PROPERTY_BODY_COMPOSITION,
  SampleLayoutDetail.JSON_PROPERTY_FOOTER_COMPOSITION,
  SampleLayoutDetail.JSON_PROPERTY_FORMATTED_STRING,
  SampleLayoutDetail.JSON_PROPERTY_SAMPLE_LAYOUT_ID,
  SampleLayoutDetail.JSON_PROPERTY_SAMPLE_LAYOUT_NAME,
  SampleLayoutDetail.JSON_PROPERTY_PRODUCT_CODE,
  SampleLayoutDetail.JSON_PROPERTY_STATUS,
  SampleLayoutDetail.JSON_PROPERTY_REGISTER_ID,
  SampleLayoutDetail.JSON_PROPERTY_REGISTER_DATE,
  SampleLayoutDetail.JSON_PROPERTY_UPDATE_DATE,
  SampleLayoutDetail.JSON_PROPERTY_APPROVAL_RESULT
})
...
public class SampleLayoutDetail {
  /**
  ...
  /**
   * 샘플 레이아웃의 상태를 표시합니다.      + ready : 사용     + pause : 사용중지 
   */
  ...
  /**
   * 레이아웃 등록 상태입니다. 레이아웃은 운영자 검수 없이 자동 등록됩니다.        - 등록완료 : 이통3사에 정상 등록된 상태입니다.                   - 저장 : RBC 웹에서 저장만 했을 경우 상태이며 별도 등록요청을 해야 합니다.     - 처리중 : 이통 3사 등록 중 에러로 인해 최종 완료가 되지 않은 상태로 수정이나 삭제가 불가능한 상태입니다.    
   */
  ...
  public SampleLayoutDetail() {
  }

  public SampleLayoutDetail spec(SpecEnum spec) {
  ...
  **/
  ...
  public SampleLayoutDetail cardType(CardTypeEnum cardType) {
  ...
  **/
  ...
  public SampleLayoutDetail buttonColor(Object buttonColor) {
  ...
  **/
  ...
  public SampleLayoutDetail headerComposition(Object headerComposition) {
  ...
  **/
  ...
  public SampleLayoutDetail bodyComposition(Object bodyComposition) {
  ...
  **/
  ...
  public SampleLayoutDetail footerComposition(Object footerComposition) {
  ...
  **/
  ...
  public SampleLayoutDetail formattedString(OpenrichcardMessage formattedString) {
  ...
  **/
  ...
  public SampleLayoutDetail sampleLayoutId(Object sampleLayoutId) {
  ...
  **/
  ...
  public SampleLayoutDetail sampleLayoutName(Object sampleLayoutName) {
  ...
  **/
  ...
  public SampleLayoutDetail productCode(ProductCodeEnum productCode) {
  ...
  **/
  ...
  public SampleLayoutDetail status(StatusEnum status) {
  ...
  **/
  ...
  public SampleLayoutDetail registerId(Object registerId) {
  ...
  **/
  ...
  public SampleLayoutDetail registerDate(Object registerDate) {
  ...
  **/
  ...
  public SampleLayoutDetail updateDate(Object updateDate) {
  ...
  **/
  ...
  public SampleLayoutDetail approvalResult(ApprovalResultEnum approvalResult) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SampleLayoutDetail sampleLayoutDetail = (SampleLayoutDetail) o;
    return equalsNullable(this.spec, sampleLayoutDetail.spec) &&
        equalsNullable(this.cardType, sampleLayoutDetail.cardType) &&
        equalsNullable(this.buttonColor, sampleLayoutDetail.buttonColor) &&
        equalsNullable(this.headerComposition, sampleLayoutDetail.headerComposition) &&
        equalsNullable(this.bodyComposition, sampleLayoutDetail.bodyComposition) &&
        equalsNullable(this.footerComposition, sampleLayoutDetail.footerComposition) &&
        Objects.equals(this.formattedString, sampleLayoutDetail.formattedString) &&
        equalsNullable(this.sampleLayoutId, sampleLayoutDetail.sampleLayoutId) &&
        equalsNullable(this.sampleLayoutName, sampleLayoutDetail.sampleLayoutName) &&
        equalsNullable(this.productCode, sampleLayoutDetail.productCode) &&
        equalsNullable(this.status, sampleLayoutDetail.status) &&
        equalsNullable(this.registerId, sampleLayoutDetail.registerId) &&
        equalsNullable(this.registerDate, sampleLayoutDetail.registerDate) &&
        equalsNullable(this.updateDate, sampleLayoutDetail.updateDate) &&
        equalsNullable(this.approvalResult, sampleLayoutDetail.approvalResult);
  }
  ...
  public String toString() {
    ...
    sb.append("class SampleLayoutDetail {\n");

...
import org.openapitools.client.model.SubStatData;
 ...
 */
@JsonPropertyOrder({
  MenuStatData.JSON_PROPERTY_POSTBACK_ID,
  MenuStatData.JSON_PROPERTY_MENU_TYPE,
  MenuStatData.JSON_PROPERTY_ACTION_TYPE,
  MenuStatData.JSON_PROPERTY_TITLE,
  MenuStatData.JSON_PROPERTY_CLICK_COUNT,
  MenuStatData.JSON_PROPERTY_SUB_LIST
})
...
public class MenuStatData {
  public static final String JSON_PROPERTY_POSTBACK_ID = "postbackId";
  private String postbackId;

  /**
   * 메뉴 할당된 액션 구분 - action: RCS 액션 버튼(urlAction, mapAction, ...) 메뉴 - reply: 기본응답 메뉴 - autoreply: 자동응답 메뉴 - menu: 하위 메뉴를 갖는 상위 메뉴 
   */
  ...
  public static final String JSON_PROPERTY_SUB_LIST = "subList";
  private List<SubStatData> subList;

  public MenuStatData() {
  }

  public MenuStatData postbackId(String postbackId) {
  ...
  **/
  ...
  public MenuStatData menuType(MenuTypeEnum menuType) {
  ...
  **/
  ...
  public MenuStatData actionType(ActionTypeEnum actionType) {
  ...
  **/
  ...
  public MenuStatData title(String title) {
  ...
  **/
  ...
  public MenuStatData clickCount(Integer clickCount) {
  ...
  **/
  ...
  public MenuStatData subList(List<SubStatData> subList) {
    
    this.subList = subList;
    return this;
  }

  public MenuStatData addSubListItem(SubStatData subListItem) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SUB_LIST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<SubStatData> getSubList() {
    return subList;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUB_LIST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubList(List<SubStatData> subList) {
    this.subList = subList;
  }
  ...
  public boolean equals(Object o) {
    ...
    MenuStatData menuStatData = (MenuStatData) o;
    return Objects.equals(this.postbackId, menuStatData.postbackId) &&
        Objects.equals(this.menuType, menuStatData.menuType) &&
        Objects.equals(this.actionType, menuStatData.actionType) &&
        Objects.equals(this.title, menuStatData.title) &&
        Objects.equals(this.clickCount, menuStatData.clickCount) &&
        Objects.equals(this.subList, menuStatData.subList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(postbackId, menuType, actionType, title, clickCount, subList);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MenuStatData {\n");

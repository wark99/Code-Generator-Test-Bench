 ...
 */
@JsonPropertyOrder({
  MessagebaseFormInfo.JSON_PROPERTY_MEDIA_URL,
  MessagebaseFormInfo.JSON_PROPERTY_PRODUCT_CODE,
  MessagebaseFormInfo.JSON_PROPERTY_SPEC,
  MessagebaseFormInfo.JSON_PROPERTY_GUIDE_INFO,
  MessagebaseFormInfo.JSON_PROPERTY_POLICY_INFO,
  MessagebaseFormInfo.JSON_PROPERTY_PARAMS,
  MessagebaseFormInfo.JSON_PROPERTY_FORMATTED_STRING,
  MessagebaseFormInfo.JSON_PROPERTY_MESSAGEBASEFORM_ID,
  MessagebaseFormInfo.JSON_PROPERTY_FORM_NAME,
  MessagebaseFormInfo.JSON_PROPERTY_CARD_TYPE,
  MessagebaseFormInfo.JSON_PROPERTY_BIZ_CONDITION,
  MessagebaseFormInfo.JSON_PROPERTY_BIZ_CATEGORY,
  MessagebaseFormInfo.JSON_PROPERTY_BIZ_SERVICE,
  MessagebaseFormInfo.JSON_PROPERTY_REGISTER_DATE,
  MessagebaseFormInfo.JSON_PROPERTY_UPDATE_DATE
})
...
public class MessagebaseFormInfo {
  ...
  private Object messagebaseformId = null;

  public static final String JSON_PROPERTY_FORM_NAME = "formName";
  private Object formName = null;
  ...
  public static final String JSON_PROPERTY_BIZ_CONDITION = "bizCondition";
  private JsonNullable<Object> bizCondition = JsonNullable.<Object>of(null);

  public static final String JSON_PROPERTY_BIZ_CATEGORY = "bizCategory";
  private JsonNullable<Object> bizCategory = JsonNullable.<Object>of(null);

  public static final String JSON_PROPERTY_BIZ_SERVICE = "bizService";
  private JsonNullable<Object> bizService = JsonNullable.<Object>of(null);
  ...
  public MessagebaseFormInfo() {
  }

  public MessagebaseFormInfo mediaUrl(List<MediaUrlInner> mediaUrl) {
    
    this.mediaUrl = mediaUrl;
    return this;
  }

  public MessagebaseFormInfo addMediaUrlItem(MediaUrlInner mediaUrlItem) {
  ...
  **/
  ...
  public MessagebaseFormInfo productCode(ProductCodeEnum productCode) {
  ...
  **/
  ...
  public MessagebaseFormInfo spec(SpecEnum spec) {
  ...
  **/
  ...
  public MessagebaseFormInfo guideInfo(GuideInfo guideInfo) {
  ...
  **/
  ...
  public MessagebaseFormInfo policyInfo(PolicyInfo policyInfo) {
  ...
  **/
  ...
  public MessagebaseFormInfo params(Object params) {
  ...
  **/
  ...
  public MessagebaseFormInfo formattedString(RCSMessage formattedString) {
  ...
  **/
  ...
  public MessagebaseFormInfo messagebaseformId(Object messagebaseformId) {
  ...
  **/
  ...
  public MessagebaseFormInfo formName(Object formName) {
  ...
  **/
  ...
  public MessagebaseFormInfo cardType(Object cardType) {
  ...
  **/
  ...
  public MessagebaseFormInfo bizCondition(Object bizCondition) {
    this.bizCondition = JsonNullable.<Object>of(bizCondition);
  ...
  **/
  ...
  public Object getBizCondition() {
        return bizCondition.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_BIZ_CONDITION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getBizCondition_JsonNullable() {
    return bizCondition;
  }
  
  @JsonProperty(JSON_PROPERTY_BIZ_CONDITION)
  public void setBizCondition_JsonNullable(JsonNullable<Object> bizCondition) {
    this.bizCondition = bizCondition;
  }

  public void setBizCondition(Object bizCondition) {
    this.bizCondition = JsonNullable.<Object>of(bizCondition);
  }


  public MessagebaseFormInfo bizCategory(Object bizCategory) {
    this.bizCategory = JsonNullable.<Object>of(bizCategory);
  ...
  **/
  ...
  public Object getBizCategory() {
        return bizCategory.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_BIZ_CATEGORY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getBizCategory_JsonNullable() {
    return bizCategory;
  }
  
  @JsonProperty(JSON_PROPERTY_BIZ_CATEGORY)
  public void setBizCategory_JsonNullable(JsonNullable<Object> bizCategory) {
    this.bizCategory = bizCategory;
  }

  public void setBizCategory(Object bizCategory) {
    this.bizCategory = JsonNullable.<Object>of(bizCategory);
  }


  public MessagebaseFormInfo bizService(Object bizService) {
    this.bizService = JsonNullable.<Object>of(bizService);
  ...
  **/
  ...
  public Object getBizService() {
        return bizService.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_BIZ_SERVICE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getBizService_JsonNullable() {
    return bizService;
  }
  
  @JsonProperty(JSON_PROPERTY_BIZ_SERVICE)
  public void setBizService_JsonNullable(JsonNullable<Object> bizService) {
    this.bizService = bizService;
  }

  public void setBizService(Object bizService) {
    this.bizService = JsonNullable.<Object>of(bizService);
  }


  public MessagebaseFormInfo registerDate(Object registerDate) {
  ...
  **/
  ...
  public MessagebaseFormInfo updateDate(Object updateDate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MessagebaseFormInfo messagebaseFormInfo = (MessagebaseFormInfo) o;
    return Objects.equals(this.mediaUrl, messagebaseFormInfo.mediaUrl) &&
        equalsNullable(this.productCode, messagebaseFormInfo.productCode) &&
        equalsNullable(this.spec, messagebaseFormInfo.spec) &&
        Objects.equals(this.guideInfo, messagebaseFormInfo.guideInfo) &&
        Objects.equals(this.policyInfo, messagebaseFormInfo.policyInfo) &&
        equalsNullable(this.params, messagebaseFormInfo.params) &&
        Objects.equals(this.formattedString, messagebaseFormInfo.formattedString) &&
        Objects.equals(this.messagebaseformId, messagebaseFormInfo.messagebaseformId) &&
        Objects.equals(this.formName, messagebaseFormInfo.formName) &&
        equalsNullable(this.cardType, messagebaseFormInfo.cardType) &&
        equalsNullable(this.bizCondition, messagebaseFormInfo.bizCondition) &&
        equalsNullable(this.bizCategory, messagebaseFormInfo.bizCategory) &&
        equalsNullable(this.bizService, messagebaseFormInfo.bizService) &&
        equalsNullable(this.registerDate, messagebaseFormInfo.registerDate) &&
        equalsNullable(this.updateDate, messagebaseFormInfo.updateDate);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(mediaUrl, hashCodeNullable(productCode), hashCodeNullable(spec), guideInfo, policyInfo, hashCodeNullable(params), formattedString, messagebaseformId, formName, hashCodeNullable(cardType), hashCodeNullable(bizCondition), hashCodeNullable(bizCategory), hashCodeNullable(bizService), hashCodeNullable(registerDate), hashCodeNullable(updateDate));
  }
  ...
  public String toString() {
    ...
    sb.append("class MessagebaseFormInfo {\n");
    ...
    sb.append("    bizCondition: ").append(toIndentedString(bizCondition)).append("\n");
    sb.append("    bizCategory: ").append(toIndentedString(bizCategory)).append("\n");
    sb.append("    bizService: ").append(toIndentedString(bizService)).append("\n");

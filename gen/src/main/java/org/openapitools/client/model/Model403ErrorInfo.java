...
import org.openapitools.client.model.Model403ErrorInfoError;
 ...
 */
@JsonPropertyOrder({
  Model403ErrorInfo.JSON_PROPERTY_STATUS,
  Model403ErrorInfo.JSON_PROPERTY_ERROR
})
@JsonTypeName("403ErrorInfo")
...
public class Model403ErrorInfo {
  public static final String JSON_PROPERTY_STATUS = "status";
  private Integer status;

  public static final String JSON_PROPERTY_ERROR = "error";
  private Model403ErrorInfoError error;

  public Model403ErrorInfo() {
  }

  public Model403ErrorInfo status(Integer status) {
  ...
  **/
  ...
  public Model403ErrorInfo error(Model403ErrorInfoError error) {
  ...
  **/
  ...
  public Model403ErrorInfoError getError() {
    return error;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ERROR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setError(Model403ErrorInfoError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    Model403ErrorInfo _403errorInfo = (Model403ErrorInfo) o;
    return Objects.equals(this.status, _403errorInfo.status) &&
        Objects.equals(this.error, _403errorInfo.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class Model403ErrorInfo {\n");

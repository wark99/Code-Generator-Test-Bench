 ...
 */
@JsonPropertyOrder({
  BrandInfo.JSON_PROPERTY_BRAND_ID,
  BrandInfo.JSON_PROPERTY_NAME,
  BrandInfo.JSON_PROPERTY_BRAND_KEY,
  BrandInfo.JSON_PROPERTY_REGISTER_DATE,
  BrandInfo.JSON_PROPERTY_APPROVAL_DATE,
  BrandInfo.JSON_PROPERTY_UPDATE_DATE,
  BrandInfo.JSON_PROPERTY_STATUS,
  BrandInfo.JSON_PROPERTY_MEDIA_URL,
  BrandInfo.JSON_PROPERTY_CHATBOT_DATE,
  BrandInfo.JSON_PROPERTY_MESSAGEBASE_DATE
})
...
public class BrandInfo {
  ...
  public BrandInfo brandId(String brandId) {
  ...
  **/
  ...
  public BrandInfo brandKey(String brandKey) {
  ...
  **/
  ...
  public BrandInfo registerDate(OffsetDateTime registerDate) {
  ...
  **/
  ...
  public BrandInfo approvalDate(OffsetDateTime approvalDate) {
  ...
  **/
  ...
  public BrandInfo updateDate(OffsetDateTime updateDate) {
  ...
  **/
  ...
  public BrandInfo status(StatusEnum status) {
  ...
  **/
  ...
  public BrandInfo mediaUrl(List<MediaUrlInner> mediaUrl) {
    
    this.mediaUrl = mediaUrl;
    return this;
  }

  public BrandInfo addMediaUrlItem(MediaUrlInner mediaUrlItem) {
  ...
  **/
  ...
  public BrandInfo chatbotDate(OffsetDateTime chatbotDate) {
  ...
  **/
  ...
  public BrandInfo messagebaseDate(OffsetDateTime messagebaseDate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.brandId, brandInfo.brandId) &&
        Objects.equals(this.name, brandInfo.name) &&
        Objects.equals(this.brandKey, brandInfo.brandKey) &&
        Objects.equals(this.registerDate, brandInfo.registerDate) &&
        Objects.equals(this.approvalDate, brandInfo.approvalDate) &&
        Objects.equals(this.updateDate, brandInfo.updateDate) &&
        Objects.equals(this.status, brandInfo.status) &&
        Objects.equals(this.mediaUrl, brandInfo.mediaUrl) &&
        Objects.equals(this.chatbotDate, brandInfo.chatbotDate) &&
        Objects.equals(this.messagebaseDate, brandInfo.messagebaseDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(brandId, name, brandKey, registerDate, approvalDate, updateDate, status, mediaUrl, chatbotDate, messagebaseDate);
  }

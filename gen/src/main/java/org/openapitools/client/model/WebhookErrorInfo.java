...
import org.openapitools.client.model.WebhookErrorInfoError;
 ...
 */
@JsonPropertyOrder({
  WebhookErrorInfo.JSON_PROPERTY_STATUS,
  WebhookErrorInfo.JSON_PROPERTY_ERROR
})
...
public class WebhookErrorInfo {
  public static final String JSON_PROPERTY_STATUS = "status";
  private String status;

  public static final String JSON_PROPERTY_ERROR = "error";
  private WebhookErrorInfoError error;

  public WebhookErrorInfo() {
  }

  public WebhookErrorInfo status(String status) {
  ...
  **/
  ...
  public WebhookErrorInfo error(WebhookErrorInfoError error) {
  ...
  **/
  ...
  public WebhookErrorInfoError getError() {
    return error;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ERROR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setError(WebhookErrorInfoError error) {
    this.error = error;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebhookErrorInfo webhookErrorInfo = (WebhookErrorInfo) o;
    return Objects.equals(this.status, webhookErrorInfo.status) &&
        Objects.equals(this.error, webhookErrorInfo.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookErrorInfo {\n");

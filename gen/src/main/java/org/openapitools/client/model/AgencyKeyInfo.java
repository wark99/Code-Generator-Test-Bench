 ...
 */
@JsonPropertyOrder({
  AgencyKeyInfo.JSON_PROPERTY_AGENCY_KEY,
  AgencyKeyInfo.JSON_PROPERTY_REGISTER_DATE,
  AgencyKeyInfo.JSON_PROPERTY_USER_NAME,
  AgencyKeyInfo.JSON_PROPERTY_IS_SYNC
})
...
public class AgencyKeyInfo {
  ...
  public static final String JSON_PROPERTY_IS_SYNC = "isSync";
  private Boolean isSync;

  public AgencyKeyInfo() {
  }

  public AgencyKeyInfo agencyKey(String agencyKey) {
  ...
  **/
  ...
  public AgencyKeyInfo registerDate(OffsetDateTime registerDate) {
  ...
  **/
  ...
  public AgencyKeyInfo userName(String userName) {
  ...
  **/
  ...
  public AgencyKeyInfo isSync(Boolean isSync) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_IS_SYNC)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public boolean equals(Object o) {
    ...
    AgencyKeyInfo agencyKeyInfo = (AgencyKeyInfo) o;
    return Objects.equals(this.agencyKey, agencyKeyInfo.agencyKey) &&
        Objects.equals(this.registerDate, agencyKeyInfo.registerDate) &&
        Objects.equals(this.userName, agencyKeyInfo.userName) &&
        Objects.equals(this.isSync, agencyKeyInfo.isSync);
  }

  @Override
  public int hashCode() {
    return Objects.hash(agencyKey, registerDate, userName, isSync);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AgencyKeyInfo {\n");

...
import org.openapitools.client.model.SubActionData;
 ...
 */
@JsonPropertyOrder({
  SubStatData.JSON_PROPERTY_POSTBACK_ID,
  SubStatData.JSON_PROPERTY_MENU_TYPE,
  SubStatData.JSON_PROPERTY_MESSAGEBASE_ID,
  SubStatData.JSON_PROPERTY_REACTION_TYPE,
  SubStatData.JSON_PROPERTY_CARD_NUM,
  SubStatData.JSON_PROPERTY_BUTTON_NUM,
  SubStatData.JSON_PROPERTY_ACTION_TYPE,
  SubStatData.JSON_PROPERTY_TITLE,
  SubStatData.JSON_PROPERTY_CLICK_COUNT,
  SubStatData.JSON_PROPERTY_SUB_ACTION_LIST
})
...
public class SubStatData {
  public static final String JSON_PROPERTY_POSTBACK_ID = "postbackId";
  private String postbackId;

  /**
   * 하위 메뉴에 할당된 액션 구분 - action: RCS 액션 버튼(urlAction, mapAction, ...) 메뉴 - reply: 기본응답 메뉴 - autoreply: 자동응답 메뉴 
   */
  ...
  public static final String JSON_PROPERTY_MENU_TYPE = "menuType";
  private MenuTypeEnum menuType;

  public static final String JSON_PROPERTY_MESSAGEBASE_ID = "messagebaseId";
  private String messagebaseId = "NA";

  /**
   * 고객이 클릭 반응한 대상(messagebaseId 식별 불가시 NA)
   */
  ...
  private ReactionTypeEnum reactionType = ReactionTypeEnum.NA;

  public static final String JSON_PROPERTY_CARD_NUM = "cardNum";
  private Integer cardNum = 0;

  public static final String JSON_PROPERTY_BUTTON_NUM = "buttonNum";
  private Integer buttonNum = 0;
  ...
  public static final String JSON_PROPERTY_SUB_ACTION_LIST = "subActionList";
  private List<SubActionData> subActionList;

  public SubStatData() {
  }

  public SubStatData postbackId(String postbackId) {
   ...
   /**
   * 하위 메뉴 또는 버튼에 할당된 postbackId
   * @return postbackId
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_POSTBACK_ID)
  ...
  public SubStatData menuType(MenuTypeEnum menuType) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_MENU_TYPE)
  ...
  public SubStatData messagebaseId(String messagebaseId) {
   ...
   /**
   * menuType이 autoreply인 경우, 자동응답메시지의 messagebaseId(식별 불가시 NA)
  ...
  **/
  ...
  public SubStatData reactionType(ReactionTypeEnum reactionType) {
  ...
  **/
  ...
  public SubStatData cardNum(Integer cardNum) {
   ...
   /**
   * menuType이 autoreply인 경우, 이미지 또는 버튼이 있는 card 의 위치(식별 불가시 0)      - ex1) Standalone 인 경우 1   - ex2) Card 4장 Carousel 1,2,3,4 중 버튼이 위치한 카드 번호   - ex3) 칩리스트인 경우 1 
   * @return cardNum
  **/
  @javax.annotation.Nullable
  ...
  public SubStatData buttonNum(Integer buttonNum) {
   ...
   /**
   * menuType이 autoreply인 경우, 이미지, 칩리스트 또는 버튼의  메시지 내 위치를 나타내는 번호(식별 불가시 0)   좌에서 우, 위에서 아래로 1부터 번호 부여하며 Carousel은 각 카드별로 1부터 부여 
   * @return buttonNum
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_BUTTON_NUM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Integer getButtonNum() {
    return buttonNum;
  }
  ...
  public SubStatData actionType(ActionTypeEnum actionType) {
  ...
  **/
  ...
  public SubStatData title(String title) {
  ...
  **/
  ...
  public SubStatData clickCount(Integer clickCount) {
  ...
  **/
  ...
  public SubStatData subActionList(List<SubActionData> subActionList) {
    
    this.subActionList = subActionList;
    return this;
  }

  public SubStatData addSubActionListItem(SubActionData subActionListItem) {
    if (this.subActionList == null) {
      this.subActionList = new ArrayList<>();
    }
    this.subActionList.add(subActionListItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SUB_ACTION_LIST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<SubActionData> getSubActionList() {
    return subActionList;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUB_ACTION_LIST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSubActionList(List<SubActionData> subActionList) {
    this.subActionList = subActionList;
  }
  ...
  public boolean equals(Object o) {
    ...
    SubStatData subStatData = (SubStatData) o;
    return Objects.equals(this.postbackId, subStatData.postbackId) &&
        Objects.equals(this.menuType, subStatData.menuType) &&
        Objects.equals(this.messagebaseId, subStatData.messagebaseId) &&
        Objects.equals(this.reactionType, subStatData.reactionType) &&
        Objects.equals(this.cardNum, subStatData.cardNum) &&
        Objects.equals(this.buttonNum, subStatData.buttonNum) &&
        Objects.equals(this.actionType, subStatData.actionType) &&
        Objects.equals(this.title, subStatData.title) &&
        Objects.equals(this.clickCount, subStatData.clickCount) &&
        Objects.equals(this.subActionList, subStatData.subActionList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(postbackId, menuType, messagebaseId, reactionType, cardNum, buttonNum, actionType, title, clickCount, subActionList);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SubStatData {\n");
    sb.append("    postbackId: ").append(toIndentedString(postbackId)).append("\n");
    ...
    sb.append("    buttonNum: ").append(toIndentedString(buttonNum)).append("\n");
    sb.append("    actionType: ").append(toIndentedString(actionType)).append("\n");
    sb.append("    title: ").append(toIndentedString(title)).append("\n");
    sb.append("    clickCount: ").append(toIndentedString(clickCount)).append("\n");
    sb.append("    subActionList: ").append(toIndentedString(subActionList)).append("\n");
    sb.append("}");
    return sb.toString();
  }

 ...
 */
@JsonPropertyOrder({
  ViewsClick.JSON_PROPERTY_REPLY,
  ViewsClick.JSON_PROPERTY_ACTION
})
@JsonTypeName("Views_click")
...
public class ViewsClick {
  ...
  public ViewsClick reply(Suggestion reply) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_REPLY)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setReply(Suggestion reply) {
    this.reply = reply;
  }


  public ViewsClick action(ActionAction action) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ViewsClick viewsClick = (ViewsClick) o;
    return Objects.equals(this.reply, viewsClick.reply) &&
        Objects.equals(this.action, viewsClick.action);
  }

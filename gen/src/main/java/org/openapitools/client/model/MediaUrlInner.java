 ...
 */
@JsonPropertyOrder({
  MediaUrlInner.JSON_PROPERTY_FILE_ID,
  MediaUrlInner.JSON_PROPERTY_URL,
  MediaUrlInner.JSON_PROPERTY_TYPE_NAME,
  MediaUrlInner.JSON_PROPERTY_FILE_NAME
})
@JsonTypeName("MediaUrl_inner")
...
public class MediaUrlInner {
  ...
  /**
   * 이미지의 사용 유형을 구분합니다.\\ icon - 템플릿 양식 아이콘 이미지&lt;br&gt; profile - 브랜드 프로필 이미지&lt;br&gt; background - 브랜드 백그라운드 이미지&lt;br&gt; 
   */
  ...
  public MediaUrlInner() {
  }

  public MediaUrlInner fileId(String fileId) {
  ...
  **/
  ...
  public MediaUrlInner url(String url) {
  ...
  **/
  ...
  public MediaUrlInner typeName(TypeNameEnum typeName) {
  ...
  **/
  ...
  public MediaUrlInner fileName(String fileName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MediaUrlInner mediaUrlInner = (MediaUrlInner) o;
    return Objects.equals(this.fileId, mediaUrlInner.fileId) &&
        Objects.equals(this.url, mediaUrlInner.url) &&
        Objects.equals(this.typeName, mediaUrlInner.typeName) &&
        Objects.equals(this.fileName, mediaUrlInner.fileName);
  }

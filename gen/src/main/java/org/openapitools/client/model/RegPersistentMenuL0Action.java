 ...
 */
@JsonPropertyOrder({
  RegPersistentMenuL0Action.JSON_PROPERTY_DIALER_ACTION
})
@JsonTypeName("RegPersistentMenu_L0_action")
...
public class RegPersistentMenuL0Action {
  public static final String JSON_PROPERTY_DIALER_ACTION = "dialerAction";
  private DialerActionDialerAction dialerAction;

  public RegPersistentMenuL0Action() {
  }

  public RegPersistentMenuL0Action dialerAction(DialerActionDialerAction dialerAction) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RegPersistentMenuL0Action regPersistentMenuL0Action = (RegPersistentMenuL0Action) o;
    return Objects.equals(this.dialerAction, regPersistentMenuL0Action.dialerAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dialerAction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegPersistentMenuL0Action {\n");

 ...
 */
@JsonPropertyOrder({
  RegPersistentMenu.JSON_PROPERTY_MENU
})
...
public class RegPersistentMenu {
  public static final String JSON_PROPERTY_MENU = "menu";
  private List<RegPersistentMenuL1> menu;

  public RegPersistentMenu() {
  }

  public RegPersistentMenu menu(List<RegPersistentMenuL1> menu) {
    
    this.menu = menu;
    return this;
  }

  public RegPersistentMenu addMenuItem(RegPersistentMenuL1 menuItem) {
    if (this.menu == null) {
  ...
  **/
  ...
  public List<RegPersistentMenuL1> getMenu() {
    return menu;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MENU)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMenu(List<RegPersistentMenuL1> menu) {
    this.menu = menu;
  }
  ...
  public boolean equals(Object o) {
    ...
    RegPersistentMenu regPersistentMenu = (RegPersistentMenu) o;
    return Objects.equals(this.menu, regPersistentMenu.menu);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegPersistentMenu {\n");

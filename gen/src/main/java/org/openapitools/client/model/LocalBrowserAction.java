 ...
 */
@JsonPropertyOrder({
  LocalBrowserAction.JSON_PROPERTY_LOCAL_BROWSER_ACTION
})
@JsonTypeName("localBrowserAction")
...
public class LocalBrowserAction {
  ...
  public LocalBrowserAction() {
  }

  public LocalBrowserAction localBrowserAction(LocalBrowserActionLocalBrowserAction localBrowserAction) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LocalBrowserAction localBrowserAction = (LocalBrowserAction) o;
    return Objects.equals(this.localBrowserAction, localBrowserAction.localBrowserAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(localBrowserAction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LocalBrowserAction {\n");

 ...
 */
@JsonPropertyOrder({
  MessagebaseformLogo.JSON_PROPERTY_FILE_ID,
  MessagebaseformLogo.JSON_PROPERTY_FILE_URL,
  MessagebaseformLogo.JSON_PROPERTY_FILE_NAME
})
...
public class MessagebaseformLogo {
  ...
  public MessagebaseformLogo() {
  }

  public MessagebaseformLogo fileId(String fileId) {
  ...
  **/
  ...
  public MessagebaseformLogo fileUrl(String fileUrl) {
  ...
  **/
  ...
  public MessagebaseformLogo fileName(String fileName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MessagebaseformLogo messagebaseformLogo = (MessagebaseformLogo) o;
    return Objects.equals(this.fileId, messagebaseformLogo.fileId) &&
        Objects.equals(this.fileUrl, messagebaseformLogo.fileUrl) &&
        Objects.equals(this.fileName, messagebaseformLogo.fileName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileId, fileUrl, fileName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MessagebaseformLogo {\n");

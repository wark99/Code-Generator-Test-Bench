 ...
 */
@JsonPropertyOrder({
  BrandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner.JSON_PROPERTY_CHATBOT_ID,
  BrandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner.JSON_PROPERTY_IS_PAUSE,
  BrandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner.JSON_PROPERTY_PAUSED_DATE,
  BrandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner.JSON_PROPERTY_RESUME_DATE
})
@JsonTypeName("_brand__brandId__bidirectional_chatbot__chatbotId__persistentmenu_pause_put_200_response_result_inner")
...
public class BrandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner {
  ...
  public static final String JSON_PROPERTY_PAUSED_DATE = "pausedDate";
  private OffsetDateTime pausedDate;

  public static final String JSON_PROPERTY_RESUME_DATE = "resumeDate";
  private OffsetDateTime resumeDate;

  public BrandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner() {
  }

  public BrandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner chatbotId(String chatbotId) {
  ...
  **/
  ...
  public BrandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner isPause(Boolean isPause) {
  ...
  **/
  ...
  public BrandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner pausedDate(OffsetDateTime pausedDate) {
   ...
   /**
   * isPause true 인 경우, 중지일시
   * @return pausedDate
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_PAUSED_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_PAUSED_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPausedDate(OffsetDateTime pausedDate) {
    this.pausedDate = pausedDate;
  }


  public BrandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner resumeDate(OffsetDateTime resumeDate) {
   ...
   /**
   * isPause false인 경우, 재개일시
   * @return resumeDate
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_RESUME_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public OffsetDateTime getResumeDate() {
    return resumeDate;
  }
  ...
  @JsonProperty(JSON_PROPERTY_RESUME_DATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResumeDate(OffsetDateTime resumeDate) {
    this.resumeDate = resumeDate;
  }
  ...
  public boolean equals(Object o) {
    ...
    BrandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner brandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner = (BrandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner) o;
    return Objects.equals(this.chatbotId, brandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner.chatbotId) &&
        Objects.equals(this.isPause, brandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner.isPause) &&
        Objects.equals(this.pausedDate, brandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner.pausedDate) &&
        Objects.equals(this.resumeDate, brandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner.resumeDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chatbotId, isPause, pausedDate, resumeDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BrandBrandIdBidirectionalChatbotChatbotIdPersistentmenuPausePut200ResponseResultInner {\n");

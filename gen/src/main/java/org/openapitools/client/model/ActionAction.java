...
import org.openapitools.client.model.CalendarActionCalendarAction;
import org.openapitools.client.model.ClipboardActionClipboardAction;
import org.openapitools.client.model.ComposeActionComposeAction;
import org.openapitools.client.model.CustomReplyReplyPostback;
import org.openapitools.client.model.DialerActionDialerAction;
import org.openapitools.client.model.LocalBrowserActionLocalBrowserAction;
import org.openapitools.client.model.MapActionMapAction;
import org.openapitools.client.model.UrlActionUrlAction;
 ...
 */
@JsonPropertyOrder({
  ActionAction.JSON_PROPERTY_DISPLAY_TEXT,
  ActionAction.JSON_PROPERTY_POSTBACK,
  ActionAction.JSON_PROPERTY_URL_ACTION,
  ActionAction.JSON_PROPERTY_DIALER_ACTION,
  ActionAction.JSON_PROPERTY_MAP_ACTION,
  ActionAction.JSON_PROPERTY_CALENDAR_ACTION,
  ActionAction.JSON_PROPERTY_COMPOSE_ACTION,
  ActionAction.JSON_PROPERTY_CLIPBOARD_ACTION,
  ActionAction.JSON_PROPERTY_LOCAL_BROWSER_ACTION
})
...
public class ActionAction {
  ...
  private Object displayText = null;

  public static final String JSON_PROPERTY_POSTBACK = "postback";
  private CustomReplyReplyPostback postback;

  public static final String JSON_PROPERTY_URL_ACTION = "urlAction";
  private UrlActionUrlAction urlAction;

  public static final String JSON_PROPERTY_DIALER_ACTION = "dialerAction";
  private DialerActionDialerAction dialerAction;

  public static final String JSON_PROPERTY_MAP_ACTION = "mapAction";
  private MapActionMapAction mapAction;

  public static final String JSON_PROPERTY_CALENDAR_ACTION = "calendarAction";
  private CalendarActionCalendarAction calendarAction;

  public static final String JSON_PROPERTY_COMPOSE_ACTION = "composeAction";
  private ComposeActionComposeAction composeAction;

  public static final String JSON_PROPERTY_CLIPBOARD_ACTION = "clipboardAction";
  private ClipboardActionClipboardAction clipboardAction;

  public static final String JSON_PROPERTY_LOCAL_BROWSER_ACTION = "localBrowserAction";
  private LocalBrowserActionLocalBrowserAction localBrowserAction;

  public ActionAction() {
  }

  public ActionAction displayText(Object displayText) {
  ...
  **/
  ...
  public ActionAction postback(CustomReplyReplyPostback postback) {
  ...
  **/
  ...
  public CustomReplyReplyPostback getPostback() {
    return postback;
  }
  ...
  @JsonProperty(JSON_PROPERTY_POSTBACK)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPostback(CustomReplyReplyPostback postback) {
    this.postback = postback;
  }


  public ActionAction urlAction(UrlActionUrlAction urlAction) {
  ...
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_URL_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public UrlActionUrlAction getUrlAction() {
    return urlAction;
  }
  ...
  @JsonProperty(JSON_PROPERTY_URL_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setUrlAction(UrlActionUrlAction urlAction) {
    this.urlAction = urlAction;
  }


  public ActionAction dialerAction(DialerActionDialerAction dialerAction) {
  ...
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_DIALER_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public DialerActionDialerAction getDialerAction() {
    return dialerAction;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DIALER_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDialerAction(DialerActionDialerAction dialerAction) {
    this.dialerAction = dialerAction;
  }


  public ActionAction mapAction(MapActionMapAction mapAction) {
  ...
  **/
  ...
  public MapActionMapAction getMapAction() {
    return mapAction;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MAP_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setMapAction(MapActionMapAction mapAction) {
    this.mapAction = mapAction;
  }


  public ActionAction calendarAction(CalendarActionCalendarAction calendarAction) {
  ...
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_CALENDAR_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public CalendarActionCalendarAction getCalendarAction() {
    return calendarAction;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CALENDAR_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCalendarAction(CalendarActionCalendarAction calendarAction) {
    this.calendarAction = calendarAction;
  }


  public ActionAction composeAction(ComposeActionComposeAction composeAction) {
  ...
  **/
  ...
  public ComposeActionComposeAction getComposeAction() {
    return composeAction;
  }
  ...
  @JsonProperty(JSON_PROPERTY_COMPOSE_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setComposeAction(ComposeActionComposeAction composeAction) {
    this.composeAction = composeAction;
  }


  public ActionAction clipboardAction(ClipboardActionClipboardAction clipboardAction) {
  ...
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_CLIPBOARD_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public ClipboardActionClipboardAction getClipboardAction() {
    return clipboardAction;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CLIPBOARD_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setClipboardAction(ClipboardActionClipboardAction clipboardAction) {
    this.clipboardAction = clipboardAction;
  }


  public ActionAction localBrowserAction(LocalBrowserActionLocalBrowserAction localBrowserAction) {
    
    this.localBrowserAction = localBrowserAction;
    return this;
  }

   /**
   * Get localBrowserAction
   * @return localBrowserAction
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_LOCAL_BROWSER_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public LocalBrowserActionLocalBrowserAction getLocalBrowserAction() {
    return localBrowserAction;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LOCAL_BROWSER_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLocalBrowserAction(LocalBrowserActionLocalBrowserAction localBrowserAction) {
    this.localBrowserAction = localBrowserAction;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.displayText, actionAction.displayText) &&
        Objects.equals(this.postback, actionAction.postback) &&
        Objects.equals(this.urlAction, actionAction.urlAction) &&
        Objects.equals(this.dialerAction, actionAction.dialerAction) &&
        Objects.equals(this.mapAction, actionAction.mapAction) &&
        Objects.equals(this.calendarAction, actionAction.calendarAction) &&
        Objects.equals(this.composeAction, actionAction.composeAction) &&
        Objects.equals(this.clipboardAction, actionAction.clipboardAction) &&
        Objects.equals(this.localBrowserAction, actionAction.localBrowserAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(displayText, postback, urlAction, dialerAction, mapAction, calendarAction, composeAction, clipboardAction, localBrowserAction);
  }
  ...
  public String toString() {
    ...
    sb.append("    dialerAction: ").append(toIndentedString(dialerAction)).append("\n");
    sb.append("    mapAction: ").append(toIndentedString(mapAction)).append("\n");
    sb.append("    calendarAction: ").append(toIndentedString(calendarAction)).append("\n");
    sb.append("    composeAction: ").append(toIndentedString(composeAction)).append("\n");
    sb.append("    clipboardAction: ").append(toIndentedString(clipboardAction)).append("\n");
    sb.append("    localBrowserAction: ").append(toIndentedString(localBrowserAction)).append("\n");
    sb.append("}");
    return sb.toString();
  }

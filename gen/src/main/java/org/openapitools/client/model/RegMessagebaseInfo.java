...
import org.openapitools.client.model.RegRCSMessage;
 ...
 */
@JsonPropertyOrder({
  RegMessagebaseInfo.JSON_PROPERTY_MESSAGEBASEFORM_ID,
  RegMessagebaseInfo.JSON_PROPERTY_CUST_TMPLT_ID,
  RegMessagebaseInfo.JSON_PROPERTY_TMPLT_NAME,
  RegMessagebaseInfo.JSON_PROPERTY_BRAND_ID,
  RegMessagebaseInfo.JSON_PROPERTY_AGENCY_ID,
  RegMessagebaseInfo.JSON_PROPERTY_FORMATTED_STRING
})
...
public class RegMessagebaseInfo {
  ...
  private RegRCSMessage formattedString;

  public RegMessagebaseInfo() {
  }

  public RegMessagebaseInfo messagebaseformId(String messagebaseformId) {
  ...
  **/
  ...
  public RegMessagebaseInfo custTmpltId(String custTmpltId) {
  ...
  **/
  ...
  public RegMessagebaseInfo tmpltName(String tmpltName) {
  ...
  **/
  ...
  public RegMessagebaseInfo brandId(String brandId) {
  ...
  **/
  ...
  public RegMessagebaseInfo agencyId(String agencyId) {
  ...
  **/
  ...
  public RegMessagebaseInfo formattedString(RegRCSMessage formattedString) {
  ...
  **/
  ...
  public RegRCSMessage getFormattedString() {
    return formattedString;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FORMATTED_STRING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFormattedString(RegRCSMessage formattedString) {
    this.formattedString = formattedString;
  }
  ...
  public boolean equals(Object o) {
    ...
    RegMessagebaseInfo regMessagebaseInfo = (RegMessagebaseInfo) o;
    return Objects.equals(this.messagebaseformId, regMessagebaseInfo.messagebaseformId) &&
        Objects.equals(this.custTmpltId, regMessagebaseInfo.custTmpltId) &&
        Objects.equals(this.tmpltName, regMessagebaseInfo.tmpltName) &&
        Objects.equals(this.brandId, regMessagebaseInfo.brandId) &&
        Objects.equals(this.agencyId, regMessagebaseInfo.agencyId) &&
        Objects.equals(this.formattedString, regMessagebaseInfo.formattedString);
  }

  @Override
  public int hashCode() {
    return Objects.hash(messagebaseformId, custTmpltId, tmpltName, brandId, agencyId, formattedString);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegMessagebaseInfo {\n");

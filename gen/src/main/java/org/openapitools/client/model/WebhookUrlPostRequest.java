...
import org.openapitools.client.model.NotiAgencyKey;
import org.openapitools.client.model.NotiAutoReplyMsg;
import org.openapitools.client.model.NotiBrand;
import org.openapitools.client.model.NotiChatbot;
import org.openapitools.client.model.NotiContract;
import org.openapitools.client.model.NotiFormat;
import org.openapitools.client.model.NotiFormatBr;
import org.openapitools.client.model.NotiLogo;
import org.openapitools.client.model.NotiMessagebaseForm;
import org.openapitools.client.model.NotiTemplate;
 ...
 */
@JsonPropertyOrder({
  WebhookUrlPostRequest.JSON_PROPERTY_NOTI_TYPE,
  WebhookUrlPostRequest.JSON_PROPERTY_CORP_ID,
  WebhookUrlPostRequest.JSON_PROPERTY_CORP_REG_NUM,
  WebhookUrlPostRequest.JSON_PROPERTY_BRAND_ID,
  WebhookUrlPostRequest.JSON_PROPERTY_METHOD,
  WebhookUrlPostRequest.JSON_PROPERTY_REASON,
  WebhookUrlPostRequest.JSON_PROPERTY_CHATBOT_ID,
  WebhookUrlPostRequest.JSON_PROPERTY_MESSAGEBASEFORM_ID,
  WebhookUrlPostRequest.JSON_PROPERTY_MESSAGEBASE_ID,
  WebhookUrlPostRequest.JSON_PROPERTY_AUTO_REPLY_MSG_ID,
  WebhookUrlPostRequest.JSON_PROPERTY_AGENCY_KEY,
  WebhookUrlPostRequest.JSON_PROPERTY_DATE,
  WebhookUrlPostRequest.JSON_PROPERTY_USER_NAME,
  WebhookUrlPostRequest.JSON_PROPERTY_FILE_ID
})
...
@JsonIgnoreProperties(
  value = "notiType", // ignore manually set notiType, it will be automatically generated by Jackson during serialization
  allowSetters = true // allows the notiType to be set during deserialization
)
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "notiType", visible = true)
@JsonSubTypes({
  @JsonSubTypes.Type(value = NotiAgencyKey.class, name = "NotiAgencyKey"),
  @JsonSubTypes.Type(value = NotiAutoReplyMsg.class, name = "NotiAutoReplyMsg"),
  @JsonSubTypes.Type(value = NotiBrand.class, name = "NotiBrand"),
  @JsonSubTypes.Type(value = NotiChatbot.class, name = "NotiChatbot"),
  @JsonSubTypes.Type(value = NotiContract.class, name = "NotiContract"),
  @JsonSubTypes.Type(value = NotiFormat.class, name = "NotiFormat"),
  @JsonSubTypes.Type(value = NotiFormatBr.class, name = "NotiFormatBr"),
  @JsonSubTypes.Type(value = NotiLogo.class, name = "NotiLogo"),
  @JsonSubTypes.Type(value = NotiMessagebaseForm.class, name = "NotiMessagebaseForm"),
  @JsonSubTypes.Type(value = NotiTemplate.class, name = "NotiTemplate"),
})

public class WebhookUrlPostRequest {
  public static final String JSON_PROPERTY_NOTI_TYPE = "notiType";
  protected Object notiType = logo;

  public static final String JSON_PROPERTY_CORP_ID = "corpId";
  private JsonNullable<Object> corpId = JsonNullable.<Object>of(null);

  public static final String JSON_PROPERTY_CORP_REG_NUM = "corpRegNum";
  private JsonNullable<Object> corpRegNum = JsonNullable.<Object>of(null);

  public static final String JSON_PROPERTY_BRAND_ID = "brandId";
  private JsonNullable<Object> brandId = JsonNullable.<Object>of(null);
  ...
  private JsonNullable<MethodEnum> method = JsonNullable.<MethodEnum>of(null);

  public static final String JSON_PROPERTY_REASON = "reason";
  private JsonNullable<Object> reason = JsonNullable.<Object>of(null);

  public static final String JSON_PROPERTY_CHATBOT_ID = "chatbotId";
  private JsonNullable<Object> chatbotId = JsonNullable.<Object>of(null);
  ...
  public static final String JSON_PROPERTY_AUTO_REPLY_MSG_ID = "autoReplyMsgId";
  private JsonNullable<Object> autoReplyMsgId = JsonNullable.<Object>of(null);

  public static final String JSON_PROPERTY_AGENCY_KEY = "agencyKey";
  private Object agencyKey = null;
  ...
  private JsonNullable<Object> fileId = JsonNullable.<Object>of(null);

  public WebhookUrlPostRequest() {
  }

  public WebhookUrlPostRequest notiType(Object notiType) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_NOTI_TYPE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public Object getNotiType() {
    return notiType;
  }
  ...
  @JsonProperty(JSON_PROPERTY_NOTI_TYPE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setNotiType(Object notiType) {
    this.notiType = notiType;
  }


  public WebhookUrlPostRequest corpId(Object corpId) {
    this.corpId = JsonNullable.<Object>of(corpId);
  ...
  **/
  ...
  public Object getCorpId() {
        return corpId.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_CORP_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getCorpId_JsonNullable() {
    return corpId;
  }
  
  @JsonProperty(JSON_PROPERTY_CORP_ID)
  public void setCorpId_JsonNullable(JsonNullable<Object> corpId) {
    this.corpId = corpId;
  }
  ...
  public WebhookUrlPostRequest corpRegNum(Object corpRegNum) {
    this.corpRegNum = JsonNullable.<Object>of(corpRegNum);
  ...
  **/
  ...
  public Object getCorpRegNum() {
        return corpRegNum.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_CORP_REG_NUM)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getCorpRegNum_JsonNullable() {
    return corpRegNum;
  }
  
  @JsonProperty(JSON_PROPERTY_CORP_REG_NUM)
  public void setCorpRegNum_JsonNullable(JsonNullable<Object> corpRegNum) {
    this.corpRegNum = corpRegNum;
  }

  public void setCorpRegNum(Object corpRegNum) {
    this.corpRegNum = JsonNullable.<Object>of(corpRegNum);
  }


  public WebhookUrlPostRequest brandId(Object brandId) {
    this.brandId = JsonNullable.<Object>of(brandId);
  ...
  **/
  ...
  public JsonNullable<Object> getBrandId_JsonNullable() {
    return brandId;
  }
  
  @JsonProperty(JSON_PROPERTY_BRAND_ID)
  public void setBrandId_JsonNullable(JsonNullable<Object> brandId) {
  ...
  public WebhookUrlPostRequest method(MethodEnum method) {
  ...
  **/
  ...
  public WebhookUrlPostRequest reason(Object reason) {
    this.reason = JsonNullable.<Object>of(reason);
  ...
  **/
  ...
  public JsonNullable<Object> getReason_JsonNullable() {
    return reason;
  }
  
  @JsonProperty(JSON_PROPERTY_REASON)
  public void setReason_JsonNullable(JsonNullable<Object> reason) {
    this.reason = reason;
  }
  ...
  public WebhookUrlPostRequest chatbotId(Object chatbotId) {
    this.chatbotId = JsonNullable.<Object>of(chatbotId);
  ...
  **/
  ...
  public Object getChatbotId() {
        return chatbotId.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_CHATBOT_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getChatbotId_JsonNullable() {
    return chatbotId;
  }
  
  @JsonProperty(JSON_PROPERTY_CHATBOT_ID)
  public void setChatbotId_JsonNullable(JsonNullable<Object> chatbotId) {
  ...
  public WebhookUrlPostRequest messagebaseformId(Object messagebaseformId) {
  ...
  **/
  ...
  public WebhookUrlPostRequest messagebaseId(Object messagebaseId) {
  ...
  **/
  ...
  public WebhookUrlPostRequest autoReplyMsgId(Object autoReplyMsgId) {
    this.autoReplyMsgId = JsonNullable.<Object>of(autoReplyMsgId);
   ...
   /**
   * Get autoReplyMsgId
   * @return autoReplyMsgId
  **/
  @javax.annotation.Nullable
  @JsonIgnore

  public Object getAutoReplyMsgId() {
        return autoReplyMsgId.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_AUTO_REPLY_MSG_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getAutoReplyMsgId_JsonNullable() {
    return autoReplyMsgId;
  }
  
  @JsonProperty(JSON_PROPERTY_AUTO_REPLY_MSG_ID)
  public void setAutoReplyMsgId_JsonNullable(JsonNullable<Object> autoReplyMsgId) {
    this.autoReplyMsgId = autoReplyMsgId;
  }

  public void setAutoReplyMsgId(Object autoReplyMsgId) {
    this.autoReplyMsgId = JsonNullable.<Object>of(autoReplyMsgId);
  }


  public WebhookUrlPostRequest agencyKey(Object agencyKey) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_AGENCY_KEY)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public Object getAgencyKey() {
    return agencyKey;
  }
  ...
  @JsonProperty(JSON_PROPERTY_AGENCY_KEY)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAgencyKey(Object agencyKey) {
    this.agencyKey = agencyKey;
  }


  public WebhookUrlPostRequest date(Object date) {
  ...
  **/
  ...
  public WebhookUrlPostRequest userName(Object userName) {
  ...
  **/
  ...
  public WebhookUrlPostRequest fileId(Object fileId) {
    this.fileId = JsonNullable.<Object>of(fileId);
  ...
  **/
  ...
  public JsonNullable<Object> getFileId_JsonNullable() {
    return fileId;
  }
  
  @JsonProperty(JSON_PROPERTY_FILE_ID)
  public void setFileId_JsonNullable(JsonNullable<Object> fileId) {
    this.fileId = fileId;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebhookUrlPostRequest webhookUrlPostRequest = (WebhookUrlPostRequest) o;
    return Objects.equals(this.notiType, webhookUrlPostRequest.notiType) &&
        equalsNullable(this.corpId, webhookUrlPostRequest.corpId) &&
        equalsNullable(this.corpRegNum, webhookUrlPostRequest.corpRegNum) &&
        equalsNullable(this.brandId, webhookUrlPostRequest.brandId) &&
        equalsNullable(this.method, webhookUrlPostRequest.method) &&
        equalsNullable(this.reason, webhookUrlPostRequest.reason) &&
        equalsNullable(this.chatbotId, webhookUrlPostRequest.chatbotId) &&
        equalsNullable(this.messagebaseformId, webhookUrlPostRequest.messagebaseformId) &&
        equalsNullable(this.messagebaseId, webhookUrlPostRequest.messagebaseId) &&
        equalsNullable(this.autoReplyMsgId, webhookUrlPostRequest.autoReplyMsgId) &&
        Objects.equals(this.agencyKey, webhookUrlPostRequest.agencyKey) &&
        equalsNullable(this.date, webhookUrlPostRequest.date) &&
        equalsNullable(this.userName, webhookUrlPostRequest.userName) &&
        equalsNullable(this.fileId, webhookUrlPostRequest.fileId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(notiType, hashCodeNullable(corpId), hashCodeNullable(corpRegNum), hashCodeNullable(brandId), hashCodeNullable(method), hashCodeNullable(reason), hashCodeNullable(chatbotId), hashCodeNullable(messagebaseformId), hashCodeNullable(messagebaseId), hashCodeNullable(autoReplyMsgId), agencyKey, hashCodeNullable(date), hashCodeNullable(userName), hashCodeNullable(fileId));
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookUrlPostRequest {\n");
    sb.append("    notiType: ").append(toIndentedString(notiType)).append("\n");
    sb.append("    corpId: ").append(toIndentedString(corpId)).append("\n");
    sb.append("    corpRegNum: ").append(toIndentedString(corpRegNum)).append("\n");
    ...
    sb.append("    autoReplyMsgId: ").append(toIndentedString(autoReplyMsgId)).append("\n");
    sb.append("    agencyKey: ").append(toIndentedString(agencyKey)).append("\n");

 ...
 */
@JsonPropertyOrder({
  CorpPersonIdBrandBrandIdPrivilegePutRequest.JSON_PROPERTY_REG_PRIVILEGE
})
@JsonTypeName("_corp__personId__brand__brandId__privilege_put_request")
...
public class CorpPersonIdBrandBrandIdPrivilegePutRequest {
  public static final String JSON_PROPERTY_REG_PRIVILEGE = "regPrivilege";
  private RegPrivilegeInfo regPrivilege;

  public CorpPersonIdBrandBrandIdPrivilegePutRequest() {
  }

  public CorpPersonIdBrandBrandIdPrivilegePutRequest regPrivilege(RegPrivilegeInfo regPrivilege) {
    
    this.regPrivilege = regPrivilege;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_REG_PRIVILEGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public RegPrivilegeInfo getRegPrivilege() {
    return regPrivilege;
  }
  ...
  @JsonProperty(JSON_PROPERTY_REG_PRIVILEGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRegPrivilege(RegPrivilegeInfo regPrivilege) {
    this.regPrivilege = regPrivilege;
  }
  ...
  public boolean equals(Object o) {
    ...
    CorpPersonIdBrandBrandIdPrivilegePutRequest corpPersonIdBrandBrandIdPrivilegePutRequest = (CorpPersonIdBrandBrandIdPrivilegePutRequest) o;
    return Objects.equals(this.regPrivilege, corpPersonIdBrandBrandIdPrivilegePutRequest.regPrivilege);
  }

  @Override
  public int hashCode() {
    return Objects.hash(regPrivilege);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CorpPersonIdBrandBrandIdPrivilegePutRequest {\n");
    sb.append("    regPrivilege: ").append(toIndentedString(regPrivilege)).append("\n");
    sb.append("}");
    return sb.toString();
  }

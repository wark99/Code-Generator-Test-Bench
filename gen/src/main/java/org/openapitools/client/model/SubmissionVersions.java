 ...
 */
@JsonPropertyOrder({
  SubmissionVersions.JSON_PROPERTY_ID,
  SubmissionVersions.JSON_PROPERTY_USER_ID,
  SubmissionVersions.JSON_PROPERTY_CONTEXT_ID,
  SubmissionVersions.JSON_PROPERTY_CONTEXT_TYPE,
  SubmissionVersions.JSON_PROPERTY_ASSIGNMENT_ID,
  SubmissionVersions.JSON_PROPERTY_VERSION_ID
})
@JsonTypeName("submission_versions")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-05-13T19:17:10.693828204Z[Etc/UTC]", comments = "Generator version: 7.4.0")
public class SubmissionVersions {
  ...
  private JsonNullable<Object> versionId = JsonNullable.<Object>of(null);

  public SubmissionVersions() {
  }

  public SubmissionVersions id(Object id) {
  ...
  **/
  ...
  public SubmissionVersions userId(Object userId) {
  ...
  **/
  ...
  public SubmissionVersions contextId(Object contextId) {
   ...
   /**
   * The ID of the course this submission belongs to.
   * @return contextId
  **/
  @javax.annotation.Nullable
  @JsonIgnore
  ...
  public SubmissionVersions contextType(ContextTypeEnum contextType) {
  ...
  **/
  ...
  public SubmissionVersions assignmentId(Object assignmentId) {
  ...
  **/
  ...
  public SubmissionVersions versionId(Object versionId) {
    this.versionId = JsonNullable.<Object>of(versionId);
    
    return this;
  }

   /**
   * The ID of the corresponding object in the versions table.
   * @return versionId
  **/
  @javax.annotation.Nullable
  @JsonIgnore
  ...
  public JsonNullable<Object> getVersionId_JsonNullable() {
    return versionId;
  }
  
  @JsonProperty(JSON_PROPERTY_VERSION_ID)
  public void setVersionId_JsonNullable(JsonNullable<Object> versionId) {
  ...
  public boolean equals(Object o) {
    ...
    SubmissionVersions submissionVersions = (SubmissionVersions) o;
    return Objects.equals(this.id, submissionVersions.id) &&
        equalsNullable(this.userId, submissionVersions.userId) &&
        equalsNullable(this.contextId, submissionVersions.contextId) &&
        Objects.equals(this.contextType, submissionVersions.contextType) &&
        equalsNullable(this.assignmentId, submissionVersions.assignmentId) &&
        equalsNullable(this.versionId, submissionVersions.versionId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, hashCodeNullable(userId), hashCodeNullable(contextId), contextType, hashCodeNullable(assignmentId), hashCodeNullable(versionId));
  }
  ...
  public String toString() {
    ...
    sb.append("class SubmissionVersions {\n");

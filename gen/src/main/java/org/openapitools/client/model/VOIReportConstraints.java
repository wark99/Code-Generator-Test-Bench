 ...
 */
@JsonPropertyOrder({
  VOIReportConstraints.JSON_PROPERTY_ACCOUNT_IDS,
  VOIReportConstraints.JSON_PROPERTY_REPORT_CUSTOM_FIELDS,
  VOIReportConstraints.JSON_PROPERTY_FROM_DATE,
  VOIReportConstraints.JSON_PROPERTY_INCOME_STREAM_CONFIDENCE_MINIMUM
})

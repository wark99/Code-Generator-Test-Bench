...
import org.openapitools.client.model.IncrementalQuery;
import org.openapitools.client.model.SnapshotQuery;
 ...
 */
@JsonPropertyOrder({
  Query.JSON_PROPERTY_FORMAT,
  Query.JSON_PROPERTY_FILTER,
  Query.JSON_PROPERTY_SINCE,
  Query.JSON_PROPERTY_UNTIL
})
...
public class Query {
  ...
  public Query format(Format format) {
  ...
  **/
  ...
  public Query since(Object since) {
  ...
  **/
  ...
  public Query until(Object until) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Query query = (Query) o;
    return Objects.equals(this.format, query.format) &&
        Objects.equals(this.filter, query.filter) &&
        Objects.equals(this.since, query.since) &&
        equalsNullable(this.until, query.until);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(format, filter, since, hashCodeNullable(until));
  }

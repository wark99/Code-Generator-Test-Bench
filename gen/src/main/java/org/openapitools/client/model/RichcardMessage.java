 ...
 */
@JsonPropertyOrder({
  RichcardMessage.JSON_PROPERTY_RICHCARD_MESSAGE
})
...
public class RichcardMessage {
  ...
  public RichcardMessage() {
  }

  public RichcardMessage richcardMessage(RichcardMessageRichcardMessage richcardMessage) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RichcardMessage richcardMessage = (RichcardMessage) o;
    return Objects.equals(this.richcardMessage, richcardMessage.richcardMessage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(richcardMessage);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RichcardMessage {\n");

...
import org.openapitools.client.model.GeneralPurposeCardCarouselMessage;
import org.openapitools.client.model.GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel;
import org.openapitools.client.model.GeneralPurposeCardMessage;
import org.openapitools.client.model.GeneralPurposeCardMessageGeneralPurposeCard;
 ...
 */
@JsonPropertyOrder({
  RichcardMessageRichcardMessageMessage.JSON_PROPERTY_GENERAL_PURPOSE_CARD,
  RichcardMessageRichcardMessageMessage.JSON_PROPERTY_GENERAL_PURPOSE_CARD_CAROUSEL
})
@JsonTypeName("RichcardMessage_richcardMessage_message")
...
public class RichcardMessageRichcardMessageMessage {
  public static final String JSON_PROPERTY_GENERAL_PURPOSE_CARD = "generalPurposeCard";
  private GeneralPurposeCardMessageGeneralPurposeCard generalPurposeCard;

  public static final String JSON_PROPERTY_GENERAL_PURPOSE_CARD_CAROUSEL = "generalPurposeCardCarousel";
  private GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel generalPurposeCardCarousel;

  public RichcardMessageRichcardMessageMessage() {
  }

  public RichcardMessageRichcardMessageMessage generalPurposeCard(GeneralPurposeCardMessageGeneralPurposeCard generalPurposeCard) {
   ...
   /**
   * Get generalPurposeCard
   * @return generalPurposeCard
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_GENERAL_PURPOSE_CARD)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public GeneralPurposeCardMessageGeneralPurposeCard getGeneralPurposeCard() {
    return generalPurposeCard;
  }
  ...
  @JsonProperty(JSON_PROPERTY_GENERAL_PURPOSE_CARD)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setGeneralPurposeCard(GeneralPurposeCardMessageGeneralPurposeCard generalPurposeCard) {
    this.generalPurposeCard = generalPurposeCard;
  }


  public RichcardMessageRichcardMessageMessage generalPurposeCardCarousel(GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel generalPurposeCardCarousel) {
   ...
   /**
   * Get generalPurposeCardCarousel
   * @return generalPurposeCardCarousel
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_GENERAL_PURPOSE_CARD_CAROUSEL)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel getGeneralPurposeCardCarousel() {
    return generalPurposeCardCarousel;
  }
  ...
  @JsonProperty(JSON_PROPERTY_GENERAL_PURPOSE_CARD_CAROUSEL)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setGeneralPurposeCardCarousel(GeneralPurposeCardCarouselMessageGeneralPurposeCardCarousel generalPurposeCardCarousel) {
    this.generalPurposeCardCarousel = generalPurposeCardCarousel;
  }
  ...
  public boolean equals(Object o) {
    ...
    RichcardMessageRichcardMessageMessage richcardMessageRichcardMessageMessage = (RichcardMessageRichcardMessageMessage) o;
    return Objects.equals(this.generalPurposeCard, richcardMessageRichcardMessageMessage.generalPurposeCard) &&
        Objects.equals(this.generalPurposeCardCarousel, richcardMessageRichcardMessageMessage.generalPurposeCardCarousel);
  }

  @Override
  public int hashCode() {
    return Objects.hash(generalPurposeCard, generalPurposeCardCarousel);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RichcardMessageRichcardMessageMessage {\n");
    sb.append("    generalPurposeCard: ").append(toIndentedString(generalPurposeCard)).append("\n");
    sb.append("    generalPurposeCardCarousel: ").append(toIndentedString(generalPurposeCardCarousel)).append("\n");
    sb.append("}");
    return sb.toString();
  }

...
import org.openapitools.client.model.GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf;
import org.openapitools.client.model.GeneralPurposeCardMessageGeneralPurposeCardLayoutOneOf1;
 ...
 */
@JsonPropertyOrder({
  GeneralPurposeCardMessageGeneralPurposeCardLayout.JSON_PROPERTY_CARD_ORIENTATION,
  GeneralPurposeCardMessageGeneralPurposeCardLayout.JSON_PROPERTY_TITLE_FONT_STYLE,
  GeneralPurposeCardMessageGeneralPurposeCardLayout.JSON_PROPERTY_DESCRIPTION_FONT_STYLE,
  GeneralPurposeCardMessageGeneralPurposeCardLayout.JSON_PROPERTY_STYLE,
  GeneralPurposeCardMessageGeneralPurposeCardLayout.JSON_PROPERTY_IMAGE_ALIGNMENT
})
@JsonTypeName("generalPurposeCardMessage_generalPurposeCard_layout")
...
public class GeneralPurposeCardMessageGeneralPurposeCardLayout {
  /**
  ...
  public enum CardOrientationEnum {
    ...
    CardOrientationEnum(Object value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static CardOrientationEnum fromValue(Object value) {
  ...
  public static final String JSON_PROPERTY_CARD_ORIENTATION = "cardOrientation";
  private CardOrientationEnum cardOrientation = null;

  public static final String JSON_PROPERTY_TITLE_FONT_STYLE = "titleFontStyle";
  private JsonNullable<Object> titleFontStyle = JsonNullable.<Object>of(null);

  public static final String JSON_PROPERTY_DESCRIPTION_FONT_STYLE = "descriptionFontStyle";
  private JsonNullable<Object> descriptionFontStyle = JsonNullable.<Object>of(null);

  public static final String JSON_PROPERTY_STYLE = "style";
  private JsonNullable<Object> style = JsonNullable.<Object>of(null);

  /**
   * Gets or Sets imageAlignment
   */
  public enum ImageAlignmentEnum {
    ...
    ImageAlignmentEnum(Object value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static ImageAlignmentEnum fromValue(Object value) {
      for (ImageAlignmentEnum b : ImageAlignmentEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  public static final String JSON_PROPERTY_IMAGE_ALIGNMENT = "imageAlignment";
  private ImageAlignmentEnum imageAlignment = null;

  public GeneralPurposeCardMessageGeneralPurposeCardLayout() {
  }

  public GeneralPurposeCardMessageGeneralPurposeCardLayout cardOrientation(CardOrientationEnum cardOrientation) {
  ...
  **/
  ...
  public GeneralPurposeCardMessageGeneralPurposeCardLayout titleFontStyle(Object titleFontStyle) {
    this.titleFontStyle = JsonNullable.<Object>of(titleFontStyle);
  ...
  **/
  ...
  public Object getTitleFontStyle() {
        return titleFontStyle.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_TITLE_FONT_STYLE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getTitleFontStyle_JsonNullable() {
    return titleFontStyle;
  }
  
  @JsonProperty(JSON_PROPERTY_TITLE_FONT_STYLE)
  public void setTitleFontStyle_JsonNullable(JsonNullable<Object> titleFontStyle) {
    this.titleFontStyle = titleFontStyle;
  }

  public void setTitleFontStyle(Object titleFontStyle) {
    this.titleFontStyle = JsonNullable.<Object>of(titleFontStyle);
  }


  public GeneralPurposeCardMessageGeneralPurposeCardLayout descriptionFontStyle(Object descriptionFontStyle) {
    this.descriptionFontStyle = JsonNullable.<Object>of(descriptionFontStyle);
    
    return this;
  }

   /**
   * Get descriptionFontStyle
   * @return descriptionFontStyle
  **/
  @javax.annotation.Nullable
  @JsonIgnore

  public Object getDescriptionFontStyle() {
        return descriptionFontStyle.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_DESCRIPTION_FONT_STYLE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public JsonNullable<Object> getDescriptionFontStyle_JsonNullable() {
    return descriptionFontStyle;
  }
  
  @JsonProperty(JSON_PROPERTY_DESCRIPTION_FONT_STYLE)
  public void setDescriptionFontStyle_JsonNullable(JsonNullable<Object> descriptionFontStyle) {
    this.descriptionFontStyle = descriptionFontStyle;
  }

  public void setDescriptionFontStyle(Object descriptionFontStyle) {
    this.descriptionFontStyle = JsonNullable.<Object>of(descriptionFontStyle);
  }


  public GeneralPurposeCardMessageGeneralPurposeCardLayout style(Object style) {
    this.style = JsonNullable.<Object>of(style);
    
    return this;
  }

   /**
   * A reference to a CSS for the rendering of the Rich Card(s).
   * @return style
  **/
  @javax.annotation.Nullable
  @JsonIgnore
  ...
  public JsonNullable<Object> getStyle_JsonNullable() {
    return style;
  }
  
  @JsonProperty(JSON_PROPERTY_STYLE)
  public void setStyle_JsonNullable(JsonNullable<Object> style) {
    this.style = style;
  }
  ...
  public GeneralPurposeCardMessageGeneralPurposeCardLayout imageAlignment(ImageAlignmentEnum imageAlignment) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_IMAGE_ALIGNMENT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public ImageAlignmentEnum getImageAlignment() {
    return imageAlignment;
  }
  ...
  @JsonProperty(JSON_PROPERTY_IMAGE_ALIGNMENT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setImageAlignment(ImageAlignmentEnum imageAlignment) {
    this.imageAlignment = imageAlignment;
  }
  ...
  public boolean equals(Object o) {
    ...
    GeneralPurposeCardMessageGeneralPurposeCardLayout generalPurposeCardMessageGeneralPurposeCardLayout = (GeneralPurposeCardMessageGeneralPurposeCardLayout) o;
    return Objects.equals(this.cardOrientation, generalPurposeCardMessageGeneralPurposeCardLayout.cardOrientation) &&
        equalsNullable(this.titleFontStyle, generalPurposeCardMessageGeneralPurposeCardLayout.titleFontStyle) &&
        equalsNullable(this.descriptionFontStyle, generalPurposeCardMessageGeneralPurposeCardLayout.descriptionFontStyle) &&
        equalsNullable(this.style, generalPurposeCardMessageGeneralPurposeCardLayout.style) &&
        Objects.equals(this.imageAlignment, generalPurposeCardMessageGeneralPurposeCardLayout.imageAlignment);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cardOrientation, hashCodeNullable(titleFontStyle), hashCodeNullable(descriptionFontStyle), hashCodeNullable(style), imageAlignment);
  }
  ...
  public String toString() {
    ...
    sb.append("class GeneralPurposeCardMessageGeneralPurposeCardLayout {\n");
    sb.append("    cardOrientation: ").append(toIndentedString(cardOrientation)).append("\n");
    sb.append("    titleFontStyle: ").append(toIndentedString(titleFontStyle)).append("\n");
    sb.append("    descriptionFontStyle: ").append(toIndentedString(descriptionFontStyle)).append("\n");
    sb.append("    style: ").append(toIndentedString(style)).append("\n");
    sb.append("    imageAlignment: ").append(toIndentedString(imageAlignment)).append("\n");
    sb.append("}");
    return sb.toString();
  }

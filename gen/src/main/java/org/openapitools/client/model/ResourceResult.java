 ...
 */
@JsonPropertyOrder({
  ResourceResult.JSON_PROPERTY_URLS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-05-13T19:17:10.693828204Z[Etc/UTC]", comments = "Generator version: 7.4.0")
public class ResourceResult {
  public static final String JSON_PROPERTY_URLS = "urls";
  private Map<String, Resource> urls = new HashMap<>();

  public ResourceResult() {
  }

  public ResourceResult urls(Map<String, Resource> urls) {
  ...
  **/
  ...
  public Map<String, Resource> getUrls() {
    return urls;
  }
  ...
  @JsonProperty(JSON_PROPERTY_URLS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setUrls(Map<String, Resource> urls) {
    this.urls = urls;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.urls, resourceResult.urls);
  }

...
@JsonPropertyOrder({
  ...
  UpdateProjectRequest.JSON_PROPERTY_LABEL
})
...
public class UpdateProjectRequest {
  ...
  public UpdateProjectRequest name(String name) {
   ...
   /**
   * The updated name of the project (optional).
   * @return name
  **/
  ...
  public UpdateProjectRequest description(String description) {
   ...
   /**
   * The updated project description (optional).
   * @return description
  **/
  @javax.annotation.Nullable
  ...
  public UpdateProjectRequest label(String label) {
   ...
   /**
   * The updated label for the project (optional).
   * @return label
  **/
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateProjectRequest.name) &&
        ...
        Objects.equals(this.label, updateProjectRequest.label);
  }

 ...
 */
@JsonPropertyOrder({
  BrandBrandIdLayoutLayoutIdDelete200ResponseResultInner.JSON_PROPERTY_LAYOUT_ID
})
@JsonTypeName("_brand__brandId__layout__layoutId__delete_200_response_result_inner")
...
public class BrandBrandIdLayoutLayoutIdDelete200ResponseResultInner {
  public static final String JSON_PROPERTY_LAYOUT_ID = "layoutId";
  private String layoutId;

  public BrandBrandIdLayoutLayoutIdDelete200ResponseResultInner() {
  }

  public BrandBrandIdLayoutLayoutIdDelete200ResponseResultInner layoutId(String layoutId) {
   ...
   /**
   * 삭제된 레이아웃 ID(&#x3D; messagebaseId) 입니다.   레이아웃 ID는 RCS 발송에 사용하는 messagebaseId 로 사용됩니다. 
   * @return layoutId
  **/
  ...
  public boolean equals(Object o) {
    ...
    BrandBrandIdLayoutLayoutIdDelete200ResponseResultInner brandBrandIdLayoutLayoutIdDelete200ResponseResultInner = (BrandBrandIdLayoutLayoutIdDelete200ResponseResultInner) o;
    return Objects.equals(this.layoutId, brandBrandIdLayoutLayoutIdDelete200ResponseResultInner.layoutId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(layoutId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BrandBrandIdLayoutLayoutIdDelete200ResponseResultInner {\n");

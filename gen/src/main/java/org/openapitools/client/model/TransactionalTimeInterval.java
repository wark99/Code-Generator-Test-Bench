 ...
 */
@JsonPropertyOrder({
  TransactionalTimeInterval.JSON_PROPERTY_PERIODS,
  TransactionalTimeInterval.JSON_PROPERTY_TIME_INTERVAL_TYPE
})
...
public class TransactionalTimeInterval {
  public static final String JSON_PROPERTY_PERIODS = "periods";
  private List<TransactionalPeriod> periods = new ArrayList<>();
  ...
  public TransactionalTimeInterval() {
  }

  public TransactionalTimeInterval periods(List<TransactionalPeriod> periods) {
    
    this.periods = periods;
    return this;
  }

  public TransactionalTimeInterval addPeriodsItem(TransactionalPeriod periodsItem) {
  ...
  **/
  ...
  public List<TransactionalPeriod> getPeriods() {
    return periods;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PERIODS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPeriods(List<TransactionalPeriod> periods) {
    this.periods = periods;
  }


  public TransactionalTimeInterval timeIntervalType(String timeIntervalType) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TransactionalTimeInterval transactionalTimeInterval = (TransactionalTimeInterval) o;
    return Objects.equals(this.periods, transactionalTimeInterval.periods) &&
        Objects.equals(this.timeIntervalType, transactionalTimeInterval.timeIntervalType);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransactionalTimeInterval {\n");

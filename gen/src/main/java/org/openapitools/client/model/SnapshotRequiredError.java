 ...
 */
@JsonPropertyOrder({
  SnapshotRequiredError.JSON_PROPERTY_TYPE,
  SnapshotRequiredError.JSON_PROPERTY_UUID,
  SnapshotRequiredError.JSON_PROPERTY_MESSAGE,
  SnapshotRequiredError.JSON_PROPERTY_SINCE,
  SnapshotRequiredError.JSON_PROPERTY_UNTIL
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-05-13T19:17:10.693828204Z[Etc/UTC]", comments = "Generator version: 7.4.0")
public class SnapshotRequiredError {
  ...
  public SnapshotRequiredError() {
  }

  public SnapshotRequiredError type(String type) {
  ...
  **/
  ...
  public SnapshotRequiredError uuid(String uuid) {
  ...
  **/
  ...
  public SnapshotRequiredError message(String message) {
  ...
  **/
  ...
  public SnapshotRequiredError since(OffsetDateTime since) {
  ...
  **/
  ...
  public SnapshotRequiredError until(OffsetDateTime until) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SnapshotRequiredError snapshotRequiredError = (SnapshotRequiredError) o;
    return Objects.equals(this.type, snapshotRequiredError.type) &&
        Objects.equals(this.uuid, snapshotRequiredError.uuid) &&
        Objects.equals(this.message, snapshotRequiredError.message) &&
        Objects.equals(this.since, snapshotRequiredError.since) &&
        Objects.equals(this.until, snapshotRequiredError.until);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, uuid, message, since, until);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SnapshotRequiredError {\n");

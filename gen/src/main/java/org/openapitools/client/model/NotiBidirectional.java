...
import org.openapitools.client.model.NotiBidirectionalValue;
 ...
 */
@JsonPropertyOrder({
  NotiBidirectional.JSON_PROPERTY_NOTI_TYPE,
  NotiBidirectional.JSON_PROPERTY_VALUE
})
...
public class NotiBidirectional {
  /**
   * + appointment: 일반 대행사가 양방향 서비스 중계사 지정 알림 + registration: 양방향 대화방 등록 알림 + subscription: 대화방메뉴 사용 청약 확인 요청 + persistentmenu: 대화방메뉴 등록 알림 
   */
  public enum NotiTypeEnum {
    ...
    @JsonCreator
    public static NotiTypeEnum fromValue(String value) {
      for (NotiTypeEnum b : NotiTypeEnum.values()) {
  ...
  private NotiBidirectionalValue value;

  public NotiBidirectional() {
  }

  public NotiBidirectional notiType(NotiTypeEnum notiType) {
  ...
  **/
  ...
  public NotiTypeEnum getNotiType() {
    return notiType;
  }
  ...
  @JsonProperty(JSON_PROPERTY_NOTI_TYPE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setNotiType(NotiTypeEnum notiType) {
    this.notiType = notiType;
  }


  public NotiBidirectional value(NotiBidirectionalValue value) {
  ...
  **/
  ...
  public NotiBidirectionalValue getValue() {
    return value;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALUE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValue(NotiBidirectionalValue value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    NotiBidirectional notiBidirectional = (NotiBidirectional) o;
    return Objects.equals(this.notiType, notiBidirectional.notiType) &&
        Objects.equals(this.value, notiBidirectional.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(notiType, value);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NotiBidirectional {\n");

...
import org.openapitools.client.model.SettingsActionSettingsAction;
 ...
 */
@JsonPropertyOrder({
  SettingsAction.JSON_PROPERTY_SETTINGS_ACTION
})
@JsonTypeName("settingsAction")
...
public class SettingsAction {
  public static final String JSON_PROPERTY_SETTINGS_ACTION = "settingsAction";
  private SettingsActionSettingsAction settingsAction;

  public SettingsAction() {
  }

  public SettingsAction settingsAction(SettingsActionSettingsAction settingsAction) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_SETTINGS_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public SettingsActionSettingsAction getSettingsAction() {
    return settingsAction;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SETTINGS_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSettingsAction(SettingsActionSettingsAction settingsAction) {
    this.settingsAction = settingsAction;
  }
  ...
  public boolean equals(Object o) {
    ...
    SettingsAction settingsAction = (SettingsAction) o;
    return Objects.equals(this.settingsAction, settingsAction.settingsAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(settingsAction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SettingsAction {\n");
    sb.append("    settingsAction: ").append(toIndentedString(settingsAction)).append("\n");
    sb.append("}");
    return sb.toString();
  }

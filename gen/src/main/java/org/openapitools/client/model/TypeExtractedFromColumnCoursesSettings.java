 ...
 */
@JsonPropertyOrder({
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_ALLOW_STUDENT_DISCUSSION_EDITING,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_ALLOW_STUDENT_DISCUSSION_TOPICS,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_COURSE_FORMAT,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_FILTER_SPEED_GRADER_BY_STUDENT_GROUP,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_HIDE_DISTRIBUTION_GRAPHS,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_HIDE_FINAL_GRADE,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_IS_PUBLIC_TO_AUTH_USERS,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_LOCK_ALL_ANNOUNCEMENTS,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_PUBLIC_SYLLABUS,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_PUBLIC_SYLLABUS_TO_AUTH,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_RESTRICT_STUDENT_FUTURE_VIEW,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_RESTRICT_STUDENT_PAST_VIEW,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_SYLLABUS_UPDATED_AT,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_USAGE_RIGHTS_REQUIRED,
  TypeExtractedFromColumnCoursesSettings.JSON_PROPERTY_ALLOW_STUDENT_FORUM_ATTACHMENTS
})
@JsonTypeName("Type_extracted_from_column__courses_settings__")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-05-13T19:17:10.693828204Z[Etc/UTC]", comments = "Generator version: 7.4.0")
public class TypeExtractedFromColumnCoursesSettings {
  ...
  public TypeExtractedFromColumnCoursesSettings() {
  }

  public TypeExtractedFromColumnCoursesSettings allowStudentDiscussionEditing(Object allowStudentDiscussionEditing) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings allowStudentDiscussionTopics(Object allowStudentDiscussionTopics) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings courseFormat(Object courseFormat) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings filterSpeedGraderByStudentGroup(String filterSpeedGraderByStudentGroup) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings hideDistributionGraphs(Object hideDistributionGraphs) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings hideFinalGrade(Object hideFinalGrade) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings isPublicToAuthUsers(Object isPublicToAuthUsers) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings lockAllAnnouncements(Object lockAllAnnouncements) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings publicSyllabus(Object publicSyllabus) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings publicSyllabusToAuth(Object publicSyllabusToAuth) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings restrictStudentFutureView(Object restrictStudentFutureView) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings restrictStudentPastView(Object restrictStudentPastView) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings syllabusUpdatedAt(Object syllabusUpdatedAt) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings usageRightsRequired(Object usageRightsRequired) {
  ...
  **/
  ...
  public TypeExtractedFromColumnCoursesSettings allowStudentForumAttachments(Object allowStudentForumAttachments) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TypeExtractedFromColumnCoursesSettings typeExtractedFromColumnCoursesSettings = (TypeExtractedFromColumnCoursesSettings) o;
    return equalsNullable(this.allowStudentDiscussionEditing, typeExtractedFromColumnCoursesSettings.allowStudentDiscussionEditing) &&
        equalsNullable(this.allowStudentDiscussionTopics, typeExtractedFromColumnCoursesSettings.allowStudentDiscussionTopics) &&
        equalsNullable(this.courseFormat, typeExtractedFromColumnCoursesSettings.courseFormat) &&
        Objects.equals(this.filterSpeedGraderByStudentGroup, typeExtractedFromColumnCoursesSettings.filterSpeedGraderByStudentGroup) &&
        equalsNullable(this.hideDistributionGraphs, typeExtractedFromColumnCoursesSettings.hideDistributionGraphs) &&
        equalsNullable(this.hideFinalGrade, typeExtractedFromColumnCoursesSettings.hideFinalGrade) &&
        equalsNullable(this.isPublicToAuthUsers, typeExtractedFromColumnCoursesSettings.isPublicToAuthUsers) &&
        equalsNullable(this.lockAllAnnouncements, typeExtractedFromColumnCoursesSettings.lockAllAnnouncements) &&
        equalsNullable(this.publicSyllabus, typeExtractedFromColumnCoursesSettings.publicSyllabus) &&
        equalsNullable(this.publicSyllabusToAuth, typeExtractedFromColumnCoursesSettings.publicSyllabusToAuth) &&
        equalsNullable(this.restrictStudentFutureView, typeExtractedFromColumnCoursesSettings.restrictStudentFutureView) &&
        equalsNullable(this.restrictStudentPastView, typeExtractedFromColumnCoursesSettings.restrictStudentPastView) &&
        equalsNullable(this.syllabusUpdatedAt, typeExtractedFromColumnCoursesSettings.syllabusUpdatedAt) &&
        equalsNullable(this.usageRightsRequired, typeExtractedFromColumnCoursesSettings.usageRightsRequired) &&
        equalsNullable(this.allowStudentForumAttachments, typeExtractedFromColumnCoursesSettings.allowStudentForumAttachments);
  }
  ...
  public String toString() {
    ...
    sb.append("class TypeExtractedFromColumnCoursesSettings {\n");

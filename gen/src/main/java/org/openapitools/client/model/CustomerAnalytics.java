 ...
 */
@JsonPropertyOrder({
  CustomerAnalytics.JSON_PROPERTY_TRANSACTIONAL_ATTRIBUTES,
  CustomerAnalytics.JSON_PROPERTY_STATE_ATTRIBUTES,
  CustomerAnalytics.JSON_PROPERTY_STREAMS
})
...
public class CustomerAnalytics {
  ...
  public CustomerAnalytics transactionalAttributes(List<TransactionalAttribute> transactionalAttributes) {
    
    this.transactionalAttributes = transactionalAttributes;
    return this;
  }

  public CustomerAnalytics addTransactionalAttributesItem(TransactionalAttribute transactionalAttributesItem) {
  ...
  **/
  ...
  public CustomerAnalytics stateAttributes(List<StateAttribute> stateAttributes) {
    
    this.stateAttributes = stateAttributes;
    return this;
  }

  public CustomerAnalytics addStateAttributesItem(StateAttribute stateAttributesItem) {
  ...
  **/
  ...
  public CustomerAnalytics streams(List<StreamModel> streams) {
    
    this.streams = streams;
    return this;
  }

  public CustomerAnalytics addStreamsItem(StreamModel streamsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.transactionalAttributes, customerAnalytics.transactionalAttributes) &&
        Objects.equals(this.stateAttributes, customerAnalytics.stateAttributes) &&
        Objects.equals(this.streams, customerAnalytics.streams);
  }

...
import org.openapitools.client.model.ShareActionShareAction;
 ...
 */
@JsonPropertyOrder({
  ShareAction.JSON_PROPERTY_SHARE_ACTION
})
@JsonTypeName("shareAction")
...
public class ShareAction {
  public static final String JSON_PROPERTY_SHARE_ACTION = "shareAction";
  private ShareActionShareAction shareAction;

  public ShareAction() {
  }

  public ShareAction shareAction(ShareActionShareAction shareAction) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_SHARE_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public ShareActionShareAction getShareAction() {
    return shareAction;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SHARE_ACTION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setShareAction(ShareActionShareAction shareAction) {
    this.shareAction = shareAction;
  }
  ...
  public boolean equals(Object o) {
    ...
    ShareAction shareAction = (ShareAction) o;
    return Objects.equals(this.shareAction, shareAction.shareAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(shareAction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ShareAction {\n");
    sb.append("    shareAction: ").append(toIndentedString(shareAction)).append("\n");
    sb.append("}");
    return sb.toString();
  }

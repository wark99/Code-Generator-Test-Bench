 ...
 */
@JsonPropertyOrder({
  IncrementalQuery.JSON_PROPERTY_FORMAT,
  IncrementalQuery.JSON_PROPERTY_FILTER,
  IncrementalQuery.JSON_PROPERTY_SINCE,
  IncrementalQuery.JSON_PROPERTY_UNTIL
})
...
public class IncrementalQuery {
  ...
  public IncrementalQuery format(Format format) {
  ...
  **/
  ...
  public IncrementalQuery filter(Filter filter) {
   ...
   /**
   * (Not implemented; this field must be omitted.) Any filters applied to the source, e.g. include specific columns, or omit specific rows.
   * @return filter
  **/
  ...
  public IncrementalQuery since(OffsetDateTime since) {
   ...
   /**
   * Start timestamp (in UTC); only those records are returned that have been persisted since the specified date and time. This typically equals &#x60;at&#x60; returned by a previous snapshot query job, or &#x60;until&#x60; returned by a previous incremental query job.
   * @return since
  **/
  @javax.annotation.Nonnull
  ...
  public IncrementalQuery until(OffsetDateTime until) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IncrementalQuery incrementalQuery = (IncrementalQuery) o;
    return Objects.equals(this.format, incrementalQuery.format) &&
        Objects.equals(this.filter, incrementalQuery.filter) &&
        Objects.equals(this.since, incrementalQuery.since) &&
        Objects.equals(this.until, incrementalQuery.until);
  }

  @Override
  public int hashCode() {
    return Objects.hash(format, filter, since, until);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IncrementalQuery {\n");

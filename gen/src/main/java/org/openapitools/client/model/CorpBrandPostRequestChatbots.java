 ...
 */
@JsonPropertyOrder({
  CorpBrandPostRequestChatbots.JSON_PROPERTY_CHATBOTS
})
@JsonTypeName("_corp_brand_post_request_chatbots")
...
public class CorpBrandPostRequestChatbots {
  public static final String JSON_PROPERTY_CHATBOTS = "chatbots";
  private List<RegChatbotInfo> chatbots;

  public CorpBrandPostRequestChatbots() {
  }

  public CorpBrandPostRequestChatbots chatbots(List<RegChatbotInfo> chatbots) {
    
    this.chatbots = chatbots;
    return this;
  }

  public CorpBrandPostRequestChatbots addChatbotsItem(RegChatbotInfo chatbotsItem) {
    if (this.chatbots == null) {
      this.chatbots = new ArrayList<>();
    }
    this.chatbots.add(chatbotsItem);
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CHATBOTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<RegChatbotInfo> getChatbots() {
    return chatbots;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CHATBOTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setChatbots(List<RegChatbotInfo> chatbots) {
    this.chatbots = chatbots;
  }
  ...
  public boolean equals(Object o) {
    ...
    CorpBrandPostRequestChatbots corpBrandPostRequestChatbots = (CorpBrandPostRequestChatbots) o;
    return Objects.equals(this.chatbots, corpBrandPostRequestChatbots.chatbots);
  }
  ...
  public String toString() {
    ...
    sb.append("class CorpBrandPostRequestChatbots {\n");

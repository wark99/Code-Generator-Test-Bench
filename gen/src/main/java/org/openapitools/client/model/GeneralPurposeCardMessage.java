 ...
 */
@JsonPropertyOrder({
  GeneralPurposeCardMessage.JSON_PROPERTY_GENERAL_PURPOSE_CARD
})
@JsonTypeName("generalPurposeCardMessage")
...
public class GeneralPurposeCardMessage {
  ...
  public GeneralPurposeCardMessage generalPurposeCard(GeneralPurposeCardMessageGeneralPurposeCard generalPurposeCard) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GeneralPurposeCardMessage generalPurposeCardMessage = (GeneralPurposeCardMessage) o;
    return Objects.equals(this.generalPurposeCard, generalPurposeCardMessage.generalPurposeCard);
  }

  @Override
  public int hashCode() {
    return Objects.hash(generalPurposeCard);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GeneralPurposeCardMessage {\n");

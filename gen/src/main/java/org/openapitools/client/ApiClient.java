...
public class ApiClient extends JavaTimeFormatter {
    ...
    protected void init() {
        ...
        authentications.put("Token", new ApiKeyAuth("header", "Token"));
        authentications.put("Fingerprint", new ApiKeyAuth("header", "Fingerprint"));
        authentications.put("Cookie", new ApiKeyAuth("cookie", "SESSID"));

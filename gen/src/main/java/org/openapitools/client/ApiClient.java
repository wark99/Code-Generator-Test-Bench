...
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "https://glusterfs1.sgx.io:8443";
    ...
    protected void init() {
        ...
        authentications.put("cookieAuth", new ApiKeyAuth("cookie", "secure:token"));
        authentications.put("sessionCookieAuth", new ApiKeyAuth("cookie", "secure:sessionHash"));
